...
@Component({
  selector: 'app-mod7-severity8-mod7-grid',
  templateUrl: './severity8-mod7-grid.component.html'
})
export class Severity8Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
