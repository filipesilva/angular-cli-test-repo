...
@Component({
  selector: 'app-mod7-severity8-mod7-form',
  templateUrl: './severity8-mod7-form.component.html'
})
export class Severity8Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/severity8-mod7']);
  }
