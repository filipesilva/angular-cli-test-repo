...
@Component({
  selector: 'app-mod7-status9-mod7-form',
  templateUrl: './status9-mod7-form.component.html'
})
export class Status9Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/status9-mod7']);
  }
