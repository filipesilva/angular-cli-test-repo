...
@Component({
  selector: 'app-mod7-status9-mod7-grid',
  templateUrl: './status9-mod7-grid.component.html'
})
export class Status9Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
