...
@Component({
  selector: 'app-mod7-category4-mod7-grid',
  templateUrl: './category4-mod7-grid.component.html'
})
export class Category4Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
