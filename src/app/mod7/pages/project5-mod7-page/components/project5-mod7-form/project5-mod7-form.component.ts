...
@Component({
  selector: 'app-mod7-project5-mod7-form',
  templateUrl: './project5-mod7-form.component.html'
})
export class Project5Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project5-mod7']);
  }
