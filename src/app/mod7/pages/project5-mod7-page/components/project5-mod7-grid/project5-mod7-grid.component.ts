...
@Component({
  selector: 'app-mod7-project5-mod7-grid',
  templateUrl: './project5-mod7-grid.component.html'
})
export class Project5Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
