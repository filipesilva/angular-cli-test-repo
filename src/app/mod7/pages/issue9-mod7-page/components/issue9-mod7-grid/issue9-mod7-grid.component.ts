...
@Component({
  selector: 'app-mod7-issue9-mod7-grid',
  templateUrl: './issue9-mod7-grid.component.html'
})
export class Issue9Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
