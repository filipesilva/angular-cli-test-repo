...
@Component({
  selector: 'app-mod7-status4-mod7-grid',
  templateUrl: './status4-mod7-grid.component.html'
})
export class Status4Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
