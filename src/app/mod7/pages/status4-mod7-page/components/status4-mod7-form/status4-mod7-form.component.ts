...
@Component({
  selector: 'app-mod7-status4-mod7-form',
  templateUrl: './status4-mod7-form.component.html'
})
export class Status4Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/status4-mod7']);
  }
