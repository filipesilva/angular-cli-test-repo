...
@Component({
  selector: 'app-mod7-status10-mod7-form',
  templateUrl: './status10-mod7-form.component.html'
})
export class Status10Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/status10-mod7']);
  }
