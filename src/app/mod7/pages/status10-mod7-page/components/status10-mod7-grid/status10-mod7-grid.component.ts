...
@Component({
  selector: 'app-mod7-status10-mod7-grid',
  templateUrl: './status10-mod7-grid.component.html'
})
export class Status10Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
