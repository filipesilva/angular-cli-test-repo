...
@Component({
  selector: 'app-mod7-category7-mod7-form',
  templateUrl: './category7-mod7-form.component.html'
})
export class Category7Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/category7-mod7']);
  }
