...
@Component({
  selector: 'app-mod7-category7-mod7-grid',
  templateUrl: './category7-mod7-grid.component.html'
})
export class Category7Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
