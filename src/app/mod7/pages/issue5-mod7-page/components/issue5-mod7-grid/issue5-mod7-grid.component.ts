...
@Component({
  selector: 'app-mod7-issue5-mod7-grid',
  templateUrl: './issue5-mod7-grid.component.html'
})
export class Issue5Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
