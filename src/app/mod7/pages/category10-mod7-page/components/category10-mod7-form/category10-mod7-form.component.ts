...
@Component({
  selector: 'app-mod7-category10-mod7-form',
  templateUrl: './category10-mod7-form.component.html'
})
export class Category10Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/category10-mod7']);
  }
