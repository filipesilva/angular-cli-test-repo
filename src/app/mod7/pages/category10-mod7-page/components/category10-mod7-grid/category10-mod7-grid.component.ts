...
@Component({
  selector: 'app-mod7-category10-mod7-grid',
  templateUrl: './category10-mod7-grid.component.html'
})
export class Category10Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
