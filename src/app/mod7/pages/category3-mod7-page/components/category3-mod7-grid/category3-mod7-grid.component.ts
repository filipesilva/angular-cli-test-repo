...
@Component({
  selector: 'app-mod7-category3-mod7-grid',
  templateUrl: './category3-mod7-grid.component.html'
})
export class Category3Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
