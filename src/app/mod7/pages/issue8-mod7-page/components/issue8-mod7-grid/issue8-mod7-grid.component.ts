...
@Component({
  selector: 'app-mod7-issue8-mod7-grid',
  templateUrl: './issue8-mod7-grid.component.html'
})
export class Issue8Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
