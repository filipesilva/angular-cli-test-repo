...
@Component({
  selector: 'app-mod7-project2-mod7-grid',
  templateUrl: './project2-mod7-grid.component.html'
})
export class Project2Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
