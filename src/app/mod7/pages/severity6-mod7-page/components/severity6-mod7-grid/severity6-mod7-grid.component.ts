...
@Component({
  selector: 'app-mod7-severity6-mod7-grid',
  templateUrl: './severity6-mod7-grid.component.html'
})
export class Severity6Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
