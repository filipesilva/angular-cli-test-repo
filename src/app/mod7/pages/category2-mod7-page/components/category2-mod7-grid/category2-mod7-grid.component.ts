...
@Component({
  selector: 'app-mod7-category2-mod7-grid',
  templateUrl: './category2-mod7-grid.component.html'
})
export class Category2Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
