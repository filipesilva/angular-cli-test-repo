...
@Component({
  selector: 'app-mod7-category2-mod7-form',
  templateUrl: './category2-mod7-form.component.html'
})
export class Category2Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/category2-mod7']);
  }
