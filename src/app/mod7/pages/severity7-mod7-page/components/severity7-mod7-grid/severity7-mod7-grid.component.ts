...
@Component({
  selector: 'app-mod7-severity7-mod7-grid',
  templateUrl: './severity7-mod7-grid.component.html'
})
export class Severity7Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
