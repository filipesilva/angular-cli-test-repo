...
@Component({
  selector: 'app-mod7-severity7-mod7-form',
  templateUrl: './severity7-mod7-form.component.html'
})
export class Severity7Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/severity7-mod7']);
  }
