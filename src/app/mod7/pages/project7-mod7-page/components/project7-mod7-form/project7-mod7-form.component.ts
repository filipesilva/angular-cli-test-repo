...
@Component({
  selector: 'app-mod7-project7-mod7-form',
  templateUrl: './project7-mod7-form.component.html'
})
export class Project7Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project7-mod7']);
  }
