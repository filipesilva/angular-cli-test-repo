...
@Component({
  selector: 'app-mod7-project7-mod7-grid',
  templateUrl: './project7-mod7-grid.component.html'
})
export class Project7Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
