...
@Component({
  selector: 'app-mod7-severity1-mod7-grid',
  templateUrl: './severity1-mod7-grid.component.html'
})
export class Severity1Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
