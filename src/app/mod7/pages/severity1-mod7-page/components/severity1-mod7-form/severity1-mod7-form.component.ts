...
@Component({
  selector: 'app-mod7-severity1-mod7-form',
  templateUrl: './severity1-mod7-form.component.html'
})
export class Severity1Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/severity1-mod7']);
  }
