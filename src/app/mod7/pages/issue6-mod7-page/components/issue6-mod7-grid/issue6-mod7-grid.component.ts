...
@Component({
  selector: 'app-mod7-issue6-mod7-grid',
  templateUrl: './issue6-mod7-grid.component.html'
})
export class Issue6Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
