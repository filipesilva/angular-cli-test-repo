...
@Component({
  selector: 'app-mod7-category9-mod7-grid',
  templateUrl: './category9-mod7-grid.component.html'
})
export class Category9Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
