...
@Component({
  selector: 'app-mod7-project8-mod7-form',
  templateUrl: './project8-mod7-form.component.html'
})
export class Project8Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project8-mod7']);
  }
