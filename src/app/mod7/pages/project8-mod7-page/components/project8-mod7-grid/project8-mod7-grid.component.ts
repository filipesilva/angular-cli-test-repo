...
@Component({
  selector: 'app-mod7-project8-mod7-grid',
  templateUrl: './project8-mod7-grid.component.html'
})
export class Project8Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
