...
@Component({
  selector: 'app-mod7-project1-mod7-grid',
  templateUrl: './project1-mod7-grid.component.html'
})
export class Project1Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
