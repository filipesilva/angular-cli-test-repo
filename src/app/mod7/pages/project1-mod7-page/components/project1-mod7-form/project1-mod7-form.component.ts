...
@Component({
  selector: 'app-mod7-project1-mod7-form',
  templateUrl: './project1-mod7-form.component.html'
})
export class Project1Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project1-mod7']);
  }
