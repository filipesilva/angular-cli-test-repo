...
@Component({
  selector: 'app-mod7-severity10-mod7-grid',
  templateUrl: './severity10-mod7-grid.component.html'
})
export class Severity10Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
