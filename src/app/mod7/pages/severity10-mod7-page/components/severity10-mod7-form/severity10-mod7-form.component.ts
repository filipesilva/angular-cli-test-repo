...
@Component({
  selector: 'app-mod7-severity10-mod7-form',
  templateUrl: './severity10-mod7-form.component.html'
})
export class Severity10Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/severity10-mod7']);
  }
