...
@Component({
  selector: 'app-mod7-status7-mod7-grid',
  templateUrl: './status7-mod7-grid.component.html'
})
export class Status7Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
