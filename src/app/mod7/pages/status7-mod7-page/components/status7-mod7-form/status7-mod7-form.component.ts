...
@Component({
  selector: 'app-mod7-status7-mod7-form',
  templateUrl: './status7-mod7-form.component.html'
})
export class Status7Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/status7-mod7']);
  }
