...
@Component({
  selector: 'app-mod7-severity9-mod7-grid',
  templateUrl: './severity9-mod7-grid.component.html'
})
export class Severity9Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
