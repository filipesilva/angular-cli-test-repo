...
@Component({
  selector: 'app-mod7-severity9-mod7-form',
  templateUrl: './severity9-mod7-form.component.html'
})
export class Severity9Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/severity9-mod7']);
  }
