...
@Component({
  selector: 'app-mod7-issue2-mod7-grid',
  templateUrl: './issue2-mod7-grid.component.html'
})
export class Issue2Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
