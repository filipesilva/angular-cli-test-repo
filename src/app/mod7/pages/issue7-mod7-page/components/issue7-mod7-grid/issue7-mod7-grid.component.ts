...
@Component({
  selector: 'app-mod7-issue7-mod7-grid',
  templateUrl: './issue7-mod7-grid.component.html'
})
export class Issue7Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
