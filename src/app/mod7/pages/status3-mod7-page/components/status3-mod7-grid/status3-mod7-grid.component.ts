...
@Component({
  selector: 'app-mod7-status3-mod7-grid',
  templateUrl: './status3-mod7-grid.component.html'
})
export class Status3Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
