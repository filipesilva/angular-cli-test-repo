...
@Component({
  selector: 'app-mod7-status3-mod7-form',
  templateUrl: './status3-mod7-form.component.html'
})
export class Status3Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/status3-mod7']);
  }
