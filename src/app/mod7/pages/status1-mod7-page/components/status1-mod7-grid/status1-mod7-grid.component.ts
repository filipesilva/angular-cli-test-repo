...
@Component({
  selector: 'app-mod7-status1-mod7-grid',
  templateUrl: './status1-mod7-grid.component.html'
})
export class Status1Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
