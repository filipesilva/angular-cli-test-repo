...
@Component({
  selector: 'app-mod7-category1-mod7-grid',
  templateUrl: './category1-mod7-grid.component.html'
})
export class Category1Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
