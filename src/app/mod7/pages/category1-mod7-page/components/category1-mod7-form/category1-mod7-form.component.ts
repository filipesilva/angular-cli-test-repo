...
@Component({
  selector: 'app-mod7-category1-mod7-form',
  templateUrl: './category1-mod7-form.component.html'
})
export class Category1Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/category1-mod7']);
  }
