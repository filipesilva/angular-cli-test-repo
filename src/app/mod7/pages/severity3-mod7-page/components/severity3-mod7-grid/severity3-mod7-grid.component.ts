...
@Component({
  selector: 'app-mod7-severity3-mod7-grid',
  templateUrl: './severity3-mod7-grid.component.html'
})
export class Severity3Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
