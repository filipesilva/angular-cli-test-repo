...
@Component({
  selector: 'app-mod7-project9-mod7-grid',
  templateUrl: './project9-mod7-grid.component.html'
})
export class Project9Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
