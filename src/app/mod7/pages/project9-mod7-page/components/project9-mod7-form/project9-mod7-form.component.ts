...
@Component({
  selector: 'app-mod7-project9-mod7-form',
  templateUrl: './project9-mod7-form.component.html'
})
export class Project9Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project9-mod7']);
  }
