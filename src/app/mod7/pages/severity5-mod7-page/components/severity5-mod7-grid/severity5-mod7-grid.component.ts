...
@Component({
  selector: 'app-mod7-severity5-mod7-grid',
  templateUrl: './severity5-mod7-grid.component.html'
})
export class Severity5Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
