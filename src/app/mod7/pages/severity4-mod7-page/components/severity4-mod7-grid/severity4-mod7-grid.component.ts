...
@Component({
  selector: 'app-mod7-severity4-mod7-grid',
  templateUrl: './severity4-mod7-grid.component.html'
})
export class Severity4Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
