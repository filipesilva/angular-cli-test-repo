...
@Component({
  selector: 'app-mod7-category8-mod7-grid',
  templateUrl: './category8-mod7-grid.component.html'
})
export class Category8Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
