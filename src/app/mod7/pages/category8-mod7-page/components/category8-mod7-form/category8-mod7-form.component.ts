...
@Component({
  selector: 'app-mod7-category8-mod7-form',
  templateUrl: './category8-mod7-form.component.html'
})
export class Category8Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/category8-mod7']);
  }
