...
@Component({
  selector: 'app-mod7-issue3-mod7-grid',
  templateUrl: './issue3-mod7-grid.component.html'
})
export class Issue3Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
