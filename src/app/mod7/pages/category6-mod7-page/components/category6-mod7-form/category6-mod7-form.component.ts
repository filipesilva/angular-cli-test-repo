...
@Component({
  selector: 'app-mod7-category6-mod7-form',
  templateUrl: './category6-mod7-form.component.html'
})
export class Category6Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/category6-mod7']);
  }
