...
@Component({
  selector: 'app-mod7-category6-mod7-grid',
  templateUrl: './category6-mod7-grid.component.html'
})
export class Category6Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
