...
@Component({
  selector: 'app-mod7-severity2-mod7-form',
  templateUrl: './severity2-mod7-form.component.html'
})
export class Severity2Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/severity2-mod7']);
  }
