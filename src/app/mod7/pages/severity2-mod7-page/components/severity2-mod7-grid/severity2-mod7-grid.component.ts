...
@Component({
  selector: 'app-mod7-severity2-mod7-grid',
  templateUrl: './severity2-mod7-grid.component.html'
})
export class Severity2Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
