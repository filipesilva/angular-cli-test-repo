...
@Component({
  selector: 'app-mod7-issue10-mod7-grid',
  templateUrl: './issue10-mod7-grid.component.html'
})
export class Issue10Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
