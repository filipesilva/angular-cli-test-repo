...
@Component({
  selector: 'app-mod7-issue10-mod7-form',
  templateUrl: './issue10-mod7-form.component.html'
})
export class Issue10Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/issue10-mod7']);
  }
  ...
  private loadSelects(): void {
    this.project10Mod7Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject10Mod7 = items;
      });
    ...
    this.category10Mod7Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory10Mod7 = items;
      });
    ...
    this.status10Mod7Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus10Mod7 = items;
      });
    ...
    this.severity10Mod7Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity10Mod7 = items;
      });
  }
