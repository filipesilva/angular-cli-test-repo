...
@Component({
  selector: 'app-mod7-status5-mod7-grid',
  templateUrl: './status5-mod7-grid.component.html'
})
export class Status5Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
