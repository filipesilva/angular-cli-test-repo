...
@Component({
  selector: 'app-mod7-category5-mod7-form',
  templateUrl: './category5-mod7-form.component.html'
})
export class Category5Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/category5-mod7']);
  }
