...
@Component({
  selector: 'app-mod7-category5-mod7-grid',
  templateUrl: './category5-mod7-grid.component.html'
})
export class Category5Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
