...
@Component({
  selector: 'app-mod7-project3-mod7-grid',
  templateUrl: './project3-mod7-grid.component.html'
})
export class Project3Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
