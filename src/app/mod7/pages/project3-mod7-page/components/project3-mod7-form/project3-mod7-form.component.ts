...
@Component({
  selector: 'app-mod7-project3-mod7-form',
  templateUrl: './project3-mod7-form.component.html'
})
export class Project3Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project3-mod7']);
  }
