...
@Component({
  selector: 'app-mod7-issue4-mod7-grid',
  templateUrl: './issue4-mod7-grid.component.html'
})
export class Issue4Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
