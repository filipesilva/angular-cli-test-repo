...
@Component({
  selector: 'app-mod7-issue1-mod7-grid',
  templateUrl: './issue1-mod7-grid.component.html'
})
export class Issue1Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
