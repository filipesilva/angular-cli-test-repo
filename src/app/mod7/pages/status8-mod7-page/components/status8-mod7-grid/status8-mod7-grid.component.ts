...
@Component({
  selector: 'app-mod7-status8-mod7-grid',
  templateUrl: './status8-mod7-grid.component.html'
})
export class Status8Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
