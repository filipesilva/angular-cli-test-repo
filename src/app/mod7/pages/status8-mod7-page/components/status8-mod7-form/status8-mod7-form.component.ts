...
@Component({
  selector: 'app-mod7-status8-mod7-form',
  templateUrl: './status8-mod7-form.component.html'
})
export class Status8Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/status8-mod7']);
  }
