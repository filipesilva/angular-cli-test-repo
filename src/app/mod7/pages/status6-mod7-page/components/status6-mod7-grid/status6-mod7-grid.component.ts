...
@Component({
  selector: 'app-mod7-status6-mod7-grid',
  templateUrl: './status6-mod7-grid.component.html'
})
export class Status6Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
