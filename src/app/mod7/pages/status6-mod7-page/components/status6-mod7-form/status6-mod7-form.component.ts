...
@Component({
  selector: 'app-mod7-status6-mod7-form',
  templateUrl: './status6-mod7-form.component.html'
})
export class Status6Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/status6-mod7']);
  }
