...
@Component({
  selector: 'app-mod7-project6-mod7-grid',
  templateUrl: './project6-mod7-grid.component.html'
})
export class Project6Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
