...
@Component({
  selector: 'app-mod7-project6-mod7-form',
  templateUrl: './project6-mod7-form.component.html'
})
export class Project6Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project6-mod7']);
  }
