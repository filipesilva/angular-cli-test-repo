...
@Component({
  selector: 'app-mod7-project4-mod7-form',
  templateUrl: './project4-mod7-form.component.html'
})
export class Project4Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project4-mod7']);
  }
