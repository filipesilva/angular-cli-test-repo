...
@Component({
  selector: 'app-mod7-project4-mod7-grid',
  templateUrl: './project4-mod7-grid.component.html'
})
export class Project4Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
