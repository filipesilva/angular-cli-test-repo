...
@Component({
  selector: 'app-mod7-project10-mod7-grid',
  templateUrl: './project10-mod7-grid.component.html'
})
export class Project10Mod7GridComponent extends GridComponent implements OnInit, OnDestroy {
