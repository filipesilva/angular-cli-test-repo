...
@Component({
  selector: 'app-mod7-project10-mod7-form',
  templateUrl: './project10-mod7-form.component.html'
})
export class Project10Mod7FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod7/project10-mod7']);
  }
