...
@Component({
  selector: 'app-cg-culture-grid',
  templateUrl: './culture-grid.component.html'
})
export class CultureGridComponent extends GridComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    super.init('cultureName', true, 10, () => this.get());
  }
