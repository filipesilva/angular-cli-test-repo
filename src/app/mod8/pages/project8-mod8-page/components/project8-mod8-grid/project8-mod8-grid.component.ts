...
@Component({
  selector: 'app-mod8-project8-mod8-grid',
  templateUrl: './project8-mod8-grid.component.html'
})
export class Project8Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
