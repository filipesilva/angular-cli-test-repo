...
@Component({
  selector: 'app-mod8-project8-mod8-form',
  templateUrl: './project8-mod8-form.component.html'
})
export class Project8Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project8-mod8']);
  }
