...
@Component({
  selector: 'app-mod8-status9-mod8-grid',
  templateUrl: './status9-mod8-grid.component.html'
})
export class Status9Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
