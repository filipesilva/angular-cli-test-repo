...
@Component({
  selector: 'app-mod8-issue6-mod8-grid',
  templateUrl: './issue6-mod8-grid.component.html'
})
export class Issue6Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
