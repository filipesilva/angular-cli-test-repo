...
@Component({
  selector: 'app-mod8-severity2-mod8-grid',
  templateUrl: './severity2-mod8-grid.component.html'
})
export class Severity2Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
