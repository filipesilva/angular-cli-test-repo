...
@Component({
  selector: 'app-mod8-severity2-mod8-form',
  templateUrl: './severity2-mod8-form.component.html'
})
export class Severity2Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/severity2-mod8']);
  }
