...
@Component({
  selector: 'app-mod8-project2-mod8-form',
  templateUrl: './project2-mod8-form.component.html'
})
export class Project2Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project2-mod8']);
  }
