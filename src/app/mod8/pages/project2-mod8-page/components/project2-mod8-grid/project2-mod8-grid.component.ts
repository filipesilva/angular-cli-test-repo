...
@Component({
  selector: 'app-mod8-project2-mod8-grid',
  templateUrl: './project2-mod8-grid.component.html'
})
export class Project2Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
