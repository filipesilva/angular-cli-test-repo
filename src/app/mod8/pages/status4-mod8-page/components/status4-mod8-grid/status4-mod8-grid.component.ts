...
@Component({
  selector: 'app-mod8-status4-mod8-grid',
  templateUrl: './status4-mod8-grid.component.html'
})
export class Status4Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
