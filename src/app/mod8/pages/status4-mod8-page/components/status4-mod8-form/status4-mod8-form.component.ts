...
@Component({
  selector: 'app-mod8-status4-mod8-form',
  templateUrl: './status4-mod8-form.component.html'
})
export class Status4Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status4-mod8']);
  }
