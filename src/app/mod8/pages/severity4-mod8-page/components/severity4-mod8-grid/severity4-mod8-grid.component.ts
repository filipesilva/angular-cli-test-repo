...
@Component({
  selector: 'app-mod8-severity4-mod8-grid',
  templateUrl: './severity4-mod8-grid.component.html'
})
export class Severity4Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
  ...
  public edit(id: number) {
    this.router.navigate(['/mod8/severity4-mod8', { id }]);
  }
