...
@Component({
  selector: 'app-mod8-status1-mod8-grid',
  templateUrl: './status1-mod8-grid.component.html'
})
export class Status1Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
