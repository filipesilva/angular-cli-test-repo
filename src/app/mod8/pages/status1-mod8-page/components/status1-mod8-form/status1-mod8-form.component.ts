...
@Component({
  selector: 'app-mod8-status1-mod8-form',
  templateUrl: './status1-mod8-form.component.html'
})
export class Status1Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status1-mod8']);
  }
