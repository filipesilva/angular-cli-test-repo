...
@Component({
  selector: 'app-mod8-category2-mod8-grid',
  templateUrl: './category2-mod8-grid.component.html'
})
export class Category2Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
