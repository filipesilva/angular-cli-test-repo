...
@Component({
  selector: 'app-mod8-category2-mod8-form',
  templateUrl: './category2-mod8-form.component.html'
})
export class Category2Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category2-mod8']);
  }
