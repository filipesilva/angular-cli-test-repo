...
@Component({
  selector: 'app-mod8-issue7-mod8-grid',
  templateUrl: './issue7-mod8-grid.component.html'
})
export class Issue7Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
