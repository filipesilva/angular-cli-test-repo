...
@Component({
  selector: 'app-mod8-issue7-mod8-form',
  templateUrl: './issue7-mod8-form.component.html'
})
export class Issue7Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/issue7-mod8']);
  }
  ...
  private loadSelects(): void {
    this.project7Mod8Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject7Mod8 = items;
      });
    ...
    this.category7Mod8Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory7Mod8 = items;
      });
    ...
    this.status7Mod8Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus7Mod8 = items;
      });
    ...
    this.severity7Mod8Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity7Mod8 = items;
      });
  }
