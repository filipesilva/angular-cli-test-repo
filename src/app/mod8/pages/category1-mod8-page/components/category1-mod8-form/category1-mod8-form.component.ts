...
@Component({
  selector: 'app-mod8-category1-mod8-form',
  templateUrl: './category1-mod8-form.component.html'
})
export class Category1Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category1-mod8']);
  }
