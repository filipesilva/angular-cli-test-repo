...
@Component({
  selector: 'app-mod8-category1-mod8-grid',
  templateUrl: './category1-mod8-grid.component.html'
})
export class Category1Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
