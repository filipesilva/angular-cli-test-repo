...
@Component({
  selector: 'app-mod8-status7-mod8-form',
  templateUrl: './status7-mod8-form.component.html'
})
export class Status7Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status7-mod8']);
  }
