...
@Component({
  selector: 'app-mod8-status7-mod8-grid',
  templateUrl: './status7-mod8-grid.component.html'
})
export class Status7Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
