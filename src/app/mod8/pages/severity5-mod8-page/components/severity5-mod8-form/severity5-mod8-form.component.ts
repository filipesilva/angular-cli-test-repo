...
@Component({
  selector: 'app-mod8-severity5-mod8-form',
  templateUrl: './severity5-mod8-form.component.html'
})
export class Severity5Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/severity5-mod8']);
  }
