...
@Component({
  selector: 'app-mod8-severity5-mod8-grid',
  templateUrl: './severity5-mod8-grid.component.html'
})
export class Severity5Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
