...
@Component({
  selector: 'app-mod8-category7-mod8-grid',
  templateUrl: './category7-mod8-grid.component.html'
})
export class Category7Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
