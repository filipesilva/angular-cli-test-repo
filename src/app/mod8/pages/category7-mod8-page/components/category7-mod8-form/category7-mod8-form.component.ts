...
@Component({
  selector: 'app-mod8-category7-mod8-form',
  templateUrl: './category7-mod8-form.component.html'
})
export class Category7Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category7-mod8']);
  }
