...
@Component({
  selector: 'app-mod8-project3-mod8-grid',
  templateUrl: './project3-mod8-grid.component.html'
})
export class Project3Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
