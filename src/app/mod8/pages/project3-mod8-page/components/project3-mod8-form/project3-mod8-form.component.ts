...
@Component({
  selector: 'app-mod8-project3-mod8-form',
  templateUrl: './project3-mod8-form.component.html'
})
export class Project3Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project3-mod8']);
  }
