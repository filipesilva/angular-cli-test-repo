...
@Component({
  selector: 'app-mod8-severity6-mod8-grid',
  templateUrl: './severity6-mod8-grid.component.html'
})
export class Severity6Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
