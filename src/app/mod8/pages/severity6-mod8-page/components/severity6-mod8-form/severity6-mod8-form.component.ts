...
@Component({
  selector: 'app-mod8-severity6-mod8-form',
  templateUrl: './severity6-mod8-form.component.html'
})
export class Severity6Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/severity6-mod8']);
  }
