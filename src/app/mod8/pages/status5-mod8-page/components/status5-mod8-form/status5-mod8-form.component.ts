...
@Component({
  selector: 'app-mod8-status5-mod8-form',
  templateUrl: './status5-mod8-form.component.html'
})
export class Status5Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status5-mod8']);
  }
