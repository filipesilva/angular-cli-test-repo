...
@Component({
  selector: 'app-mod8-status5-mod8-grid',
  templateUrl: './status5-mod8-grid.component.html'
})
export class Status5Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
