...
@Component({
  selector: 'app-mod8-issue3-mod8-grid',
  templateUrl: './issue3-mod8-grid.component.html'
})
export class Issue3Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
