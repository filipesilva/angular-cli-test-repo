...
@Component({
  selector: 'app-mod8-status8-mod8-grid',
  templateUrl: './status8-mod8-grid.component.html'
})
export class Status8Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
