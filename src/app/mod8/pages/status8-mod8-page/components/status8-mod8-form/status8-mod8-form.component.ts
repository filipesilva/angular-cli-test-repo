...
@Component({
  selector: 'app-mod8-status8-mod8-form',
  templateUrl: './status8-mod8-form.component.html'
})
export class Status8Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status8-mod8']);
  }
