...
@Component({
  selector: 'app-mod8-category3-mod8-grid',
  templateUrl: './category3-mod8-grid.component.html'
})
export class Category3Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
