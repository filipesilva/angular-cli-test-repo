...
@Component({
  selector: 'app-mod8-category3-mod8-form',
  templateUrl: './category3-mod8-form.component.html'
})
export class Category3Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category3-mod8']);
  }
