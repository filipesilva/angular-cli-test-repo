...
@Component({
  selector: 'app-mod8-severity8-mod8-grid',
  templateUrl: './severity8-mod8-grid.component.html'
})
export class Severity8Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
  ...
  public edit(id: number) {
    this.router.navigate(['/mod8/severity8-mod8', { id }]);
  }
