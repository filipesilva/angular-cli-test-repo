...
@Component({
  selector: 'app-mod8-status6-mod8-grid',
  templateUrl: './status6-mod8-grid.component.html'
})
export class Status6Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
