...
@Component({
  selector: 'app-mod8-status6-mod8-form',
  templateUrl: './status6-mod8-form.component.html'
})
export class Status6Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status6-mod8']);
  }
