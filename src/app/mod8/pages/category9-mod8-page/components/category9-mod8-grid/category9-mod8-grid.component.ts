...
@Component({
  selector: 'app-mod8-category9-mod8-grid',
  templateUrl: './category9-mod8-grid.component.html'
})
export class Category9Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
