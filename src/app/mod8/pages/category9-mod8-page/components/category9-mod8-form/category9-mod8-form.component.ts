...
@Component({
  selector: 'app-mod8-category9-mod8-form',
  templateUrl: './category9-mod8-form.component.html'
})
export class Category9Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category9-mod8']);
  }
