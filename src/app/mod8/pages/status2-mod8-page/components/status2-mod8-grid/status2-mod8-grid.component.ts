...
@Component({
  selector: 'app-mod8-status2-mod8-grid',
  templateUrl: './status2-mod8-grid.component.html'
})
export class Status2Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
