...
@Component({
  selector: 'app-mod8-status2-mod8-form',
  templateUrl: './status2-mod8-form.component.html'
})
export class Status2Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status2-mod8']);
  }
