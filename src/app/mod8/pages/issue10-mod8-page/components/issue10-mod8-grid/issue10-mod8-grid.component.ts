...
@Component({
  selector: 'app-mod8-issue10-mod8-grid',
  templateUrl: './issue10-mod8-grid.component.html'
})
export class Issue10Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
