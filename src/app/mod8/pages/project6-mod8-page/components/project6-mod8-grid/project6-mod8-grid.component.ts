...
@Component({
  selector: 'app-mod8-project6-mod8-grid',
  templateUrl: './project6-mod8-grid.component.html'
})
export class Project6Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
