...
@Component({
  selector: 'app-mod8-project6-mod8-form',
  templateUrl: './project6-mod8-form.component.html'
})
export class Project6Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project6-mod8']);
  }
