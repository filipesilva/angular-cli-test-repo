...
@Component({
  selector: 'app-mod8-project4-mod8-form',
  templateUrl: './project4-mod8-form.component.html'
})
export class Project4Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project4-mod8']);
  }
