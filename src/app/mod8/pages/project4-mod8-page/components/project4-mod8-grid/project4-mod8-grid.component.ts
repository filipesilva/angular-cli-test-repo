...
@Component({
  selector: 'app-mod8-project4-mod8-grid',
  templateUrl: './project4-mod8-grid.component.html'
})
export class Project4Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
