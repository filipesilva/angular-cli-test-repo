...
@Component({
  selector: 'app-mod8-category6-mod8-grid',
  templateUrl: './category6-mod8-grid.component.html'
})
export class Category6Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
