...
@Component({
  selector: 'app-mod8-project1-mod8-grid',
  templateUrl: './project1-mod8-grid.component.html'
})
export class Project1Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
