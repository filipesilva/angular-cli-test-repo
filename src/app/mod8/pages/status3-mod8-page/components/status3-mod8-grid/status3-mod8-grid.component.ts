...
@Component({
  selector: 'app-mod8-status3-mod8-grid',
  templateUrl: './status3-mod8-grid.component.html'
})
export class Status3Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
