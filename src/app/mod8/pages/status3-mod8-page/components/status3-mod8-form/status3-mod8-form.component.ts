...
@Component({
  selector: 'app-mod8-status3-mod8-form',
  templateUrl: './status3-mod8-form.component.html'
})
export class Status3Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status3-mod8']);
  }
