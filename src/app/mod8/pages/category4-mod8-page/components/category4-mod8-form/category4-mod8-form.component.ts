...
@Component({
  selector: 'app-mod8-category4-mod8-form',
  templateUrl: './category4-mod8-form.component.html'
})
export class Category4Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category4-mod8']);
  }
