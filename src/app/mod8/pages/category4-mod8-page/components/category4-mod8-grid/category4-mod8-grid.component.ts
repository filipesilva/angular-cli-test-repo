...
@Component({
  selector: 'app-mod8-category4-mod8-grid',
  templateUrl: './category4-mod8-grid.component.html'
})
export class Category4Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
