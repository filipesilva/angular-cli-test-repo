...
@Component({
  selector: 'app-mod8-category10-mod8-grid',
  templateUrl: './category10-mod8-grid.component.html'
})
export class Category10Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
