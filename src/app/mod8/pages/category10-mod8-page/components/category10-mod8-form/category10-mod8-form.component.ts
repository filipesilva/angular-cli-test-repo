...
@Component({
  selector: 'app-mod8-category10-mod8-form',
  templateUrl: './category10-mod8-form.component.html'
})
export class Category10Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category10-mod8']);
  }
