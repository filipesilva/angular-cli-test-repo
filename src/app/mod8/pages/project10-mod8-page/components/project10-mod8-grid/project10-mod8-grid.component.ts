...
@Component({
  selector: 'app-mod8-project10-mod8-grid',
  templateUrl: './project10-mod8-grid.component.html'
})
export class Project10Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
