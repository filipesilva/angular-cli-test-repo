...
@Component({
  selector: 'app-mod8-project10-mod8-form',
  templateUrl: './project10-mod8-form.component.html'
})
export class Project10Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project10-mod8']);
  }
