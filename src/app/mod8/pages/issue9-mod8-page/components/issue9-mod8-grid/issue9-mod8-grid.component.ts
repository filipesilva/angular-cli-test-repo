...
@Component({
  selector: 'app-mod8-issue9-mod8-grid',
  templateUrl: './issue9-mod8-grid.component.html'
})
export class Issue9Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
