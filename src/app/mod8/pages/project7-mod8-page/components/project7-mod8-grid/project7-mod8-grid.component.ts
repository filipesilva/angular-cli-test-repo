...
@Component({
  selector: 'app-mod8-project7-mod8-grid',
  templateUrl: './project7-mod8-grid.component.html'
})
export class Project7Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
