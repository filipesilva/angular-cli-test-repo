...
@Component({
  selector: 'app-mod8-project7-mod8-form',
  templateUrl: './project7-mod8-form.component.html'
})
export class Project7Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project7-mod8']);
  }
