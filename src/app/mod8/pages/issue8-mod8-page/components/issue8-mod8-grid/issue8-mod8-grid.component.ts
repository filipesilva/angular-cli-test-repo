...
@Component({
  selector: 'app-mod8-issue8-mod8-grid',
  templateUrl: './issue8-mod8-grid.component.html'
})
export class Issue8Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
