...
@Component({
  selector: 'app-mod8-issue2-mod8-grid',
  templateUrl: './issue2-mod8-grid.component.html'
})
export class Issue2Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
