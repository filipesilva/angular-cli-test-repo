...
@Component({
  selector: 'app-mod8-severity1-mod8-grid',
  templateUrl: './severity1-mod8-grid.component.html'
})
export class Severity1Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
