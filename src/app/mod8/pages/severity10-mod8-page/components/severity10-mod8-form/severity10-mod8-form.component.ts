...
@Component({
  selector: 'app-mod8-severity10-mod8-form',
  templateUrl: './severity10-mod8-form.component.html'
})
export class Severity10Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/severity10-mod8']);
  }
