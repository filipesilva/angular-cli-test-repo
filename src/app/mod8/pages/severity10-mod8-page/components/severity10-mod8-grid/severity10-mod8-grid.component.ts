...
@Component({
  selector: 'app-mod8-severity10-mod8-grid',
  templateUrl: './severity10-mod8-grid.component.html'
})
export class Severity10Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
