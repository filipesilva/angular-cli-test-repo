...
@Component({
  selector: 'app-mod8-issue5-mod8-grid',
  templateUrl: './issue5-mod8-grid.component.html'
})
export class Issue5Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
