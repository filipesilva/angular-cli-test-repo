...
@Component({
  selector: 'app-mod8-status10-mod8-form',
  templateUrl: './status10-mod8-form.component.html'
})
export class Status10Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/status10-mod8']);
  }
