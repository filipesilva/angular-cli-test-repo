...
@Component({
  selector: 'app-mod8-status10-mod8-grid',
  templateUrl: './status10-mod8-grid.component.html'
})
export class Status10Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
