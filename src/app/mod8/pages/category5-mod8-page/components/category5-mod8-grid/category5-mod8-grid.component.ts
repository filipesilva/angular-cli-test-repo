...
@Component({
  selector: 'app-mod8-category5-mod8-grid',
  templateUrl: './category5-mod8-grid.component.html'
})
export class Category5Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
