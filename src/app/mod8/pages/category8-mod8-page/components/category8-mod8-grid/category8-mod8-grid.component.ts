...
@Component({
  selector: 'app-mod8-category8-mod8-grid',
  templateUrl: './category8-mod8-grid.component.html'
})
export class Category8Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
