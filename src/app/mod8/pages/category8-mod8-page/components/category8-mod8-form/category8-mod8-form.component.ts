...
@Component({
  selector: 'app-mod8-category8-mod8-form',
  templateUrl: './category8-mod8-form.component.html'
})
export class Category8Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/category8-mod8']);
  }
