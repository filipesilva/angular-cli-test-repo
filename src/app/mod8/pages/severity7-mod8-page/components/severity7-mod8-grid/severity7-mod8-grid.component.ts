...
@Component({
  selector: 'app-mod8-severity7-mod8-grid',
  templateUrl: './severity7-mod8-grid.component.html'
})
export class Severity7Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
