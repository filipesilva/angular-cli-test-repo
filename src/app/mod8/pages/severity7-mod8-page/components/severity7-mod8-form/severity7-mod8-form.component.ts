...
@Component({
  selector: 'app-mod8-severity7-mod8-form',
  templateUrl: './severity7-mod8-form.component.html'
})
export class Severity7Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/severity7-mod8']);
  }
