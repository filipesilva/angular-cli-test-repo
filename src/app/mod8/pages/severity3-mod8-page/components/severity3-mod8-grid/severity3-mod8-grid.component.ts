...
@Component({
  selector: 'app-mod8-severity3-mod8-grid',
  templateUrl: './severity3-mod8-grid.component.html'
})
export class Severity3Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
  ...
  public edit(id: number) {
    this.router.navigate(['/mod8/severity3-mod8', { id }]);
  }
