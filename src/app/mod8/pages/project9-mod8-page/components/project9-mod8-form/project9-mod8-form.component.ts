...
@Component({
  selector: 'app-mod8-project9-mod8-form',
  templateUrl: './project9-mod8-form.component.html'
})
export class Project9Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project9-mod8']);
  }
