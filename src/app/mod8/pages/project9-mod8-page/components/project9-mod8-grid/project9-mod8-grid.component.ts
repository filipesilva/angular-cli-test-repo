...
@Component({
  selector: 'app-mod8-project9-mod8-grid',
  templateUrl: './project9-mod8-grid.component.html'
})
export class Project9Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
