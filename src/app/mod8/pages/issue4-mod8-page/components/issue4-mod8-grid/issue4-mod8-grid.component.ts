...
@Component({
  selector: 'app-mod8-issue4-mod8-grid',
  templateUrl: './issue4-mod8-grid.component.html'
})
export class Issue4Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
