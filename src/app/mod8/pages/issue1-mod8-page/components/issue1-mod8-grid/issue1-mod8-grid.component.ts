...
@Component({
  selector: 'app-mod8-issue1-mod8-grid',
  templateUrl: './issue1-mod8-grid.component.html'
})
export class Issue1Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
