...
@Component({
  selector: 'app-mod8-project5-mod8-grid',
  templateUrl: './project5-mod8-grid.component.html'
})
export class Project5Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
