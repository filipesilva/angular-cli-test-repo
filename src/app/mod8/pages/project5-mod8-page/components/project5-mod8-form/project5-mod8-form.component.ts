...
@Component({
  selector: 'app-mod8-project5-mod8-form',
  templateUrl: './project5-mod8-form.component.html'
})
export class Project5Mod8FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod8/project5-mod8']);
  }
