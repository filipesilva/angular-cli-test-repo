...
@Component({
  selector: 'app-mod8-severity9-mod8-grid',
  templateUrl: './severity9-mod8-grid.component.html'
})
export class Severity9Mod8GridComponent extends GridComponent implements OnInit, OnDestroy {
