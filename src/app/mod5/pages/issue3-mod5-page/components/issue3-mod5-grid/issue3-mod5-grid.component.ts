...
@Component({
  selector: 'app-mod5-issue3-mod5-grid',
  templateUrl: './issue3-mod5-grid.component.html'
})
export class Issue3Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
