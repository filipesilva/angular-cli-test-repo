...
@Component({
  selector: 'app-mod5-project5-mod5-grid',
  templateUrl: './project5-mod5-grid.component.html'
})
export class Project5Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
