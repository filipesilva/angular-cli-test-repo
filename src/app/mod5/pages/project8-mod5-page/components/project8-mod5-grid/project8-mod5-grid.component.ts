...
@Component({
  selector: 'app-mod5-project8-mod5-grid',
  templateUrl: './project8-mod5-grid.component.html'
})
export class Project8Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
