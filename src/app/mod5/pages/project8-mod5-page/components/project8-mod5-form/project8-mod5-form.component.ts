...
@Component({
  selector: 'app-mod5-project8-mod5-form',
  templateUrl: './project8-mod5-form.component.html'
})
export class Project8Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/project8-mod5']);
  }
