...
@Component({
  selector: 'app-mod5-severity7-mod5-form',
  templateUrl: './severity7-mod5-form.component.html'
})
export class Severity7Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity7-mod5']);
  }
