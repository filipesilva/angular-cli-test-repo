...
@Component({
  selector: 'app-mod5-severity7-mod5-grid',
  templateUrl: './severity7-mod5-grid.component.html'
})
export class Severity7Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
