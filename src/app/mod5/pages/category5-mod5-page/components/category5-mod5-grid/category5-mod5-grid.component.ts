...
@Component({
  selector: 'app-mod5-category5-mod5-grid',
  templateUrl: './category5-mod5-grid.component.html'
})
export class Category5Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
