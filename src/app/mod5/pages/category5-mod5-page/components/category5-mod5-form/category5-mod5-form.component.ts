...
@Component({
  selector: 'app-mod5-category5-mod5-form',
  templateUrl: './category5-mod5-form.component.html'
})
export class Category5Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category5-mod5']);
  }
