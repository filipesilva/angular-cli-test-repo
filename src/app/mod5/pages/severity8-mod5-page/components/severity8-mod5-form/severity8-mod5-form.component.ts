...
@Component({
  selector: 'app-mod5-severity8-mod5-form',
  templateUrl: './severity8-mod5-form.component.html'
})
export class Severity8Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity8-mod5']);
  }
