...
@Component({
  selector: 'app-mod5-severity8-mod5-grid',
  templateUrl: './severity8-mod5-grid.component.html'
})
export class Severity8Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
