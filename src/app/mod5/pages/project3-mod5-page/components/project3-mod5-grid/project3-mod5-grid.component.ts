...
@Component({
  selector: 'app-mod5-project3-mod5-grid',
  templateUrl: './project3-mod5-grid.component.html'
})
export class Project3Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
