...
@Component({
  selector: 'app-mod5-issue6-mod5-grid',
  templateUrl: './issue6-mod5-grid.component.html'
})
export class Issue6Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
