...
@Component({
  selector: 'app-mod5-status10-mod5-grid',
  templateUrl: './status10-mod5-grid.component.html'
})
export class Status10Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
