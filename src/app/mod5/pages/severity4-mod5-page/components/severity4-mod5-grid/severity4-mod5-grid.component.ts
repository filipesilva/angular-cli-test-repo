...
@Component({
  selector: 'app-mod5-severity4-mod5-grid',
  templateUrl: './severity4-mod5-grid.component.html'
})
export class Severity4Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
