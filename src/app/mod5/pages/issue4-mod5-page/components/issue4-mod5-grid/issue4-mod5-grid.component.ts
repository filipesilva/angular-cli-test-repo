...
@Component({
  selector: 'app-mod5-issue4-mod5-grid',
  templateUrl: './issue4-mod5-grid.component.html'
})
export class Issue4Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
