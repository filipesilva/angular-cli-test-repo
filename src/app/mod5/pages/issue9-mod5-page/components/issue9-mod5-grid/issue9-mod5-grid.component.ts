...
@Component({
  selector: 'app-mod5-issue9-mod5-grid',
  templateUrl: './issue9-mod5-grid.component.html'
})
export class Issue9Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
