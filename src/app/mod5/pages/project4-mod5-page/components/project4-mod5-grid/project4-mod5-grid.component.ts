...
@Component({
  selector: 'app-mod5-project4-mod5-grid',
  templateUrl: './project4-mod5-grid.component.html'
})
export class Project4Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
