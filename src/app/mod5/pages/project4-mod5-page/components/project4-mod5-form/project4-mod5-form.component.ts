...
@Component({
  selector: 'app-mod5-project4-mod5-form',
  templateUrl: './project4-mod5-form.component.html'
})
export class Project4Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/project4-mod5']);
  }
