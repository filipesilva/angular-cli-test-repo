...
@Component({
  selector: 'app-mod5-status2-mod5-grid',
  templateUrl: './status2-mod5-grid.component.html'
})
export class Status2Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
