...
@Component({
  selector: 'app-mod5-status2-mod5-form',
  templateUrl: './status2-mod5-form.component.html'
})
export class Status2Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/status2-mod5']);
  }
