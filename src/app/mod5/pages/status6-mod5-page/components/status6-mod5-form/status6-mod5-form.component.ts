...
@Component({
  selector: 'app-mod5-status6-mod5-form',
  templateUrl: './status6-mod5-form.component.html'
})
export class Status6Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/status6-mod5']);
  }
