...
@Component({
  selector: 'app-mod5-status6-mod5-grid',
  templateUrl: './status6-mod5-grid.component.html'
})
export class Status6Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
