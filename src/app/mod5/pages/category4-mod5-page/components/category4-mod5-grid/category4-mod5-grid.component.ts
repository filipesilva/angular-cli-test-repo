...
@Component({
  selector: 'app-mod5-category4-mod5-grid',
  templateUrl: './category4-mod5-grid.component.html'
})
export class Category4Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
