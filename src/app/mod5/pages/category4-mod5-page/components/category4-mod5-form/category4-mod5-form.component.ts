...
@Component({
  selector: 'app-mod5-category4-mod5-form',
  templateUrl: './category4-mod5-form.component.html'
})
export class Category4Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category4-mod5']);
  }
