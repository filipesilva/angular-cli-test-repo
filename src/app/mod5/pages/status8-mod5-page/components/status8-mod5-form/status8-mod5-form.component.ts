...
@Component({
  selector: 'app-mod5-status8-mod5-form',
  templateUrl: './status8-mod5-form.component.html'
})
export class Status8Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/status8-mod5']);
  }
