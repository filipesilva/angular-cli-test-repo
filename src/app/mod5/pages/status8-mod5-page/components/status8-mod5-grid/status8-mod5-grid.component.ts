...
@Component({
  selector: 'app-mod5-status8-mod5-grid',
  templateUrl: './status8-mod5-grid.component.html'
})
export class Status8Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
