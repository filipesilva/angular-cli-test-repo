...
@Component({
  selector: 'app-mod5-severity2-mod5-form',
  templateUrl: './severity2-mod5-form.component.html'
})
export class Severity2Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity2-mod5']);
  }
