...
@Component({
  selector: 'app-mod5-severity2-mod5-grid',
  templateUrl: './severity2-mod5-grid.component.html'
})
export class Severity2Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
