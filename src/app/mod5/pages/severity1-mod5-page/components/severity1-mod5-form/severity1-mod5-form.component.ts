...
@Component({
  selector: 'app-mod5-severity1-mod5-form',
  templateUrl: './severity1-mod5-form.component.html'
})
export class Severity1Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity1-mod5']);
  }
