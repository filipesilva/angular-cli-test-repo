...
@Component({
  selector: 'app-mod5-severity1-mod5-grid',
  templateUrl: './severity1-mod5-grid.component.html'
})
export class Severity1Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
