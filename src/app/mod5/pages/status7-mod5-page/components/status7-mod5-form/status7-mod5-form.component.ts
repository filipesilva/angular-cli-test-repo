...
@Component({
  selector: 'app-mod5-status7-mod5-form',
  templateUrl: './status7-mod5-form.component.html'
})
export class Status7Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/status7-mod5']);
  }
