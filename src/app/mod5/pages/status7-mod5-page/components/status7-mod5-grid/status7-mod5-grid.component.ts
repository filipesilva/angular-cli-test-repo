...
@Component({
  selector: 'app-mod5-status7-mod5-grid',
  templateUrl: './status7-mod5-grid.component.html'
})
export class Status7Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
