...
@Component({
  selector: 'app-mod5-severity3-mod5-form',
  templateUrl: './severity3-mod5-form.component.html'
})
export class Severity3Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity3-mod5']);
  }
