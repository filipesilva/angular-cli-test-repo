...
@Component({
  selector: 'app-mod5-severity3-mod5-grid',
  templateUrl: './severity3-mod5-grid.component.html'
})
export class Severity3Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
