...
@Component({
  selector: 'app-mod5-category3-mod5-grid',
  templateUrl: './category3-mod5-grid.component.html'
})
export class Category3Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
