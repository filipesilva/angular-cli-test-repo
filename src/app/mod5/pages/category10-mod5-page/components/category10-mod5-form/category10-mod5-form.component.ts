...
@Component({
  selector: 'app-mod5-category10-mod5-form',
  templateUrl: './category10-mod5-form.component.html'
})
export class Category10Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category10-mod5']);
  }
