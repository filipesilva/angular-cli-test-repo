...
@Component({
  selector: 'app-mod5-category10-mod5-grid',
  templateUrl: './category10-mod5-grid.component.html'
})
export class Category10Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
