...
@Component({
  selector: 'app-mod5-issue1-mod5-grid',
  templateUrl: './issue1-mod5-grid.component.html'
})
export class Issue1Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
