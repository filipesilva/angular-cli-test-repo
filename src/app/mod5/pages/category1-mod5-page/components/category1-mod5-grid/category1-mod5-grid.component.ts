...
@Component({
  selector: 'app-mod5-category1-mod5-grid',
  templateUrl: './category1-mod5-grid.component.html'
})
export class Category1Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
