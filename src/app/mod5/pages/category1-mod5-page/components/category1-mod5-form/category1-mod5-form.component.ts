...
@Component({
  selector: 'app-mod5-category1-mod5-form',
  templateUrl: './category1-mod5-form.component.html'
})
export class Category1Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category1-mod5']);
  }
