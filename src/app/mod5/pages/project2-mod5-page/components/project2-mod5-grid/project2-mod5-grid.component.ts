...
@Component({
  selector: 'app-mod5-project2-mod5-grid',
  templateUrl: './project2-mod5-grid.component.html'
})
export class Project2Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
