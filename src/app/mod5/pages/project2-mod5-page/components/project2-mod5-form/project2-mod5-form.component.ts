...
@Component({
  selector: 'app-mod5-project2-mod5-form',
  templateUrl: './project2-mod5-form.component.html'
})
export class Project2Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/project2-mod5']);
  }
