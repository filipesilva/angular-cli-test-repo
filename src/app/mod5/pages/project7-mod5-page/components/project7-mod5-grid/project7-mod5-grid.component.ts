...
@Component({
  selector: 'app-mod5-project7-mod5-grid',
  templateUrl: './project7-mod5-grid.component.html'
})
export class Project7Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
