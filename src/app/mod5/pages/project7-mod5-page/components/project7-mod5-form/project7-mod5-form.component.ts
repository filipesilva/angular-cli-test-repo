...
@Component({
  selector: 'app-mod5-project7-mod5-form',
  templateUrl: './project7-mod5-form.component.html'
})
export class Project7Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/project7-mod5']);
  }
