...
@Component({
  selector: 'app-mod5-issue10-mod5-grid',
  templateUrl: './issue10-mod5-grid.component.html'
})
export class Issue10Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
