...
@Component({
  selector: 'app-mod5-status1-mod5-grid',
  templateUrl: './status1-mod5-grid.component.html'
})
export class Status1Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
