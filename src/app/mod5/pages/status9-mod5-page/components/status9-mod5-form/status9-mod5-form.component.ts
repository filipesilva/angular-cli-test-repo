...
@Component({
  selector: 'app-mod5-status9-mod5-form',
  templateUrl: './status9-mod5-form.component.html'
})
export class Status9Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/status9-mod5']);
  }
