...
@Component({
  selector: 'app-mod5-status9-mod5-grid',
  templateUrl: './status9-mod5-grid.component.html'
})
export class Status9Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
