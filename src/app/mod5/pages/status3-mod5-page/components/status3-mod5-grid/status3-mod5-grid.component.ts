...
@Component({
  selector: 'app-mod5-status3-mod5-grid',
  templateUrl: './status3-mod5-grid.component.html'
})
export class Status3Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
