...
@Component({
  selector: 'app-mod5-issue2-mod5-form',
  templateUrl: './issue2-mod5-form.component.html'
})
export class Issue2Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/issue2-mod5']);
  }
  ...
  private loadSelects(): void {
    this.project2Mod5Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject2Mod5 = items;
      });
    ...
    this.category2Mod5Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory2Mod5 = items;
      });
    ...
    this.status2Mod5Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus2Mod5 = items;
      });
    ...
    this.severity2Mod5Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity2Mod5 = items;
      });
  }
