...
@Component({
  selector: 'app-mod5-issue2-mod5-grid',
  templateUrl: './issue2-mod5-grid.component.html'
})
export class Issue2Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
