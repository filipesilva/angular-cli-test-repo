...
@Component({
  selector: 'app-mod5-project1-mod5-form',
  templateUrl: './project1-mod5-form.component.html'
})
export class Project1Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/project1-mod5']);
  }
