...
@Component({
  selector: 'app-mod5-severity5-mod5-form',
  templateUrl: './severity5-mod5-form.component.html'
})
export class Severity5Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity5-mod5']);
  }
