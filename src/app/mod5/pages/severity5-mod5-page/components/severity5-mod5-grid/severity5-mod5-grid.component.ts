...
@Component({
  selector: 'app-mod5-severity5-mod5-grid',
  templateUrl: './severity5-mod5-grid.component.html'
})
export class Severity5Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
