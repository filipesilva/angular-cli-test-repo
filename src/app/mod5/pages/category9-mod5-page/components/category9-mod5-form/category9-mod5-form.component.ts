...
@Component({
  selector: 'app-mod5-category9-mod5-form',
  templateUrl: './category9-mod5-form.component.html'
})
export class Category9Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category9-mod5']);
  }
