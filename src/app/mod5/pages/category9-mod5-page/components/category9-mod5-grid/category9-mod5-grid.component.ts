...
@Component({
  selector: 'app-mod5-category9-mod5-grid',
  templateUrl: './category9-mod5-grid.component.html'
})
export class Category9Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
