...
@Component({
  selector: 'app-mod5-category2-mod5-grid',
  templateUrl: './category2-mod5-grid.component.html'
})
export class Category2Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
