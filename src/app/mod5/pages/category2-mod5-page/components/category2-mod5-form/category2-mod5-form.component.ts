...
@Component({
  selector: 'app-mod5-category2-mod5-form',
  templateUrl: './category2-mod5-form.component.html'
})
export class Category2Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category2-mod5']);
  }
