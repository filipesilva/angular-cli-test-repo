...
@Component({
  selector: 'app-mod5-status4-mod5-form',
  templateUrl: './status4-mod5-form.component.html'
})
export class Status4Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/status4-mod5']);
  }
