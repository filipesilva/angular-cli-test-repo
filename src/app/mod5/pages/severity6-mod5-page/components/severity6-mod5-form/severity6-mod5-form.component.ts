...
@Component({
  selector: 'app-mod5-severity6-mod5-form',
  templateUrl: './severity6-mod5-form.component.html'
})
export class Severity6Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity6-mod5']);
  }
