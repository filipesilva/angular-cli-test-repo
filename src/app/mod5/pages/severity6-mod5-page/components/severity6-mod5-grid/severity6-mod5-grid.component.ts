...
@Component({
  selector: 'app-mod5-severity6-mod5-grid',
  templateUrl: './severity6-mod5-grid.component.html'
})
export class Severity6Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
