...
@Component({
  selector: 'app-mod5-issue8-mod5-grid',
  templateUrl: './issue8-mod5-grid.component.html'
})
export class Issue8Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
