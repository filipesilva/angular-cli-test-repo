...
@Component({
  selector: 'app-mod5-status5-mod5-grid',
  templateUrl: './status5-mod5-grid.component.html'
})
export class Status5Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
