...
@Component({
  selector: 'app-mod5-status5-mod5-form',
  templateUrl: './status5-mod5-form.component.html'
})
export class Status5Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/status5-mod5']);
  }
