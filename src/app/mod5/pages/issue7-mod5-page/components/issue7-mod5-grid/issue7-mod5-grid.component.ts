...
@Component({
  selector: 'app-mod5-issue7-mod5-grid',
  templateUrl: './issue7-mod5-grid.component.html'
})
export class Issue7Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
