...
@Component({
  selector: 'app-mod5-category6-mod5-grid',
  templateUrl: './category6-mod5-grid.component.html'
})
export class Category6Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
