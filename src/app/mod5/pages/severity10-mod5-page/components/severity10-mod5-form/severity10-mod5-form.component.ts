...
@Component({
  selector: 'app-mod5-severity10-mod5-form',
  templateUrl: './severity10-mod5-form.component.html'
})
export class Severity10Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/severity10-mod5']);
  }
