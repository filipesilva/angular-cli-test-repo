...
@Component({
  selector: 'app-mod5-severity10-mod5-grid',
  templateUrl: './severity10-mod5-grid.component.html'
})
export class Severity10Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
