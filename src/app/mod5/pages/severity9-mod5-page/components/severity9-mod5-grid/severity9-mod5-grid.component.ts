...
@Component({
  selector: 'app-mod5-severity9-mod5-grid',
  templateUrl: './severity9-mod5-grid.component.html'
})
export class Severity9Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
  ...
  public edit(id: number) {
    this.router.navigate(['/mod5/severity9-mod5', { id }]);
  }
