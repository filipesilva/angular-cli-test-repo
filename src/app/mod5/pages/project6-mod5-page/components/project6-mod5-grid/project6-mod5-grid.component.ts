...
@Component({
  selector: 'app-mod5-project6-mod5-grid',
  templateUrl: './project6-mod5-grid.component.html'
})
export class Project6Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
