...
@Component({
  selector: 'app-mod5-project6-mod5-form',
  templateUrl: './project6-mod5-form.component.html'
})
export class Project6Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/project6-mod5']);
  }
