...
@Component({
  selector: 'app-mod5-category8-mod5-grid',
  templateUrl: './category8-mod5-grid.component.html'
})
export class Category8Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
