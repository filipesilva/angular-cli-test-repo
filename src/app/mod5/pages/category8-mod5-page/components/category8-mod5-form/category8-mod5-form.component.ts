...
@Component({
  selector: 'app-mod5-category8-mod5-form',
  templateUrl: './category8-mod5-form.component.html'
})
export class Category8Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category8-mod5']);
  }
