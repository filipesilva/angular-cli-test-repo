...
@Component({
  selector: 'app-mod5-issue5-mod5-grid',
  templateUrl: './issue5-mod5-grid.component.html'
})
export class Issue5Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
