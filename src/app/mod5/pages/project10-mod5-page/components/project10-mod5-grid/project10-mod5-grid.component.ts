...
@Component({
  selector: 'app-mod5-project10-mod5-grid',
  templateUrl: './project10-mod5-grid.component.html'
})
export class Project10Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
