...
@Component({
  selector: 'app-mod5-category7-mod5-form',
  templateUrl: './category7-mod5-form.component.html'
})
export class Category7Mod5FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod5/category7-mod5']);
  }
