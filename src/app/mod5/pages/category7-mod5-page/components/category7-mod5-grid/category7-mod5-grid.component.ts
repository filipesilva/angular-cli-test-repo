...
@Component({
  selector: 'app-mod5-category7-mod5-grid',
  templateUrl: './category7-mod5-grid.component.html'
})
export class Category7Mod5GridComponent extends GridComponent implements OnInit, OnDestroy {
