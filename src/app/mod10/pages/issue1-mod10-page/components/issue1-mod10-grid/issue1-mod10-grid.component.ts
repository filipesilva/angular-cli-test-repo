...
@Component({
  selector: 'app-mod10-issue1-mod10-grid',
  templateUrl: './issue1-mod10-grid.component.html'
})
export class Issue1Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
