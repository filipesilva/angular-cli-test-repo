...
@Component({
  selector: 'app-mod10-issue4-mod10-grid',
  templateUrl: './issue4-mod10-grid.component.html'
})
export class Issue4Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
