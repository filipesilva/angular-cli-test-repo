...
@Component({
  selector: 'app-mod10-severity7-mod10-grid',
  templateUrl: './severity7-mod10-grid.component.html'
})
export class Severity7Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
