...
@Component({
  selector: 'app-mod10-status10-mod10-grid',
  templateUrl: './status10-mod10-grid.component.html'
})
export class Status10Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
