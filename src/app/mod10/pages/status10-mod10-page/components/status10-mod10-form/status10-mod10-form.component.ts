...
@Component({
  selector: 'app-mod10-status10-mod10-form',
  templateUrl: './status10-mod10-form.component.html'
})
export class Status10Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/status10-mod10']);
  }
