...
@Component({
  selector: 'app-mod10-severity5-mod10-grid',
  templateUrl: './severity5-mod10-grid.component.html'
})
export class Severity5Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
