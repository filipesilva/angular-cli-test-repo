...
@Component({
  selector: 'app-mod10-severity5-mod10-form',
  templateUrl: './severity5-mod10-form.component.html'
})
export class Severity5Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/severity5-mod10']);
  }
