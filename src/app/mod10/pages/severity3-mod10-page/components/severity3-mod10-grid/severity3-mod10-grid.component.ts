...
@Component({
  selector: 'app-mod10-severity3-mod10-grid',
  templateUrl: './severity3-mod10-grid.component.html'
})
export class Severity3Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
