...
@Component({
  selector: 'app-mod10-severity3-mod10-form',
  templateUrl: './severity3-mod10-form.component.html'
})
export class Severity3Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/severity3-mod10']);
  }
