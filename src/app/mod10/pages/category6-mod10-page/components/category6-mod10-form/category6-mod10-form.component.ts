...
@Component({
  selector: 'app-mod10-category6-mod10-form',
  templateUrl: './category6-mod10-form.component.html'
})
export class Category6Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category6-mod10']);
  }
