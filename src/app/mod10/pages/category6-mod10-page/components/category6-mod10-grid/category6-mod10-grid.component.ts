...
@Component({
  selector: 'app-mod10-category6-mod10-grid',
  templateUrl: './category6-mod10-grid.component.html'
})
export class Category6Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
