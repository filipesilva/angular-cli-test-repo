...
@Component({
  selector: 'app-mod10-project6-mod10-form',
  templateUrl: './project6-mod10-form.component.html'
})
export class Project6Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project6-mod10']);
  }
