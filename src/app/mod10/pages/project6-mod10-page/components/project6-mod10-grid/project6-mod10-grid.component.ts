...
@Component({
  selector: 'app-mod10-project6-mod10-grid',
  templateUrl: './project6-mod10-grid.component.html'
})
export class Project6Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
