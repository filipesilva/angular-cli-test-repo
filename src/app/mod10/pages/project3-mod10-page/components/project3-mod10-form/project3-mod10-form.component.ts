...
@Component({
  selector: 'app-mod10-project3-mod10-form',
  templateUrl: './project3-mod10-form.component.html'
})
export class Project3Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project3-mod10']);
  }
