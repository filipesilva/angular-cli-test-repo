...
@Component({
  selector: 'app-mod10-project3-mod10-grid',
  templateUrl: './project3-mod10-grid.component.html'
})
export class Project3Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
