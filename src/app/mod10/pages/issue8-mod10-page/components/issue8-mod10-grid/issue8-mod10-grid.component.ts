...
@Component({
  selector: 'app-mod10-issue8-mod10-grid',
  templateUrl: './issue8-mod10-grid.component.html'
})
export class Issue8Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
