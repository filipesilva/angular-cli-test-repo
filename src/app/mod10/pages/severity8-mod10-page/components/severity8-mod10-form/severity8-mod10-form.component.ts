...
@Component({
  selector: 'app-mod10-severity8-mod10-form',
  templateUrl: './severity8-mod10-form.component.html'
})
export class Severity8Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/severity8-mod10']);
  }
