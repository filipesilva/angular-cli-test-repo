...
@Component({
  selector: 'app-mod10-severity8-mod10-grid',
  templateUrl: './severity8-mod10-grid.component.html'
})
export class Severity8Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
