...
@Component({
  selector: 'app-mod10-issue7-mod10-grid',
  templateUrl: './issue7-mod10-grid.component.html'
})
export class Issue7Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
