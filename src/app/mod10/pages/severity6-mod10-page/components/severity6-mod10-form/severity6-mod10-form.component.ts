...
@Component({
  selector: 'app-mod10-severity6-mod10-form',
  templateUrl: './severity6-mod10-form.component.html'
})
export class Severity6Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/severity6-mod10']);
  }
