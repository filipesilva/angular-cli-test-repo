...
@Component({
  selector: 'app-mod10-status1-mod10-form',
  templateUrl: './status1-mod10-form.component.html'
})
export class Status1Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/status1-mod10']);
  }
