...
@Component({
  selector: 'app-mod10-status1-mod10-grid',
  templateUrl: './status1-mod10-grid.component.html'
})
export class Status1Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
