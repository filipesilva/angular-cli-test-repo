...
@Component({
  selector: 'app-mod10-issue6-mod10-grid',
  templateUrl: './issue6-mod10-grid.component.html'
})
export class Issue6Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
