...
@Component({
  selector: 'app-mod10-project1-mod10-form',
  templateUrl: './project1-mod10-form.component.html'
})
export class Project1Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project1-mod10']);
  }
