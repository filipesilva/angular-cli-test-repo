...
@Component({
  selector: 'app-mod10-project1-mod10-grid',
  templateUrl: './project1-mod10-grid.component.html'
})
export class Project1Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
