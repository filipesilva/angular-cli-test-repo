...
@Component({
  selector: 'app-mod10-status7-mod10-form',
  templateUrl: './status7-mod10-form.component.html'
})
export class Status7Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/status7-mod10']);
  }
