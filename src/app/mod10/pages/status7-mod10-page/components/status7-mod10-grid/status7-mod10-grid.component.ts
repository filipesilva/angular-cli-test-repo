...
@Component({
  selector: 'app-mod10-status7-mod10-grid',
  templateUrl: './status7-mod10-grid.component.html'
})
export class Status7Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
