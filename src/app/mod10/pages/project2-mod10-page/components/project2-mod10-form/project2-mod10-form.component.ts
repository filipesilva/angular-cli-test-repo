...
@Component({
  selector: 'app-mod10-project2-mod10-form',
  templateUrl: './project2-mod10-form.component.html'
})
export class Project2Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project2-mod10']);
  }
