...
@Component({
  selector: 'app-mod10-project2-mod10-grid',
  templateUrl: './project2-mod10-grid.component.html'
})
export class Project2Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
