...
@Component({
  selector: 'app-mod10-severity10-mod10-grid',
  templateUrl: './severity10-mod10-grid.component.html'
})
export class Severity10Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
