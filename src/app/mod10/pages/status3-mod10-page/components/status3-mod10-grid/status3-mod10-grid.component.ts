...
@Component({
  selector: 'app-mod10-status3-mod10-grid',
  templateUrl: './status3-mod10-grid.component.html'
})
export class Status3Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
