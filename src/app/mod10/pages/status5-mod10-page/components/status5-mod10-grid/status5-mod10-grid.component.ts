...
@Component({
  selector: 'app-mod10-status5-mod10-grid',
  templateUrl: './status5-mod10-grid.component.html'
})
export class Status5Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
