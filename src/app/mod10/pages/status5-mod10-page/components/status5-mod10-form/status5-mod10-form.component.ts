...
@Component({
  selector: 'app-mod10-status5-mod10-form',
  templateUrl: './status5-mod10-form.component.html'
})
export class Status5Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/status5-mod10']);
  }
