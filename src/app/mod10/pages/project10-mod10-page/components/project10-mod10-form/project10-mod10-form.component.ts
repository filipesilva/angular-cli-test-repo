...
@Component({
  selector: 'app-mod10-project10-mod10-form',
  templateUrl: './project10-mod10-form.component.html'
})
export class Project10Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project10-mod10']);
  }
