...
@Component({
  selector: 'app-mod10-severity1-mod10-grid',
  templateUrl: './severity1-mod10-grid.component.html'
})
export class Severity1Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
