...
@Component({
  selector: 'app-mod10-severity1-mod10-form',
  templateUrl: './severity1-mod10-form.component.html'
})
export class Severity1Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/severity1-mod10']);
  }
