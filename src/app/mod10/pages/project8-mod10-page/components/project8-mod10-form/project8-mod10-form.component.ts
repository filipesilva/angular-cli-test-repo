...
@Component({
  selector: 'app-mod10-project8-mod10-form',
  templateUrl: './project8-mod10-form.component.html'
})
export class Project8Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project8-mod10']);
  }
