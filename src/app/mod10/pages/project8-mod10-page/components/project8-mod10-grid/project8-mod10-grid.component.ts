...
@Component({
  selector: 'app-mod10-project8-mod10-grid',
  templateUrl: './project8-mod10-grid.component.html'
})
export class Project8Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
