...
@Component({
  selector: 'app-mod10-severity4-mod10-grid',
  templateUrl: './severity4-mod10-grid.component.html'
})
export class Severity4Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
