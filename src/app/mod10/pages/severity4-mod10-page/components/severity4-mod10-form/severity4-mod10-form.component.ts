...
@Component({
  selector: 'app-mod10-severity4-mod10-form',
  templateUrl: './severity4-mod10-form.component.html'
})
export class Severity4Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/severity4-mod10']);
  }
