...
@Component({
  selector: 'app-mod10-issue10-mod10-grid',
  templateUrl: './issue10-mod10-grid.component.html'
})
export class Issue10Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
