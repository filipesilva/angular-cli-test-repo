...
@Component({
  selector: 'app-mod10-issue10-mod10-form',
  templateUrl: './issue10-mod10-form.component.html'
})
export class Issue10Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/issue10-mod10']);
  }
  ...
  private loadSelects(): void {
    this.project10Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject10Mod10 = items;
      });
    ...
    this.category10Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory10Mod10 = items;
      });
    ...
    this.status10Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus10Mod10 = items;
      });
    ...
    this.severity10Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity10Mod10 = items;
      });
  }
