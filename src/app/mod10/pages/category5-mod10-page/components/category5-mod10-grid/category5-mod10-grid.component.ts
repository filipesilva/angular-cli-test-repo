...
@Component({
  selector: 'app-mod10-category5-mod10-grid',
  templateUrl: './category5-mod10-grid.component.html'
})
export class Category5Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
