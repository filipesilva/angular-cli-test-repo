...
@Component({
  selector: 'app-mod10-category5-mod10-form',
  templateUrl: './category5-mod10-form.component.html'
})
export class Category5Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category5-mod10']);
  }
