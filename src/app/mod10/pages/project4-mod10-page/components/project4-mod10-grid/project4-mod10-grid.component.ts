...
@Component({
  selector: 'app-mod10-project4-mod10-grid',
  templateUrl: './project4-mod10-grid.component.html'
})
export class Project4Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
