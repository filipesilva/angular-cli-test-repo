...
@Component({
  selector: 'app-mod10-project5-mod10-form',
  templateUrl: './project5-mod10-form.component.html'
})
export class Project5Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project5-mod10']);
  }
