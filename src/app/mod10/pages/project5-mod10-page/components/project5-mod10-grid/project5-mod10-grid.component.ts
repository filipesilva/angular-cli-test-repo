...
@Component({
  selector: 'app-mod10-project5-mod10-grid',
  templateUrl: './project5-mod10-grid.component.html'
})
export class Project5Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
