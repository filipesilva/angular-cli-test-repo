...
@Component({
  selector: 'app-mod10-status4-mod10-grid',
  templateUrl: './status4-mod10-grid.component.html'
})
export class Status4Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
