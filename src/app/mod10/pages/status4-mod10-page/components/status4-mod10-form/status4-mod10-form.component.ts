...
@Component({
  selector: 'app-mod10-status4-mod10-form',
  templateUrl: './status4-mod10-form.component.html'
})
export class Status4Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/status4-mod10']);
  }
