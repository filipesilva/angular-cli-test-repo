...
@Component({
  selector: 'app-mod10-status6-mod10-grid',
  templateUrl: './status6-mod10-grid.component.html'
})
export class Status6Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
