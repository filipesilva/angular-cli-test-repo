...
@Component({
  selector: 'app-mod10-status8-mod10-form',
  templateUrl: './status8-mod10-form.component.html'
})
export class Status8Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/status8-mod10']);
  }
