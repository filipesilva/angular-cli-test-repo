...
@Component({
  selector: 'app-mod10-status8-mod10-grid',
  templateUrl: './status8-mod10-grid.component.html'
})
export class Status8Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
