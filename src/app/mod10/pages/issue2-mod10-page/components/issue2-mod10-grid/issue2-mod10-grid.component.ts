...
@Component({
  selector: 'app-mod10-issue2-mod10-grid',
  templateUrl: './issue2-mod10-grid.component.html'
})
export class Issue2Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
