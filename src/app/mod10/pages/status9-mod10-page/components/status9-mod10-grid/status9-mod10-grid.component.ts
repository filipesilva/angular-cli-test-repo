...
@Component({
  selector: 'app-mod10-status9-mod10-grid',
  templateUrl: './status9-mod10-grid.component.html'
})
export class Status9Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
