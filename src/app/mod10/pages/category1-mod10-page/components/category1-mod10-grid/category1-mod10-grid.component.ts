...
@Component({
  selector: 'app-mod10-category1-mod10-grid',
  templateUrl: './category1-mod10-grid.component.html'
})
export class Category1Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
