...
@Component({
  selector: 'app-mod10-category1-mod10-form',
  templateUrl: './category1-mod10-form.component.html'
})
export class Category1Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category1-mod10']);
  }
