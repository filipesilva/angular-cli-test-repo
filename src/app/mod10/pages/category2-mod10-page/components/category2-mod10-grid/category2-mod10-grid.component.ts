...
@Component({
  selector: 'app-mod10-category2-mod10-grid',
  templateUrl: './category2-mod10-grid.component.html'
})
export class Category2Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
