...
@Component({
  selector: 'app-mod10-category2-mod10-form',
  templateUrl: './category2-mod10-form.component.html'
})
export class Category2Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category2-mod10']);
  }
