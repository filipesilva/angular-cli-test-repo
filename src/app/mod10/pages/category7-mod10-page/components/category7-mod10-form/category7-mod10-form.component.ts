...
@Component({
  selector: 'app-mod10-category7-mod10-form',
  templateUrl: './category7-mod10-form.component.html'
})
export class Category7Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category7-mod10']);
  }
