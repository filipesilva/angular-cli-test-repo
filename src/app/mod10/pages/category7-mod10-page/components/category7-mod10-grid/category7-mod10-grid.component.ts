...
@Component({
  selector: 'app-mod10-category7-mod10-grid',
  templateUrl: './category7-mod10-grid.component.html'
})
export class Category7Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
