...
@Component({
  selector: 'app-mod10-project9-mod10-form',
  templateUrl: './project9-mod10-form.component.html'
})
export class Project9Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project9-mod10']);
  }
