...
@Component({
  selector: 'app-mod10-project9-mod10-grid',
  templateUrl: './project9-mod10-grid.component.html'
})
export class Project9Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
