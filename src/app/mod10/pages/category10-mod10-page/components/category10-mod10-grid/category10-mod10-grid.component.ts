...
@Component({
  selector: 'app-mod10-category10-mod10-grid',
  templateUrl: './category10-mod10-grid.component.html'
})
export class Category10Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
