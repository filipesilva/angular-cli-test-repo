...
@Component({
  selector: 'app-mod10-category10-mod10-form',
  templateUrl: './category10-mod10-form.component.html'
})
export class Category10Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category10-mod10']);
  }
