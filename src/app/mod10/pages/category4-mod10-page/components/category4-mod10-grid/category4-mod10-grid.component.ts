...
@Component({
  selector: 'app-mod10-category4-mod10-grid',
  templateUrl: './category4-mod10-grid.component.html'
})
export class Category4Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
