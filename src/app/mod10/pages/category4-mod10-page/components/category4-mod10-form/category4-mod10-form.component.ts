...
@Component({
  selector: 'app-mod10-category4-mod10-form',
  templateUrl: './category4-mod10-form.component.html'
})
export class Category4Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category4-mod10']);
  }
