...
@Component({
  selector: 'app-mod10-project7-mod10-form',
  templateUrl: './project7-mod10-form.component.html'
})
export class Project7Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/project7-mod10']);
  }
