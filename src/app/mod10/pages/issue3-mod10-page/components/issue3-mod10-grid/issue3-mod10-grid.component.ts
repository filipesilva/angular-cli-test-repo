...
@Component({
  selector: 'app-mod10-issue3-mod10-grid',
  templateUrl: './issue3-mod10-grid.component.html'
})
export class Issue3Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
