...
@Component({
  selector: 'app-mod10-severity2-mod10-grid',
  templateUrl: './severity2-mod10-grid.component.html'
})
export class Severity2Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
