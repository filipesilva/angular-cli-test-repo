...
@Component({
  selector: 'app-mod10-category9-mod10-grid',
  templateUrl: './category9-mod10-grid.component.html'
})
export class Category9Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
