...
@Component({
  selector: 'app-mod10-category9-mod10-form',
  templateUrl: './category9-mod10-form.component.html'
})
export class Category9Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category9-mod10']);
  }
