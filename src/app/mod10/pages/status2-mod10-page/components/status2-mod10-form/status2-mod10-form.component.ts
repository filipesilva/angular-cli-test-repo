...
@Component({
  selector: 'app-mod10-status2-mod10-form',
  templateUrl: './status2-mod10-form.component.html'
})
export class Status2Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/status2-mod10']);
  }
