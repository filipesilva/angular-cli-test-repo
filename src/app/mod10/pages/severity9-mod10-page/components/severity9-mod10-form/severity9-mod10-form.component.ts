...
@Component({
  selector: 'app-mod10-severity9-mod10-form',
  templateUrl: './severity9-mod10-form.component.html'
})
export class Severity9Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/severity9-mod10']);
  }
