...
@Component({
  selector: 'app-mod10-severity9-mod10-grid',
  templateUrl: './severity9-mod10-grid.component.html'
})
export class Severity9Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
