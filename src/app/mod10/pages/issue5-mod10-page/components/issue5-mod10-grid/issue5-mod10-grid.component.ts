...
@Component({
  selector: 'app-mod10-issue5-mod10-grid',
  templateUrl: './issue5-mod10-grid.component.html'
})
export class Issue5Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
