...
@Component({
  selector: 'app-mod10-issue5-mod10-form',
  templateUrl: './issue5-mod10-form.component.html'
})
export class Issue5Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/issue5-mod10']);
  }
  ...
  private loadSelects(): void {
    this.project5Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject5Mod10 = items;
      });
    ...
    this.category5Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory5Mod10 = items;
      });
    ...
    this.status5Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus5Mod10 = items;
      });
    ...
    this.severity5Mod10Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity5Mod10 = items;
      });
  }
