...
@Component({
  selector: 'app-mod10-category8-mod10-grid',
  templateUrl: './category8-mod10-grid.component.html'
})
export class Category8Mod10GridComponent extends GridComponent implements OnInit, OnDestroy {
