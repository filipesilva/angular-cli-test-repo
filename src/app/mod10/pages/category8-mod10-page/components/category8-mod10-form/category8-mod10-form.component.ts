...
@Component({
  selector: 'app-mod10-category8-mod10-form',
  templateUrl: './category8-mod10-form.component.html'
})
export class Category8Mod10FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod10/category8-mod10']);
  }
