...
@Component({
  selector: 'app-mod6-status6-mod6-grid',
  templateUrl: './status6-mod6-grid.component.html'
})
export class Status6Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
