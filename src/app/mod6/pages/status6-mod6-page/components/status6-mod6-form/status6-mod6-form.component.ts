...
@Component({
  selector: 'app-mod6-status6-mod6-form',
  templateUrl: './status6-mod6-form.component.html'
})
export class Status6Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status6-mod6']);
  }
