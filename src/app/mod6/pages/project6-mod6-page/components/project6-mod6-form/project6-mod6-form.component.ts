...
@Component({
  selector: 'app-mod6-project6-mod6-form',
  templateUrl: './project6-mod6-form.component.html'
})
export class Project6Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project6-mod6']);
  }
