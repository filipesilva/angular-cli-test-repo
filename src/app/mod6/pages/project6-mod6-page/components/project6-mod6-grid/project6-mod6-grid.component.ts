...
@Component({
  selector: 'app-mod6-project6-mod6-grid',
  templateUrl: './project6-mod6-grid.component.html'
})
export class Project6Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
