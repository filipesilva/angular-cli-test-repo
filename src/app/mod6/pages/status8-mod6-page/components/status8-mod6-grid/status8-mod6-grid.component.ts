...
@Component({
  selector: 'app-mod6-status8-mod6-grid',
  templateUrl: './status8-mod6-grid.component.html'
})
export class Status8Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
