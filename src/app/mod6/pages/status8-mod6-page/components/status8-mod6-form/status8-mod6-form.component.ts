...
@Component({
  selector: 'app-mod6-status8-mod6-form',
  templateUrl: './status8-mod6-form.component.html'
})
export class Status8Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status8-mod6']);
  }
