...
@Component({
  selector: 'app-mod6-category10-mod6-grid',
  templateUrl: './category10-mod6-grid.component.html'
})
export class Category10Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
