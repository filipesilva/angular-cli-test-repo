...
@Component({
  selector: 'app-mod6-category10-mod6-form',
  templateUrl: './category10-mod6-form.component.html'
})
export class Category10Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/category10-mod6']);
  }
