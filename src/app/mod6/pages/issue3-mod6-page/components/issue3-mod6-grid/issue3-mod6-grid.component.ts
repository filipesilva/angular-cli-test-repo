...
@Component({
  selector: 'app-mod6-issue3-mod6-grid',
  templateUrl: './issue3-mod6-grid.component.html'
})
export class Issue3Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
