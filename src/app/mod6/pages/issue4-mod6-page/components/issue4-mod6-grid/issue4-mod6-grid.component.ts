...
@Component({
  selector: 'app-mod6-issue4-mod6-grid',
  templateUrl: './issue4-mod6-grid.component.html'
})
export class Issue4Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
