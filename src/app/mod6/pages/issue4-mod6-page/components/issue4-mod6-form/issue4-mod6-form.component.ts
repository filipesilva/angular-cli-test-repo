...
@Component({
  selector: 'app-mod6-issue4-mod6-form',
  templateUrl: './issue4-mod6-form.component.html'
})
export class Issue4Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/issue4-mod6']);
  }
  ...
  private loadSelects(): void {
    this.project4Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject4Mod6 = items;
      });
    ...
    this.category4Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory4Mod6 = items;
      });
    ...
    this.status4Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus4Mod6 = items;
      });
    ...
    this.severity4Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity4Mod6 = items;
      });
  }
