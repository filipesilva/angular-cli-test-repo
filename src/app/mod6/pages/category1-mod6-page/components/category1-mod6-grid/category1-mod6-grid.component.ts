...
@Component({
  selector: 'app-mod6-category1-mod6-grid',
  templateUrl: './category1-mod6-grid.component.html'
})
export class Category1Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
