...
@Component({
  selector: 'app-mod6-status9-mod6-grid',
  templateUrl: './status9-mod6-grid.component.html'
})
export class Status9Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
