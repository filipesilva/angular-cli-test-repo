...
@Component({
  selector: 'app-mod6-status9-mod6-form',
  templateUrl: './status9-mod6-form.component.html'
})
export class Status9Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status9-mod6']);
  }
