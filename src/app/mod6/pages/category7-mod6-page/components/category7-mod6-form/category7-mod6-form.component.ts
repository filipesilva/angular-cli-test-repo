...
@Component({
  selector: 'app-mod6-category7-mod6-form',
  templateUrl: './category7-mod6-form.component.html'
})
export class Category7Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/category7-mod6']);
  }
