...
@Component({
  selector: 'app-mod6-category7-mod6-grid',
  templateUrl: './category7-mod6-grid.component.html'
})
export class Category7Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
