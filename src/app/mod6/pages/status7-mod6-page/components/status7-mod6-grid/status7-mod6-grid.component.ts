...
@Component({
  selector: 'app-mod6-status7-mod6-grid',
  templateUrl: './status7-mod6-grid.component.html'
})
export class Status7Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
