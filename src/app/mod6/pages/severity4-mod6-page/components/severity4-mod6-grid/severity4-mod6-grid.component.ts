...
@Component({
  selector: 'app-mod6-severity4-mod6-grid',
  templateUrl: './severity4-mod6-grid.component.html'
})
export class Severity4Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
