...
@Component({
  selector: 'app-mod6-severity4-mod6-form',
  templateUrl: './severity4-mod6-form.component.html'
})
export class Severity4Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/severity4-mod6']);
  }
