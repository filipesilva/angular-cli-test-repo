...
@Component({
  selector: 'app-mod6-project5-mod6-form',
  templateUrl: './project5-mod6-form.component.html'
})
export class Project5Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project5-mod6']);
  }
