...
@Component({
  selector: 'app-mod6-project5-mod6-grid',
  templateUrl: './project5-mod6-grid.component.html'
})
export class Project5Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
