...
@Component({
  selector: 'app-mod6-status2-mod6-form',
  templateUrl: './status2-mod6-form.component.html'
})
export class Status2Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status2-mod6']);
  }
