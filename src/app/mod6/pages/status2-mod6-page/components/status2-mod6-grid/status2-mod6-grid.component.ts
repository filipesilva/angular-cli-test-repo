...
@Component({
  selector: 'app-mod6-status2-mod6-grid',
  templateUrl: './status2-mod6-grid.component.html'
})
export class Status2Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
