...
@Component({
  selector: 'app-mod6-issue9-mod6-grid',
  templateUrl: './issue9-mod6-grid.component.html'
})
export class Issue9Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
