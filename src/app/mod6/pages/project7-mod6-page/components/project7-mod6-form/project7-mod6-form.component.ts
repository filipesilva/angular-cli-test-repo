...
@Component({
  selector: 'app-mod6-project7-mod6-form',
  templateUrl: './project7-mod6-form.component.html'
})
export class Project7Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project7-mod6']);
  }
