...
@Component({
  selector: 'app-mod6-project7-mod6-grid',
  templateUrl: './project7-mod6-grid.component.html'
})
export class Project7Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
