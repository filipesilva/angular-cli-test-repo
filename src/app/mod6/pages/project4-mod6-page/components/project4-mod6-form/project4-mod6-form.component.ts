...
@Component({
  selector: 'app-mod6-project4-mod6-form',
  templateUrl: './project4-mod6-form.component.html'
})
export class Project4Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project4-mod6']);
  }
