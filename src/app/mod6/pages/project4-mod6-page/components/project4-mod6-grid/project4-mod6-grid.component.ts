...
@Component({
  selector: 'app-mod6-project4-mod6-grid',
  templateUrl: './project4-mod6-grid.component.html'
})
export class Project4Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
