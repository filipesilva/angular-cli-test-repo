...
@Component({
  selector: 'app-mod6-severity9-mod6-grid',
  templateUrl: './severity9-mod6-grid.component.html'
})
export class Severity9Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
