...
@Component({
  selector: 'app-mod6-project2-mod6-form',
  templateUrl: './project2-mod6-form.component.html'
})
export class Project2Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project2-mod6']);
  }
