...
@Component({
  selector: 'app-mod6-project2-mod6-grid',
  templateUrl: './project2-mod6-grid.component.html'
})
export class Project2Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
