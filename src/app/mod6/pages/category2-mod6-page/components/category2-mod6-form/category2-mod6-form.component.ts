...
@Component({
  selector: 'app-mod6-category2-mod6-form',
  templateUrl: './category2-mod6-form.component.html'
})
export class Category2Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/category2-mod6']);
  }
