...
@Component({
  selector: 'app-mod6-category2-mod6-grid',
  templateUrl: './category2-mod6-grid.component.html'
})
export class Category2Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
