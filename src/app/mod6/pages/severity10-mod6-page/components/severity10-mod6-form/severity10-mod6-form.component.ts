...
@Component({
  selector: 'app-mod6-severity10-mod6-form',
  templateUrl: './severity10-mod6-form.component.html'
})
export class Severity10Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/severity10-mod6']);
  }
