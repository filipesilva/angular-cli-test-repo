...
@Component({
  selector: 'app-mod6-severity10-mod6-grid',
  templateUrl: './severity10-mod6-grid.component.html'
})
export class Severity10Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
