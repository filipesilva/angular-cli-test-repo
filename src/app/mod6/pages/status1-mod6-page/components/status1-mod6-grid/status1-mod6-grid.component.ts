...
@Component({
  selector: 'app-mod6-status1-mod6-grid',
  templateUrl: './status1-mod6-grid.component.html'
})
export class Status1Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
