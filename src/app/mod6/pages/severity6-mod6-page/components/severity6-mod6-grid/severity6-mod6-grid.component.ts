...
@Component({
  selector: 'app-mod6-severity6-mod6-grid',
  templateUrl: './severity6-mod6-grid.component.html'
})
export class Severity6Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
