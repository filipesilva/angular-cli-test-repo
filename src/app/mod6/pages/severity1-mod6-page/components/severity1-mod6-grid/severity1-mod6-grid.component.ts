...
@Component({
  selector: 'app-mod6-severity1-mod6-grid',
  templateUrl: './severity1-mod6-grid.component.html'
})
export class Severity1Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
