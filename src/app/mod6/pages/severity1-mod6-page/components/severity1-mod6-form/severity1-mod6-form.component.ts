...
@Component({
  selector: 'app-mod6-severity1-mod6-form',
  templateUrl: './severity1-mod6-form.component.html'
})
export class Severity1Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/severity1-mod6']);
  }
