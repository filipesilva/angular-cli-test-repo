...
@Component({
  selector: 'app-mod6-issue7-mod6-grid',
  templateUrl: './issue7-mod6-grid.component.html'
})
export class Issue7Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
