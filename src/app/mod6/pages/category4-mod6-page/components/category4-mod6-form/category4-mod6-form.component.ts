...
@Component({
  selector: 'app-mod6-category4-mod6-form',
  templateUrl: './category4-mod6-form.component.html'
})
export class Category4Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/category4-mod6']);
  }
