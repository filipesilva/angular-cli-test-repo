...
@Component({
  selector: 'app-mod6-category4-mod6-grid',
  templateUrl: './category4-mod6-grid.component.html'
})
export class Category4Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
