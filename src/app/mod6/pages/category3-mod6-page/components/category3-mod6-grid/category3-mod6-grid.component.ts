...
@Component({
  selector: 'app-mod6-category3-mod6-grid',
  templateUrl: './category3-mod6-grid.component.html'
})
export class Category3Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
