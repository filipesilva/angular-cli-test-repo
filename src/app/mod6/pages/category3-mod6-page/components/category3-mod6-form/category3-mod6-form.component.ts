...
@Component({
  selector: 'app-mod6-category3-mod6-form',
  templateUrl: './category3-mod6-form.component.html'
})
export class Category3Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/category3-mod6']);
  }
