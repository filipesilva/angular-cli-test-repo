...
@Component({
  selector: 'app-mod6-status4-mod6-form',
  templateUrl: './status4-mod6-form.component.html'
})
export class Status4Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status4-mod6']);
  }
