...
@Component({
  selector: 'app-mod6-status4-mod6-grid',
  templateUrl: './status4-mod6-grid.component.html'
})
export class Status4Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
