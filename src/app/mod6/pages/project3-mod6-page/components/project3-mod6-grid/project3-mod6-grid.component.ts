...
@Component({
  selector: 'app-mod6-project3-mod6-grid',
  templateUrl: './project3-mod6-grid.component.html'
})
export class Project3Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
