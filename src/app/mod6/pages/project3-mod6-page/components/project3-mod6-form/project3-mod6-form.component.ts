...
@Component({
  selector: 'app-mod6-project3-mod6-form',
  templateUrl: './project3-mod6-form.component.html'
})
export class Project3Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project3-mod6']);
  }
