...
@Component({
  selector: 'app-mod6-severity8-mod6-form',
  templateUrl: './severity8-mod6-form.component.html'
})
export class Severity8Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/severity8-mod6']);
  }
