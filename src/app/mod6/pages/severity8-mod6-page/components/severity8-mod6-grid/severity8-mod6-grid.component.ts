...
@Component({
  selector: 'app-mod6-severity8-mod6-grid',
  templateUrl: './severity8-mod6-grid.component.html'
})
export class Severity8Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
