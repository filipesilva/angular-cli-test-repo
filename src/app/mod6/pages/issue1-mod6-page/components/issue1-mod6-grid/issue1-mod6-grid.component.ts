...
@Component({
  selector: 'app-mod6-issue1-mod6-grid',
  templateUrl: './issue1-mod6-grid.component.html'
})
export class Issue1Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
