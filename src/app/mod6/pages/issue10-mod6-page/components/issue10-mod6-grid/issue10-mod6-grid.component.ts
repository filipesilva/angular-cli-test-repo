...
@Component({
  selector: 'app-mod6-issue10-mod6-grid',
  templateUrl: './issue10-mod6-grid.component.html'
})
export class Issue10Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
