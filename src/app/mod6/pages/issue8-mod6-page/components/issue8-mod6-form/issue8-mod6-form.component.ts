...
@Component({
  selector: 'app-mod6-issue8-mod6-form',
  templateUrl: './issue8-mod6-form.component.html'
})
export class Issue8Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/issue8-mod6']);
  }
  ...
  private loadSelects(): void {
    this.project8Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject8Mod6 = items;
      });
    ...
    this.category8Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory8Mod6 = items;
      });
    ...
    this.status8Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus8Mod6 = items;
      });
    ...
    this.severity8Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity8Mod6 = items;
      });
  }
