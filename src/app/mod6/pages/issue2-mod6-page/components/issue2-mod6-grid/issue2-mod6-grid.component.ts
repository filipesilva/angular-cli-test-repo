...
@Component({
  selector: 'app-mod6-issue2-mod6-grid',
  templateUrl: './issue2-mod6-grid.component.html'
})
export class Issue2Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
