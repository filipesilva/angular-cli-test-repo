...
@Component({
  selector: 'app-mod6-category6-mod6-grid',
  templateUrl: './category6-mod6-grid.component.html'
})
export class Category6Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
