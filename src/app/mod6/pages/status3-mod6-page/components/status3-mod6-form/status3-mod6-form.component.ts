...
@Component({
  selector: 'app-mod6-status3-mod6-form',
  templateUrl: './status3-mod6-form.component.html'
})
export class Status3Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status3-mod6']);
  }
