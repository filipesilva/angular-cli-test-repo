...
@Component({
  selector: 'app-mod6-status3-mod6-grid',
  templateUrl: './status3-mod6-grid.component.html'
})
export class Status3Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
