...
@Component({
  selector: 'app-mod6-status5-mod6-grid',
  templateUrl: './status5-mod6-grid.component.html'
})
export class Status5Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
