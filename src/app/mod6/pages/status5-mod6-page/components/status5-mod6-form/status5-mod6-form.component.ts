...
@Component({
  selector: 'app-mod6-status5-mod6-form',
  templateUrl: './status5-mod6-form.component.html'
})
export class Status5Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status5-mod6']);
  }
