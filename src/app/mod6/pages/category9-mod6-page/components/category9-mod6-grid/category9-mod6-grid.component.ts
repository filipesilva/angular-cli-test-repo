...
@Component({
  selector: 'app-mod6-category9-mod6-grid',
  templateUrl: './category9-mod6-grid.component.html'
})
export class Category9Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
