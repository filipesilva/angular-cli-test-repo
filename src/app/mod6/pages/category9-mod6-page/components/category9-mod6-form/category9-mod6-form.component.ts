...
@Component({
  selector: 'app-mod6-category9-mod6-form',
  templateUrl: './category9-mod6-form.component.html'
})
export class Category9Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/category9-mod6']);
  }
