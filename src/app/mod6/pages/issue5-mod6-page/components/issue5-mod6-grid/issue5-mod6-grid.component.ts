...
@Component({
  selector: 'app-mod6-issue5-mod6-grid',
  templateUrl: './issue5-mod6-grid.component.html'
})
export class Issue5Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
