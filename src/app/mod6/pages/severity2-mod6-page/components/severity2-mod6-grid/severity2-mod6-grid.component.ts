...
@Component({
  selector: 'app-mod6-severity2-mod6-grid',
  templateUrl: './severity2-mod6-grid.component.html'
})
export class Severity2Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
  ...
  public edit(id: number) {
    this.router.navigate(['/mod6/severity2-mod6', { id }]);
  }
