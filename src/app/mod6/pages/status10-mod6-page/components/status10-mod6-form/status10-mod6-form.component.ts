...
@Component({
  selector: 'app-mod6-status10-mod6-form',
  templateUrl: './status10-mod6-form.component.html'
})
export class Status10Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/status10-mod6']);
  }
