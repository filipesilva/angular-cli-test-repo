...
@Component({
  selector: 'app-mod6-status10-mod6-grid',
  templateUrl: './status10-mod6-grid.component.html'
})
export class Status10Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
