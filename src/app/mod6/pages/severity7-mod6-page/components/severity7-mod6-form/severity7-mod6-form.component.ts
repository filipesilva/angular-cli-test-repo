...
@Component({
  selector: 'app-mod6-severity7-mod6-form',
  templateUrl: './severity7-mod6-form.component.html'
})
export class Severity7Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/severity7-mod6']);
  }
