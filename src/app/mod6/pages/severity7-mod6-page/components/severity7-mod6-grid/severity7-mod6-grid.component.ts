...
@Component({
  selector: 'app-mod6-severity7-mod6-grid',
  templateUrl: './severity7-mod6-grid.component.html'
})
export class Severity7Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
