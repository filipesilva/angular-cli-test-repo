...
@Component({
  selector: 'app-mod6-project9-mod6-grid',
  templateUrl: './project9-mod6-grid.component.html'
})
export class Project9Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
