...
@Component({
  selector: 'app-mod6-project9-mod6-form',
  templateUrl: './project9-mod6-form.component.html'
})
export class Project9Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project9-mod6']);
  }
