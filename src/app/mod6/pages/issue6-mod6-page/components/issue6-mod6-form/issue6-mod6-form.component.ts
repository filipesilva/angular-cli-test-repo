...
@Component({
  selector: 'app-mod6-issue6-mod6-form',
  templateUrl: './issue6-mod6-form.component.html'
})
export class Issue6Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/issue6-mod6']);
  }
  ...
  private loadSelects(): void {
    this.project6Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject6Mod6 = items;
      });
    ...
    this.category6Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory6Mod6 = items;
      });
    ...
    this.status6Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus6Mod6 = items;
      });
    ...
    this.severity6Mod6Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity6Mod6 = items;
      });
  }
