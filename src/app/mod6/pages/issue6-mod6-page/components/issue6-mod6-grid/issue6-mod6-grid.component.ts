...
@Component({
  selector: 'app-mod6-issue6-mod6-grid',
  templateUrl: './issue6-mod6-grid.component.html'
})
export class Issue6Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
