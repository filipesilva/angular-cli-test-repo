...
@Component({
  selector: 'app-mod6-project8-mod6-form',
  templateUrl: './project8-mod6-form.component.html'
})
export class Project8Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project8-mod6']);
  }
