...
@Component({
  selector: 'app-mod6-project8-mod6-grid',
  templateUrl: './project8-mod6-grid.component.html'
})
export class Project8Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
