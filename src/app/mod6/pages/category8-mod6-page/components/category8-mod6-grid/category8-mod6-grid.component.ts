...
@Component({
  selector: 'app-mod6-category8-mod6-grid',
  templateUrl: './category8-mod6-grid.component.html'
})
export class Category8Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
