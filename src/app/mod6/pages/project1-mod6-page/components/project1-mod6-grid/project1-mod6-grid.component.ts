...
@Component({
  selector: 'app-mod6-project1-mod6-grid',
  templateUrl: './project1-mod6-grid.component.html'
})
export class Project1Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
