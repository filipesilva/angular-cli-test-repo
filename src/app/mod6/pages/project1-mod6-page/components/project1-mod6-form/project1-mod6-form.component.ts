...
@Component({
  selector: 'app-mod6-project1-mod6-form',
  templateUrl: './project1-mod6-form.component.html'
})
export class Project1Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project1-mod6']);
  }
