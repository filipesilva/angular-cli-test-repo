...
@Component({
  selector: 'app-mod6-project10-mod6-grid',
  templateUrl: './project10-mod6-grid.component.html'
})
export class Project10Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
