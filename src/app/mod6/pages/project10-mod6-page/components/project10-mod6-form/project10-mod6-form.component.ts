...
@Component({
  selector: 'app-mod6-project10-mod6-form',
  templateUrl: './project10-mod6-form.component.html'
})
export class Project10Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/project10-mod6']);
  }
