...
@Component({
  selector: 'app-mod6-severity5-mod6-grid',
  templateUrl: './severity5-mod6-grid.component.html'
})
export class Severity5Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
