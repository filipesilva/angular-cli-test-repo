...
@Component({
  selector: 'app-mod6-severity3-mod6-grid',
  templateUrl: './severity3-mod6-grid.component.html'
})
export class Severity3Mod6GridComponent extends GridComponent implements OnInit, OnDestroy {
