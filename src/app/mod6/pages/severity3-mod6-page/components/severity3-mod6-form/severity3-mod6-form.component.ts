...
@Component({
  selector: 'app-mod6-severity3-mod6-form',
  templateUrl: './severity3-mod6-form.component.html'
})
export class Severity3Mod6FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod6/severity3-mod6']);
  }
