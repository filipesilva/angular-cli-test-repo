...
@Component({
  selector: 'app-mod1-category5-mod1-grid',
  templateUrl: './category5-mod1-grid.component.html'
})
export class Category5Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
