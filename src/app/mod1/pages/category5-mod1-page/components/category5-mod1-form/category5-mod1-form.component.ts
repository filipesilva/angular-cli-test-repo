...
@Component({
  selector: 'app-mod1-category5-mod1-form',
  templateUrl: './category5-mod1-form.component.html'
})
export class Category5Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category5-mod1']);
  }
