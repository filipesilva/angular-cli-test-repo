...
@Component({
  selector: 'app-mod1-issue10-mod1-grid',
  templateUrl: './issue10-mod1-grid.component.html'
})
export class Issue10Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
