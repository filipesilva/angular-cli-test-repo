...
@Component({
  selector: 'app-mod1-project6-mod1-grid',
  templateUrl: './project6-mod1-grid.component.html'
})
export class Project6Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
