...
@Component({
  selector: 'app-mod1-project9-mod1-form',
  templateUrl: './project9-mod1-form.component.html'
})
export class Project9Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project9-mod1']);
  }
