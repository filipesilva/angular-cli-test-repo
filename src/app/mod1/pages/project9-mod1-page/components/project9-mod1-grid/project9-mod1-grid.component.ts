...
@Component({
  selector: 'app-mod1-project9-mod1-grid',
  templateUrl: './project9-mod1-grid.component.html'
})
export class Project9Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
