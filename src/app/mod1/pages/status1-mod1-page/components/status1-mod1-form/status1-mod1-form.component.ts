...
@Component({
  selector: 'app-mod1-status1-mod1-form',
  templateUrl: './status1-mod1-form.component.html'
})
export class Status1Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/status1-mod1']);
  }
