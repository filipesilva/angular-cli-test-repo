...
@Component({
  selector: 'app-mod1-status1-mod1-grid',
  templateUrl: './status1-mod1-grid.component.html'
})
export class Status1Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
