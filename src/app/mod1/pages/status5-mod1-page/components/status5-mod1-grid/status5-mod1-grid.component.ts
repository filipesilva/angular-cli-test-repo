...
@Component({
  selector: 'app-mod1-status5-mod1-grid',
  templateUrl: './status5-mod1-grid.component.html'
})
export class Status5Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
