...
@Component({
  selector: 'app-mod1-issue6-mod1-grid',
  templateUrl: './issue6-mod1-grid.component.html'
})
export class Issue6Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
