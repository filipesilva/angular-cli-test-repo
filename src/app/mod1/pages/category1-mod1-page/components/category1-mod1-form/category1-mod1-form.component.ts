...
@Component({
  selector: 'app-mod1-category1-mod1-form',
  templateUrl: './category1-mod1-form.component.html'
})
export class Category1Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category1-mod1']);
  }
