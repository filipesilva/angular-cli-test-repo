...
@Component({
  selector: 'app-mod1-category1-mod1-grid',
  templateUrl: './category1-mod1-grid.component.html'
})
export class Category1Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
