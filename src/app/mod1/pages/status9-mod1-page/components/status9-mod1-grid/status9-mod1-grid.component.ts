...
@Component({
  selector: 'app-mod1-status9-mod1-grid',
  templateUrl: './status9-mod1-grid.component.html'
})
export class Status9Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
