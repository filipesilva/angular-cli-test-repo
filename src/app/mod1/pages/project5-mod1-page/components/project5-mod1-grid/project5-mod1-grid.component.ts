...
@Component({
  selector: 'app-mod1-project5-mod1-grid',
  templateUrl: './project5-mod1-grid.component.html'
})
export class Project5Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
