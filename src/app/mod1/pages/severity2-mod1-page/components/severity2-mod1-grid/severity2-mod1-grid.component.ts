...
@Component({
  selector: 'app-mod1-severity2-mod1-grid',
  templateUrl: './severity2-mod1-grid.component.html'
})
export class Severity2Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
