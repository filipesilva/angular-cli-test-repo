...
@Component({
  selector: 'app-mod1-severity2-mod1-form',
  templateUrl: './severity2-mod1-form.component.html'
})
export class Severity2Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity2-mod1']);
  }
