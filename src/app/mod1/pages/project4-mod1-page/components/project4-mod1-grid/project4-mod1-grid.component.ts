...
@Component({
  selector: 'app-mod1-project4-mod1-grid',
  templateUrl: './project4-mod1-grid.component.html'
})
export class Project4Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
