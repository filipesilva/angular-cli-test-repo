...
@Component({
  selector: 'app-mod1-project4-mod1-form',
  templateUrl: './project4-mod1-form.component.html'
})
export class Project4Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project4-mod1']);
  }
