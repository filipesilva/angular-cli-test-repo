...
@Component({
  selector: 'app-mod1-status3-mod1-form',
  templateUrl: './status3-mod1-form.component.html'
})
export class Status3Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/status3-mod1']);
  }
