...
@Component({
  selector: 'app-mod1-status3-mod1-grid',
  templateUrl: './status3-mod1-grid.component.html'
})
export class Status3Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
