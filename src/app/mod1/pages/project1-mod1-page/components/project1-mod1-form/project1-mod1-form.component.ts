...
@Component({
  selector: 'app-mod1-project1-mod1-form',
  templateUrl: './project1-mod1-form.component.html'
})
export class Project1Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project1-mod1']);
  }
