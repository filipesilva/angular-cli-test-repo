...
@Component({
  selector: 'app-mod1-project1-mod1-grid',
  templateUrl: './project1-mod1-grid.component.html'
})
export class Project1Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
