...
@Component({
  selector: 'app-mod1-status7-mod1-grid',
  templateUrl: './status7-mod1-grid.component.html'
})
export class Status7Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
