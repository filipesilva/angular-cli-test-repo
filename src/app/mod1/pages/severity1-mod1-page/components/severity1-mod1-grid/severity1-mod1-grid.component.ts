...
@Component({
  selector: 'app-mod1-severity1-mod1-grid',
  templateUrl: './severity1-mod1-grid.component.html'
})
export class Severity1Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
