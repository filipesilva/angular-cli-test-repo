...
@Component({
  selector: 'app-mod1-severity1-mod1-form',
  templateUrl: './severity1-mod1-form.component.html'
})
export class Severity1Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity1-mod1']);
  }
