...
@Component({
  selector: 'app-mod1-severity10-mod1-grid',
  templateUrl: './severity10-mod1-grid.component.html'
})
export class Severity10Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
  ...
  public edit(id: number) {
    this.router.navigate(['/mod1/severity10-mod1', { id }]);
  }
