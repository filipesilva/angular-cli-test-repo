...
@Component({
  selector: 'app-mod1-status4-mod1-form',
  templateUrl: './status4-mod1-form.component.html'
})
export class Status4Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/status4-mod1']);
  }
