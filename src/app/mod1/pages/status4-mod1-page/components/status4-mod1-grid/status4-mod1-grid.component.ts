...
@Component({
  selector: 'app-mod1-status4-mod1-grid',
  templateUrl: './status4-mod1-grid.component.html'
})
export class Status4Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
