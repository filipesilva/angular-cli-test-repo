...
@Component({
  selector: 'app-mod1-project7-mod1-form',
  templateUrl: './project7-mod1-form.component.html'
})
export class Project7Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project7-mod1']);
  }
