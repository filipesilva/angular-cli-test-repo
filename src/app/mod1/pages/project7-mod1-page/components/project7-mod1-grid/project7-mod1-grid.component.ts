...
@Component({
  selector: 'app-mod1-project7-mod1-grid',
  templateUrl: './project7-mod1-grid.component.html'
})
export class Project7Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
