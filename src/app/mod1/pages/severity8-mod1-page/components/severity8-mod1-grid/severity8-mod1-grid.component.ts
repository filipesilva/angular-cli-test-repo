...
@Component({
  selector: 'app-mod1-severity8-mod1-grid',
  templateUrl: './severity8-mod1-grid.component.html'
})
export class Severity8Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
