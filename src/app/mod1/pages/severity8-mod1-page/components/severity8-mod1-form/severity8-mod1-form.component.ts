...
@Component({
  selector: 'app-mod1-severity8-mod1-form',
  templateUrl: './severity8-mod1-form.component.html'
})
export class Severity8Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity8-mod1']);
  }
