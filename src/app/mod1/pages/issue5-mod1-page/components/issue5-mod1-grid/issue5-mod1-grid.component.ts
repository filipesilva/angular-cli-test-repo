...
@Component({
  selector: 'app-mod1-issue5-mod1-grid',
  templateUrl: './issue5-mod1-grid.component.html'
})
export class Issue5Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
