...
@Component({
  selector: 'app-mod1-severity6-mod1-grid',
  templateUrl: './severity6-mod1-grid.component.html'
})
export class Severity6Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
