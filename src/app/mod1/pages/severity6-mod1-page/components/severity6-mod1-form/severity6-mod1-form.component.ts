...
@Component({
  selector: 'app-mod1-severity6-mod1-form',
  templateUrl: './severity6-mod1-form.component.html'
})
export class Severity6Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity6-mod1']);
  }
