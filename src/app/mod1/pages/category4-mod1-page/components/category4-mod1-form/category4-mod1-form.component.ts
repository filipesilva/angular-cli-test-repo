...
@Component({
  selector: 'app-mod1-category4-mod1-form',
  templateUrl: './category4-mod1-form.component.html'
})
export class Category4Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category4-mod1']);
  }
