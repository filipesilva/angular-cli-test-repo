...
@Component({
  selector: 'app-mod1-category4-mod1-grid',
  templateUrl: './category4-mod1-grid.component.html'
})
export class Category4Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
