...
@Component({
  selector: 'app-mod1-category6-mod1-grid',
  templateUrl: './category6-mod1-grid.component.html'
})
export class Category6Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
