...
@Component({
  selector: 'app-mod1-category6-mod1-form',
  templateUrl: './category6-mod1-form.component.html'
})
export class Category6Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category6-mod1']);
  }
