...
@Component({
  selector: 'app-mod1-severity7-mod1-form',
  templateUrl: './severity7-mod1-form.component.html'
})
export class Severity7Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity7-mod1']);
  }
