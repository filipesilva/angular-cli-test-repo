...
@Component({
  selector: 'app-mod1-severity7-mod1-grid',
  templateUrl: './severity7-mod1-grid.component.html'
})
export class Severity7Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
