...
@Component({
  selector: 'app-mod1-status6-mod1-grid',
  templateUrl: './status6-mod1-grid.component.html'
})
export class Status6Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
