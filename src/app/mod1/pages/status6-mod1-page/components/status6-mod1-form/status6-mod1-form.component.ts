...
@Component({
  selector: 'app-mod1-status6-mod1-form',
  templateUrl: './status6-mod1-form.component.html'
})
export class Status6Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/status6-mod1']);
  }
