...
@Component({
  selector: 'app-mod1-severity3-mod1-grid',
  templateUrl: './severity3-mod1-grid.component.html'
})
export class Severity3Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
