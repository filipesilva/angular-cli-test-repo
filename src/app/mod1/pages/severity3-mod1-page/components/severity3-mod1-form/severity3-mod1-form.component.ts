...
@Component({
  selector: 'app-mod1-severity3-mod1-form',
  templateUrl: './severity3-mod1-form.component.html'
})
export class Severity3Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity3-mod1']);
  }
