...
@Component({
  selector: 'app-mod1-issue1-mod1-grid',
  templateUrl: './issue1-mod1-grid.component.html'
})
export class Issue1Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
