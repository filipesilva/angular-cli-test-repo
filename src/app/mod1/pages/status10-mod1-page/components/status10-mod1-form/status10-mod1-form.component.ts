...
@Component({
  selector: 'app-mod1-status10-mod1-form',
  templateUrl: './status10-mod1-form.component.html'
})
export class Status10Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/status10-mod1']);
  }
