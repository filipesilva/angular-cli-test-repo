...
@Component({
  selector: 'app-mod1-category9-mod1-grid',
  templateUrl: './category9-mod1-grid.component.html'
})
export class Category9Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
