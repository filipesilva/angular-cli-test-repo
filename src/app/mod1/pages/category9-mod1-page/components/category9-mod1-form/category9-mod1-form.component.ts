...
@Component({
  selector: 'app-mod1-category9-mod1-form',
  templateUrl: './category9-mod1-form.component.html'
})
export class Category9Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category9-mod1']);
  }
