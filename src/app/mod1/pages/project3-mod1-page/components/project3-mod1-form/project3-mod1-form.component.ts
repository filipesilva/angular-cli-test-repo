...
@Component({
  selector: 'app-mod1-project3-mod1-form',
  templateUrl: './project3-mod1-form.component.html'
})
export class Project3Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project3-mod1']);
  }
