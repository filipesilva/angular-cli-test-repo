...
@Component({
  selector: 'app-mod1-project3-mod1-grid',
  templateUrl: './project3-mod1-grid.component.html'
})
export class Project3Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
