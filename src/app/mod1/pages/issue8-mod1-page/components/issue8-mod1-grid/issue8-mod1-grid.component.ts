...
@Component({
  selector: 'app-mod1-issue8-mod1-grid',
  templateUrl: './issue8-mod1-grid.component.html'
})
export class Issue8Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
