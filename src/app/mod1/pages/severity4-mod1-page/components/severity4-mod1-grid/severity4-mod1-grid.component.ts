...
@Component({
  selector: 'app-mod1-severity4-mod1-grid',
  templateUrl: './severity4-mod1-grid.component.html'
})
export class Severity4Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
