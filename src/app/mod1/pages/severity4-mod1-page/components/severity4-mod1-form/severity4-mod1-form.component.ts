...
@Component({
  selector: 'app-mod1-severity4-mod1-form',
  templateUrl: './severity4-mod1-form.component.html'
})
export class Severity4Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity4-mod1']);
  }
