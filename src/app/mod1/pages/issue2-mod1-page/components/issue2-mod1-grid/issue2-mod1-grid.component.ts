...
@Component({
  selector: 'app-mod1-issue2-mod1-grid',
  templateUrl: './issue2-mod1-grid.component.html'
})
export class Issue2Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
