...
@Component({
  selector: 'app-mod1-issue9-mod1-grid',
  templateUrl: './issue9-mod1-grid.component.html'
})
export class Issue9Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
