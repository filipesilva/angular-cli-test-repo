...
@Component({
  selector: 'app-mod1-issue9-mod1-form',
  templateUrl: './issue9-mod1-form.component.html'
})
export class Issue9Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/issue9-mod1']);
  }
  ...
  private loadSelects(): void {
    this.project9Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject9Mod1 = items;
      });
    ...
    this.category9Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory9Mod1 = items;
      });
    ...
    this.status9Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus9Mod1 = items;
      });
    ...
    this.severity9Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity9Mod1 = items;
      });
  }
