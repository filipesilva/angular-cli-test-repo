...
@Component({
  selector: 'app-mod1-category3-mod1-form',
  templateUrl: './category3-mod1-form.component.html'
})
export class Category3Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category3-mod1']);
  }
