...
@Component({
  selector: 'app-mod1-category3-mod1-grid',
  templateUrl: './category3-mod1-grid.component.html'
})
export class Category3Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
