...
@Component({
  selector: 'app-mod1-issue4-mod1-grid',
  templateUrl: './issue4-mod1-grid.component.html'
})
export class Issue4Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
