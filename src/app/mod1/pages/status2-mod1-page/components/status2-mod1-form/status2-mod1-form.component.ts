...
@Component({
  selector: 'app-mod1-status2-mod1-form',
  templateUrl: './status2-mod1-form.component.html'
})
export class Status2Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/status2-mod1']);
  }
