...
@Component({
  selector: 'app-mod1-status2-mod1-grid',
  templateUrl: './status2-mod1-grid.component.html'
})
export class Status2Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
