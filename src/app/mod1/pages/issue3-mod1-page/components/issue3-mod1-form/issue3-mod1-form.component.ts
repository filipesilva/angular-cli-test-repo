...
@Component({
  selector: 'app-mod1-issue3-mod1-form',
  templateUrl: './issue3-mod1-form.component.html'
})
export class Issue3Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/issue3-mod1']);
  }
  ...
  private loadSelects(): void {
    this.project3Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject3Mod1 = items;
      });
    ...
    this.category3Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory3Mod1 = items;
      });
    ...
    this.status3Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus3Mod1 = items;
      });
    ...
    this.severity3Mod1Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity3Mod1 = items;
      });
  }
