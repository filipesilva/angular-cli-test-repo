...
@Component({
  selector: 'app-mod1-issue3-mod1-grid',
  templateUrl: './issue3-mod1-grid.component.html'
})
export class Issue3Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
