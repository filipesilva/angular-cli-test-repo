...
@Component({
  selector: 'app-mod1-issue7-mod1-grid',
  templateUrl: './issue7-mod1-grid.component.html'
})
export class Issue7Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
