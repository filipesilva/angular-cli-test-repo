...
@Component({
  selector: 'app-mod1-category2-mod1-grid',
  templateUrl: './category2-mod1-grid.component.html'
})
export class Category2Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
