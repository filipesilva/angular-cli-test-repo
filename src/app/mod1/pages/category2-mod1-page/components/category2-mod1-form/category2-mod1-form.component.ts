...
@Component({
  selector: 'app-mod1-category2-mod1-form',
  templateUrl: './category2-mod1-form.component.html'
})
export class Category2Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category2-mod1']);
  }
