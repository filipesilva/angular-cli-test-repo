...
@Component({
  selector: 'app-mod1-status8-mod1-grid',
  templateUrl: './status8-mod1-grid.component.html'
})
export class Status8Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
