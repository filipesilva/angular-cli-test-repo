...
@Component({
  selector: 'app-mod1-status8-mod1-form',
  templateUrl: './status8-mod1-form.component.html'
})
export class Status8Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/status8-mod1']);
  }
