...
@Component({
  selector: 'app-mod1-category8-mod1-grid',
  templateUrl: './category8-mod1-grid.component.html'
})
export class Category8Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
