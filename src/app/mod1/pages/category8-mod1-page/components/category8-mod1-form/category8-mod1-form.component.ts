...
@Component({
  selector: 'app-mod1-category8-mod1-form',
  templateUrl: './category8-mod1-form.component.html'
})
export class Category8Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category8-mod1']);
  }
