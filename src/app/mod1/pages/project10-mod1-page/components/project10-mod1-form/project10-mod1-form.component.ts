...
@Component({
  selector: 'app-mod1-project10-mod1-form',
  templateUrl: './project10-mod1-form.component.html'
})
export class Project10Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project10-mod1']);
  }
