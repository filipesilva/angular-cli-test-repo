...
@Component({
  selector: 'app-mod1-project10-mod1-grid',
  templateUrl: './project10-mod1-grid.component.html'
})
export class Project10Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
