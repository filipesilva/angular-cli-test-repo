...
@Component({
  selector: 'app-mod1-category7-mod1-grid',
  templateUrl: './category7-mod1-grid.component.html'
})
export class Category7Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
