...
@Component({
  selector: 'app-mod1-category7-mod1-form',
  templateUrl: './category7-mod1-form.component.html'
})
export class Category7Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/category7-mod1']);
  }
