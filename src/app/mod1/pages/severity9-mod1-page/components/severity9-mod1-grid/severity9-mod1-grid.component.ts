...
@Component({
  selector: 'app-mod1-severity9-mod1-grid',
  templateUrl: './severity9-mod1-grid.component.html'
})
export class Severity9Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
