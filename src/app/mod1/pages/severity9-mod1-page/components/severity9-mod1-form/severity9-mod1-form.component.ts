...
@Component({
  selector: 'app-mod1-severity9-mod1-form',
  templateUrl: './severity9-mod1-form.component.html'
})
export class Severity9Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/severity9-mod1']);
  }
