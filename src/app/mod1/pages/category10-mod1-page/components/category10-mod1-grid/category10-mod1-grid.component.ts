...
@Component({
  selector: 'app-mod1-category10-mod1-grid',
  templateUrl: './category10-mod1-grid.component.html'
})
export class Category10Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
