...
@Component({
  selector: 'app-mod1-project8-mod1-form',
  templateUrl: './project8-mod1-form.component.html'
})
export class Project8Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project8-mod1']);
  }
