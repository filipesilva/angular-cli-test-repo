...
@Component({
  selector: 'app-mod1-project8-mod1-grid',
  templateUrl: './project8-mod1-grid.component.html'
})
export class Project8Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
