...
@Component({
  selector: 'app-mod1-project2-mod1-grid',
  templateUrl: './project2-mod1-grid.component.html'
})
export class Project2Mod1GridComponent extends GridComponent implements OnInit, OnDestroy {
