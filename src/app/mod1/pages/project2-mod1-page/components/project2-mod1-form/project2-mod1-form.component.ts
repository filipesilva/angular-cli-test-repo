...
@Component({
  selector: 'app-mod1-project2-mod1-form',
  templateUrl: './project2-mod1-form.component.html'
})
export class Project2Mod1FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod1/project2-mod1']);
  }
