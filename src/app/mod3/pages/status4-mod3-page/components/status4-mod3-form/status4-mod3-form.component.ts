...
@Component({
  selector: 'app-mod3-status4-mod3-form',
  templateUrl: './status4-mod3-form.component.html'
})
export class Status4Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status4-mod3']);
  }
