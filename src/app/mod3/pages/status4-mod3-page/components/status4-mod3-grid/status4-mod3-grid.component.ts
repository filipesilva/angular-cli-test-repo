...
@Component({
  selector: 'app-mod3-status4-mod3-grid',
  templateUrl: './status4-mod3-grid.component.html'
})
export class Status4Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
