...
@Component({
  selector: 'app-mod3-issue6-mod3-grid',
  templateUrl: './issue6-mod3-grid.component.html'
})
export class Issue6Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
