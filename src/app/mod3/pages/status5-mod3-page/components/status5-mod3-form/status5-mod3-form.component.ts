...
@Component({
  selector: 'app-mod3-status5-mod3-form',
  templateUrl: './status5-mod3-form.component.html'
})
export class Status5Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status5-mod3']);
  }
