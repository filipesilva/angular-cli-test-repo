...
@Component({
  selector: 'app-mod3-status5-mod3-grid',
  templateUrl: './status5-mod3-grid.component.html'
})
export class Status5Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
