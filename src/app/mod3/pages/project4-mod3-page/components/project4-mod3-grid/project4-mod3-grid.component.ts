...
@Component({
  selector: 'app-mod3-project4-mod3-grid',
  templateUrl: './project4-mod3-grid.component.html'
})
export class Project4Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
