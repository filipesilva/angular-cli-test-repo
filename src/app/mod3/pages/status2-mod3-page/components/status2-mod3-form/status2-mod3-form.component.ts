...
@Component({
  selector: 'app-mod3-status2-mod3-form',
  templateUrl: './status2-mod3-form.component.html'
})
export class Status2Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status2-mod3']);
  }
