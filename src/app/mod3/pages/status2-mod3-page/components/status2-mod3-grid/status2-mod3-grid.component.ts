...
@Component({
  selector: 'app-mod3-status2-mod3-grid',
  templateUrl: './status2-mod3-grid.component.html'
})
export class Status2Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
