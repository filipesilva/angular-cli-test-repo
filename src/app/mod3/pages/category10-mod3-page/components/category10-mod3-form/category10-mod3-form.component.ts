...
@Component({
  selector: 'app-mod3-category10-mod3-form',
  templateUrl: './category10-mod3-form.component.html'
})
export class Category10Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category10-mod3']);
  }
