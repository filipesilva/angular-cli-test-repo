...
@Component({
  selector: 'app-mod3-category10-mod3-grid',
  templateUrl: './category10-mod3-grid.component.html'
})
export class Category10Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
