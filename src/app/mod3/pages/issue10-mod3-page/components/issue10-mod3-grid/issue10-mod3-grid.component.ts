...
@Component({
  selector: 'app-mod3-issue10-mod3-grid',
  templateUrl: './issue10-mod3-grid.component.html'
})
export class Issue10Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
