...
@Component({
  selector: 'app-mod3-category9-mod3-form',
  templateUrl: './category9-mod3-form.component.html'
})
export class Category9Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category9-mod3']);
  }
