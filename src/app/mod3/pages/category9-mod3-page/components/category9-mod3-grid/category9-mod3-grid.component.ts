...
@Component({
  selector: 'app-mod3-category9-mod3-grid',
  templateUrl: './category9-mod3-grid.component.html'
})
export class Category9Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
