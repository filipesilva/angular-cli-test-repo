...
@Component({
  selector: 'app-mod3-severity1-mod3-form',
  templateUrl: './severity1-mod3-form.component.html'
})
export class Severity1Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity1-mod3']);
  }
