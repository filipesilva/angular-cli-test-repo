...
@Component({
  selector: 'app-mod3-severity1-mod3-grid',
  templateUrl: './severity1-mod3-grid.component.html'
})
export class Severity1Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
