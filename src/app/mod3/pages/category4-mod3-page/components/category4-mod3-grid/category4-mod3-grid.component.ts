...
@Component({
  selector: 'app-mod3-category4-mod3-grid',
  templateUrl: './category4-mod3-grid.component.html'
})
export class Category4Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
