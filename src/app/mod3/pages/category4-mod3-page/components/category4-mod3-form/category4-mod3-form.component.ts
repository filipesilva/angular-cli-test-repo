...
@Component({
  selector: 'app-mod3-category4-mod3-form',
  templateUrl: './category4-mod3-form.component.html'
})
export class Category4Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category4-mod3']);
  }
