...
@Component({
  selector: 'app-mod3-severity3-mod3-grid',
  templateUrl: './severity3-mod3-grid.component.html'
})
export class Severity3Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
