...
@Component({
  selector: 'app-mod3-issue9-mod3-grid',
  templateUrl: './issue9-mod3-grid.component.html'
})
export class Issue9Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
