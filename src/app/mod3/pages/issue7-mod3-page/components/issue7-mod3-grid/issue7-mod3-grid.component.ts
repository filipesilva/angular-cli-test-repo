...
@Component({
  selector: 'app-mod3-issue7-mod3-grid',
  templateUrl: './issue7-mod3-grid.component.html'
})
export class Issue7Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
