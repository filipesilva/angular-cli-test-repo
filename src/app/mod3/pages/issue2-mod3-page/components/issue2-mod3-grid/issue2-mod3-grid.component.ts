...
@Component({
  selector: 'app-mod3-issue2-mod3-grid',
  templateUrl: './issue2-mod3-grid.component.html'
})
export class Issue2Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
