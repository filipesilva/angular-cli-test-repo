...
@Component({
  selector: 'app-mod3-status1-mod3-grid',
  templateUrl: './status1-mod3-grid.component.html'
})
export class Status1Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
