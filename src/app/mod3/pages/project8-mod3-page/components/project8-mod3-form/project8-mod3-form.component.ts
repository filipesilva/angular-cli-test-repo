...
@Component({
  selector: 'app-mod3-project8-mod3-form',
  templateUrl: './project8-mod3-form.component.html'
})
export class Project8Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/project8-mod3']);
  }
