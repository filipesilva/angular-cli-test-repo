...
@Component({
  selector: 'app-mod3-project8-mod3-grid',
  templateUrl: './project8-mod3-grid.component.html'
})
export class Project8Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
