...
@Component({
  selector: 'app-mod3-project5-mod3-form',
  templateUrl: './project5-mod3-form.component.html'
})
export class Project5Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/project5-mod3']);
  }
