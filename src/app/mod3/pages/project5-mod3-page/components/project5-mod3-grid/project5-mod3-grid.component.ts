...
@Component({
  selector: 'app-mod3-project5-mod3-grid',
  templateUrl: './project5-mod3-grid.component.html'
})
export class Project5Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
