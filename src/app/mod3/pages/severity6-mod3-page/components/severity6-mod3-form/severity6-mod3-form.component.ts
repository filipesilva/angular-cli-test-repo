...
@Component({
  selector: 'app-mod3-severity6-mod3-form',
  templateUrl: './severity6-mod3-form.component.html'
})
export class Severity6Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity6-mod3']);
  }
