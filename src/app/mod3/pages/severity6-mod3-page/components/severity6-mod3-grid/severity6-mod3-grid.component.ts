...
@Component({
  selector: 'app-mod3-severity6-mod3-grid',
  templateUrl: './severity6-mod3-grid.component.html'
})
export class Severity6Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
