...
@Component({
  selector: 'app-mod3-status9-mod3-form',
  templateUrl: './status9-mod3-form.component.html'
})
export class Status9Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status9-mod3']);
  }
