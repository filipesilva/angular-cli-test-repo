...
@Component({
  selector: 'app-mod3-status9-mod3-grid',
  templateUrl: './status9-mod3-grid.component.html'
})
export class Status9Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
