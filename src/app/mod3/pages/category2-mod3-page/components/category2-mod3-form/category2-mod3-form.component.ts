...
@Component({
  selector: 'app-mod3-category2-mod3-form',
  templateUrl: './category2-mod3-form.component.html'
})
export class Category2Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category2-mod3']);
  }
