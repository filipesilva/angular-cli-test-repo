...
@Component({
  selector: 'app-mod3-category2-mod3-grid',
  templateUrl: './category2-mod3-grid.component.html'
})
export class Category2Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
