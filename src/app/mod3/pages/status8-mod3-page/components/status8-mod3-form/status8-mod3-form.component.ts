...
@Component({
  selector: 'app-mod3-status8-mod3-form',
  templateUrl: './status8-mod3-form.component.html'
})
export class Status8Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status8-mod3']);
  }
