...
@Component({
  selector: 'app-mod3-status8-mod3-grid',
  templateUrl: './status8-mod3-grid.component.html'
})
export class Status8Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
