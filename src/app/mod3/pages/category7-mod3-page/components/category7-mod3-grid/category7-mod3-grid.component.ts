...
@Component({
  selector: 'app-mod3-category7-mod3-grid',
  templateUrl: './category7-mod3-grid.component.html'
})
export class Category7Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
