...
@Component({
  selector: 'app-mod3-category7-mod3-form',
  templateUrl: './category7-mod3-form.component.html'
})
export class Category7Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category7-mod3']);
  }
