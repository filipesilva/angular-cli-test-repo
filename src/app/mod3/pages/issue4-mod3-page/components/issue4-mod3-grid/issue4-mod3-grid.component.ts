...
@Component({
  selector: 'app-mod3-issue4-mod3-grid',
  templateUrl: './issue4-mod3-grid.component.html'
})
export class Issue4Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
