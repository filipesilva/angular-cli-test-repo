...
@Component({
  selector: 'app-mod3-project2-mod3-grid',
  templateUrl: './project2-mod3-grid.component.html'
})
export class Project2Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
