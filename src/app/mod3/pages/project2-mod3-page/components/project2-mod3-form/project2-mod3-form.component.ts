...
@Component({
  selector: 'app-mod3-project2-mod3-form',
  templateUrl: './project2-mod3-form.component.html'
})
export class Project2Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/project2-mod3']);
  }
