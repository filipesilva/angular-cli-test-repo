...
@Component({
  selector: 'app-mod3-category1-mod3-grid',
  templateUrl: './category1-mod3-grid.component.html'
})
export class Category1Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
