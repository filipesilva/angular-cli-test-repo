...
@Component({
  selector: 'app-mod3-category1-mod3-form',
  templateUrl: './category1-mod3-form.component.html'
})
export class Category1Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category1-mod3']);
  }
