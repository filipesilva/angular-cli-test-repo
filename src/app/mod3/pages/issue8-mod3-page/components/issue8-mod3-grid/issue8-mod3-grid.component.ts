...
@Component({
  selector: 'app-mod3-issue8-mod3-grid',
  templateUrl: './issue8-mod3-grid.component.html'
})
export class Issue8Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
