...
@Component({
  selector: 'app-mod3-category3-mod3-grid',
  templateUrl: './category3-mod3-grid.component.html'
})
export class Category3Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
