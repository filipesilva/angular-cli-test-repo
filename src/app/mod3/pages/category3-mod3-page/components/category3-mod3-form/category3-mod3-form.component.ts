...
@Component({
  selector: 'app-mod3-category3-mod3-form',
  templateUrl: './category3-mod3-form.component.html'
})
export class Category3Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category3-mod3']);
  }
