...
@Component({
  selector: 'app-mod3-status3-mod3-grid',
  templateUrl: './status3-mod3-grid.component.html'
})
export class Status3Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
