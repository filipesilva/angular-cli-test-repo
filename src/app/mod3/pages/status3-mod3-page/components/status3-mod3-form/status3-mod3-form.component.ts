...
@Component({
  selector: 'app-mod3-status3-mod3-form',
  templateUrl: './status3-mod3-form.component.html'
})
export class Status3Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status3-mod3']);
  }
