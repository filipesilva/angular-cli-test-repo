...
@Component({
  selector: 'app-mod3-severity10-mod3-form',
  templateUrl: './severity10-mod3-form.component.html'
})
export class Severity10Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity10-mod3']);
  }
