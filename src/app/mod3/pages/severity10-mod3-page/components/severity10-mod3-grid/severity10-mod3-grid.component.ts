...
@Component({
  selector: 'app-mod3-severity10-mod3-grid',
  templateUrl: './severity10-mod3-grid.component.html'
})
export class Severity10Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
