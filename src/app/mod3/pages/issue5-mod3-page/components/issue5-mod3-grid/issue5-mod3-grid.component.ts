...
@Component({
  selector: 'app-mod3-issue5-mod3-grid',
  templateUrl: './issue5-mod3-grid.component.html'
})
export class Issue5Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
