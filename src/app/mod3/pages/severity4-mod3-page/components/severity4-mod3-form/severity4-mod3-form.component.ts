...
@Component({
  selector: 'app-mod3-severity4-mod3-form',
  templateUrl: './severity4-mod3-form.component.html'
})
export class Severity4Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity4-mod3']);
  }
