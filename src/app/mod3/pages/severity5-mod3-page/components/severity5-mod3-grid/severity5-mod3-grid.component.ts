...
@Component({
  selector: 'app-mod3-severity5-mod3-grid',
  templateUrl: './severity5-mod3-grid.component.html'
})
export class Severity5Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
