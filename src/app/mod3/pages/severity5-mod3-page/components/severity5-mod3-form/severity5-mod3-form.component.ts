...
@Component({
  selector: 'app-mod3-severity5-mod3-form',
  templateUrl: './severity5-mod3-form.component.html'
})
export class Severity5Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity5-mod3']);
  }
