...
@Component({
  selector: 'app-mod3-status7-mod3-grid',
  templateUrl: './status7-mod3-grid.component.html'
})
export class Status7Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
