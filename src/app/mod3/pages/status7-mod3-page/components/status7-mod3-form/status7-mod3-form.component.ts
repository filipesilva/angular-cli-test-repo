...
@Component({
  selector: 'app-mod3-status7-mod3-form',
  templateUrl: './status7-mod3-form.component.html'
})
export class Status7Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status7-mod3']);
  }
