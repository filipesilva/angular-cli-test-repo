...
@Component({
  selector: 'app-mod3-severity8-mod3-form',
  templateUrl: './severity8-mod3-form.component.html'
})
export class Severity8Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity8-mod3']);
  }
