...
@Component({
  selector: 'app-mod3-severity8-mod3-grid',
  templateUrl: './severity8-mod3-grid.component.html'
})
export class Severity8Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
