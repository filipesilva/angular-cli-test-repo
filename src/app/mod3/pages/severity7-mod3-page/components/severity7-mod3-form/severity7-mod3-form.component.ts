...
@Component({
  selector: 'app-mod3-severity7-mod3-form',
  templateUrl: './severity7-mod3-form.component.html'
})
export class Severity7Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity7-mod3']);
  }
