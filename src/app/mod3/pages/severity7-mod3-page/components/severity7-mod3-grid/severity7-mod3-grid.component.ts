...
@Component({
  selector: 'app-mod3-severity7-mod3-grid',
  templateUrl: './severity7-mod3-grid.component.html'
})
export class Severity7Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
