...
@Component({
  selector: 'app-mod3-issue1-mod3-grid',
  templateUrl: './issue1-mod3-grid.component.html'
})
export class Issue1Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
