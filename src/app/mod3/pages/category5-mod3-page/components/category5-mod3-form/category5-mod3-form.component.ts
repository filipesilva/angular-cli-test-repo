...
@Component({
  selector: 'app-mod3-category5-mod3-form',
  templateUrl: './category5-mod3-form.component.html'
})
export class Category5Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category5-mod3']);
  }
