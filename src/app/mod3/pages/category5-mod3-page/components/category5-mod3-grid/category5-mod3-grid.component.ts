...
@Component({
  selector: 'app-mod3-category5-mod3-grid',
  templateUrl: './category5-mod3-grid.component.html'
})
export class Category5Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
