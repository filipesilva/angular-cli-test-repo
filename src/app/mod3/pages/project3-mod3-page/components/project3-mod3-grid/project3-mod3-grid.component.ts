...
@Component({
  selector: 'app-mod3-project3-mod3-grid',
  templateUrl: './project3-mod3-grid.component.html'
})
export class Project3Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
