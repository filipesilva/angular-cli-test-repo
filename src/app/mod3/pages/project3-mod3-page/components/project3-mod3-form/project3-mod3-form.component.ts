...
@Component({
  selector: 'app-mod3-project3-mod3-form',
  templateUrl: './project3-mod3-form.component.html'
})
export class Project3Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/project3-mod3']);
  }
