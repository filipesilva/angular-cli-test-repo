...
@Component({
  selector: 'app-mod3-project6-mod3-grid',
  templateUrl: './project6-mod3-grid.component.html'
})
export class Project6Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
