...
@Component({
  selector: 'app-mod3-project6-mod3-form',
  templateUrl: './project6-mod3-form.component.html'
})
export class Project6Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/project6-mod3']);
  }
