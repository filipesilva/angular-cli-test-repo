...
@Component({
  selector: 'app-mod3-severity9-mod3-grid',
  templateUrl: './severity9-mod3-grid.component.html'
})
export class Severity9Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
