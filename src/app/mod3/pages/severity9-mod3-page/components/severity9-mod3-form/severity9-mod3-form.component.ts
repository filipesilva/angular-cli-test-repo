...
@Component({
  selector: 'app-mod3-severity9-mod3-form',
  templateUrl: './severity9-mod3-form.component.html'
})
export class Severity9Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity9-mod3']);
  }
