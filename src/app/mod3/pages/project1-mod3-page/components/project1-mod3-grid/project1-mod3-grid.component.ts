...
@Component({
  selector: 'app-mod3-project1-mod3-grid',
  templateUrl: './project1-mod3-grid.component.html'
})
export class Project1Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
