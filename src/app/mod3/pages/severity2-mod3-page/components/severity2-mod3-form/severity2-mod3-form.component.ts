...
@Component({
  selector: 'app-mod3-severity2-mod3-form',
  templateUrl: './severity2-mod3-form.component.html'
})
export class Severity2Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/severity2-mod3']);
  }
