...
@Component({
  selector: 'app-mod3-severity2-mod3-grid',
  templateUrl: './severity2-mod3-grid.component.html'
})
export class Severity2Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
