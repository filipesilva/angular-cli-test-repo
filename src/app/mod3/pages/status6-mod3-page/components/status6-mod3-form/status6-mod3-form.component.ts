...
@Component({
  selector: 'app-mod3-status6-mod3-form',
  templateUrl: './status6-mod3-form.component.html'
})
export class Status6Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status6-mod3']);
  }
