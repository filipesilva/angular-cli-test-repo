...
@Component({
  selector: 'app-mod3-status6-mod3-grid',
  templateUrl: './status6-mod3-grid.component.html'
})
export class Status6Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
