...
@Component({
  selector: 'app-mod3-project7-mod3-grid',
  templateUrl: './project7-mod3-grid.component.html'
})
export class Project7Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
