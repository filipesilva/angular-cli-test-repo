...
@Component({
  selector: 'app-mod3-project7-mod3-form',
  templateUrl: './project7-mod3-form.component.html'
})
export class Project7Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/project7-mod3']);
  }
