...
@Component({
  selector: 'app-mod3-project9-mod3-form',
  templateUrl: './project9-mod3-form.component.html'
})
export class Project9Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/project9-mod3']);
  }
