...
@Component({
  selector: 'app-mod3-project9-mod3-grid',
  templateUrl: './project9-mod3-grid.component.html'
})
export class Project9Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
