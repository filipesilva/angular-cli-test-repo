...
@Component({
  selector: 'app-mod3-project10-mod3-grid',
  templateUrl: './project10-mod3-grid.component.html'
})
export class Project10Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
