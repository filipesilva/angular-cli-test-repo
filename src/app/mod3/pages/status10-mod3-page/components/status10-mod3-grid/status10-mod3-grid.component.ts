...
@Component({
  selector: 'app-mod3-status10-mod3-grid',
  templateUrl: './status10-mod3-grid.component.html'
})
export class Status10Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
