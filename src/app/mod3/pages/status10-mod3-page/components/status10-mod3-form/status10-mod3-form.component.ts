...
@Component({
  selector: 'app-mod3-status10-mod3-form',
  templateUrl: './status10-mod3-form.component.html'
})
export class Status10Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/status10-mod3']);
  }
