...
@Component({
  selector: 'app-mod3-category6-mod3-grid',
  templateUrl: './category6-mod3-grid.component.html'
})
export class Category6Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
