...
@Component({
  selector: 'app-mod3-category8-mod3-form',
  templateUrl: './category8-mod3-form.component.html'
})
export class Category8Mod3FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod3/category8-mod3']);
  }
