...
@Component({
  selector: 'app-mod3-category8-mod3-grid',
  templateUrl: './category8-mod3-grid.component.html'
})
export class Category8Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
