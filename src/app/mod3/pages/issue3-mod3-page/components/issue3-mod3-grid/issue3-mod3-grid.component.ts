...
@Component({
  selector: 'app-mod3-issue3-mod3-grid',
  templateUrl: './issue3-mod3-grid.component.html'
})
export class Issue3Mod3GridComponent extends GridComponent implements OnInit, OnDestroy {
