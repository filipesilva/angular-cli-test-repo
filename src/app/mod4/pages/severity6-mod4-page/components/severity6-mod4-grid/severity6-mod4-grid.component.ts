...
@Component({
  selector: 'app-mod4-severity6-mod4-grid',
  templateUrl: './severity6-mod4-grid.component.html'
})
export class Severity6Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
