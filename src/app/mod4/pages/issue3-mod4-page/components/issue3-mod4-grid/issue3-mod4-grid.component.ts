...
@Component({
  selector: 'app-mod4-issue3-mod4-grid',
  templateUrl: './issue3-mod4-grid.component.html'
})
export class Issue3Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
