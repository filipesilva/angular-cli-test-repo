...
@Component({
  selector: 'app-mod4-issue7-mod4-grid',
  templateUrl: './issue7-mod4-grid.component.html'
})
export class Issue7Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
