...
@Component({
  selector: 'app-mod4-category9-mod4-grid',
  templateUrl: './category9-mod4-grid.component.html'
})
export class Category9Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
