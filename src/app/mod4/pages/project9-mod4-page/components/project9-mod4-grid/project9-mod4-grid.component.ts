...
@Component({
  selector: 'app-mod4-project9-mod4-grid',
  templateUrl: './project9-mod4-grid.component.html'
})
export class Project9Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
