...
@Component({
  selector: 'app-mod4-category6-mod4-form',
  templateUrl: './category6-mod4-form.component.html'
})
export class Category6Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category6-mod4']);
  }
