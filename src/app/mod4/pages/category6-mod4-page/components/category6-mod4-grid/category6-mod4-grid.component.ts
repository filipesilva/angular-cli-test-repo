...
@Component({
  selector: 'app-mod4-category6-mod4-grid',
  templateUrl: './category6-mod4-grid.component.html'
})
export class Category6Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
