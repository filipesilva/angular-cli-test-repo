...
@Component({
  selector: 'app-mod4-issue2-mod4-grid',
  templateUrl: './issue2-mod4-grid.component.html'
})
export class Issue2Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
