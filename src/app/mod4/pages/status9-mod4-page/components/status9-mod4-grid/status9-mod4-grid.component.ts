...
@Component({
  selector: 'app-mod4-status9-mod4-grid',
  templateUrl: './status9-mod4-grid.component.html'
})
export class Status9Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
