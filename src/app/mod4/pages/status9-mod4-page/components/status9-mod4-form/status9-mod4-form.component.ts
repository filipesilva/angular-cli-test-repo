...
@Component({
  selector: 'app-mod4-status9-mod4-form',
  templateUrl: './status9-mod4-form.component.html'
})
export class Status9Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/status9-mod4']);
  }
