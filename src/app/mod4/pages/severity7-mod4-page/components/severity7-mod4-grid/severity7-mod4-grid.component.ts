...
@Component({
  selector: 'app-mod4-severity7-mod4-grid',
  templateUrl: './severity7-mod4-grid.component.html'
})
export class Severity7Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
