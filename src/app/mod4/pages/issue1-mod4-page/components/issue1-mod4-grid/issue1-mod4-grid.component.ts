...
@Component({
  selector: 'app-mod4-issue1-mod4-grid',
  templateUrl: './issue1-mod4-grid.component.html'
})
export class Issue1Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
