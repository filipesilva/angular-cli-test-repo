...
@Component({
  selector: 'app-mod4-status3-mod4-grid',
  templateUrl: './status3-mod4-grid.component.html'
})
export class Status3Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
