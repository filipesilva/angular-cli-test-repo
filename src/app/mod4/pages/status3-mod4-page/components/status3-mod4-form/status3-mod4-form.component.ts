...
@Component({
  selector: 'app-mod4-status3-mod4-form',
  templateUrl: './status3-mod4-form.component.html'
})
export class Status3Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/status3-mod4']);
  }
