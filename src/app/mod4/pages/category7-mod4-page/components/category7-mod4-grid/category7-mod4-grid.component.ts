...
@Component({
  selector: 'app-mod4-category7-mod4-grid',
  templateUrl: './category7-mod4-grid.component.html'
})
export class Category7Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
