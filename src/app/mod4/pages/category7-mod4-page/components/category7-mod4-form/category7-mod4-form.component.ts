...
@Component({
  selector: 'app-mod4-category7-mod4-form',
  templateUrl: './category7-mod4-form.component.html'
})
export class Category7Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category7-mod4']);
  }
