...
@Component({
  selector: 'app-mod4-severity3-mod4-form',
  templateUrl: './severity3-mod4-form.component.html'
})
export class Severity3Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/severity3-mod4']);
  }
