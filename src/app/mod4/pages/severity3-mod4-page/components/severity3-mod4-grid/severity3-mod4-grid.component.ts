...
@Component({
  selector: 'app-mod4-severity3-mod4-grid',
  templateUrl: './severity3-mod4-grid.component.html'
})
export class Severity3Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
