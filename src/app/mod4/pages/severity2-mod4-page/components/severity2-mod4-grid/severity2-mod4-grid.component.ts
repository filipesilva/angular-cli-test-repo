...
@Component({
  selector: 'app-mod4-severity2-mod4-grid',
  templateUrl: './severity2-mod4-grid.component.html'
})
export class Severity2Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
