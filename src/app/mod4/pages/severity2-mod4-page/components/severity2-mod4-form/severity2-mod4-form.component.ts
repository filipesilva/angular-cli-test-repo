...
@Component({
  selector: 'app-mod4-severity2-mod4-form',
  templateUrl: './severity2-mod4-form.component.html'
})
export class Severity2Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/severity2-mod4']);
  }
