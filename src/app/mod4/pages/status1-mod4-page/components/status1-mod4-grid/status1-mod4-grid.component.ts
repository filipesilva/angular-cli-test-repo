...
@Component({
  selector: 'app-mod4-status1-mod4-grid',
  templateUrl: './status1-mod4-grid.component.html'
})
export class Status1Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
