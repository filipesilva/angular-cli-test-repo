...
@Component({
  selector: 'app-mod4-project6-mod4-form',
  templateUrl: './project6-mod4-form.component.html'
})
export class Project6Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/project6-mod4']);
  }
