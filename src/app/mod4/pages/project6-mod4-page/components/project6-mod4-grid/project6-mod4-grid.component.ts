...
@Component({
  selector: 'app-mod4-project6-mod4-grid',
  templateUrl: './project6-mod4-grid.component.html'
})
export class Project6Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
