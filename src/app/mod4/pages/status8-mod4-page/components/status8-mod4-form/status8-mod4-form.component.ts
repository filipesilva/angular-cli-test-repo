...
@Component({
  selector: 'app-mod4-status8-mod4-form',
  templateUrl: './status8-mod4-form.component.html'
})
export class Status8Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/status8-mod4']);
  }
