...
@Component({
  selector: 'app-mod4-status8-mod4-grid',
  templateUrl: './status8-mod4-grid.component.html'
})
export class Status8Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
