...
@Component({
  selector: 'app-mod4-category4-mod4-grid',
  templateUrl: './category4-mod4-grid.component.html'
})
export class Category4Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
