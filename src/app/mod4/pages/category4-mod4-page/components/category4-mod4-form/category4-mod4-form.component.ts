...
@Component({
  selector: 'app-mod4-category4-mod4-form',
  templateUrl: './category4-mod4-form.component.html'
})
export class Category4Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category4-mod4']);
  }
