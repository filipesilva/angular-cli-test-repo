...
@Component({
  selector: 'app-mod4-project4-mod4-form',
  templateUrl: './project4-mod4-form.component.html'
})
export class Project4Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/project4-mod4']);
  }
