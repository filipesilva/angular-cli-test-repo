...
@Component({
  selector: 'app-mod4-project4-mod4-grid',
  templateUrl: './project4-mod4-grid.component.html'
})
export class Project4Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
