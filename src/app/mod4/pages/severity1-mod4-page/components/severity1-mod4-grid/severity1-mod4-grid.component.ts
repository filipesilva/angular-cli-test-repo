...
@Component({
  selector: 'app-mod4-severity1-mod4-grid',
  templateUrl: './severity1-mod4-grid.component.html'
})
export class Severity1Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
