...
@Component({
  selector: 'app-mod4-project1-mod4-grid',
  templateUrl: './project1-mod4-grid.component.html'
})
export class Project1Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
