...
@Component({
  selector: 'app-mod4-project1-mod4-form',
  templateUrl: './project1-mod4-form.component.html'
})
export class Project1Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/project1-mod4']);
  }
