...
@Component({
  selector: 'app-mod4-severity4-mod4-form',
  templateUrl: './severity4-mod4-form.component.html'
})
export class Severity4Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/severity4-mod4']);
  }
