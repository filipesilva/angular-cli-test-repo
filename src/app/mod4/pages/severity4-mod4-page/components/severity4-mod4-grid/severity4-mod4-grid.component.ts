...
@Component({
  selector: 'app-mod4-severity4-mod4-grid',
  templateUrl: './severity4-mod4-grid.component.html'
})
export class Severity4Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
