...
@Component({
  selector: 'app-mod4-project3-mod4-grid',
  templateUrl: './project3-mod4-grid.component.html'
})
export class Project3Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
