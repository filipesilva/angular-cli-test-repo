...
@Component({
  selector: 'app-mod4-status2-mod4-form',
  templateUrl: './status2-mod4-form.component.html'
})
export class Status2Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/status2-mod4']);
  }
