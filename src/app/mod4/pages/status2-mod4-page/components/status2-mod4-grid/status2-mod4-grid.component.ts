...
@Component({
  selector: 'app-mod4-status2-mod4-grid',
  templateUrl: './status2-mod4-grid.component.html'
})
export class Status2Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
