...
@Component({
  selector: 'app-mod4-status7-mod4-grid',
  templateUrl: './status7-mod4-grid.component.html'
})
export class Status7Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
