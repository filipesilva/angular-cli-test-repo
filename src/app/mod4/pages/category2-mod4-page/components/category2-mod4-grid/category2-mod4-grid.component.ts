...
@Component({
  selector: 'app-mod4-category2-mod4-grid',
  templateUrl: './category2-mod4-grid.component.html'
})
export class Category2Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
