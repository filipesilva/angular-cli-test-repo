...
@Component({
  selector: 'app-mod4-category2-mod4-form',
  templateUrl: './category2-mod4-form.component.html'
})
export class Category2Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category2-mod4']);
  }
