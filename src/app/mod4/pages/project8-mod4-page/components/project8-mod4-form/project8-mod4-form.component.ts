...
@Component({
  selector: 'app-mod4-project8-mod4-form',
  templateUrl: './project8-mod4-form.component.html'
})
export class Project8Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/project8-mod4']);
  }
