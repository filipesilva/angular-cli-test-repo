...
@Component({
  selector: 'app-mod4-project8-mod4-grid',
  templateUrl: './project8-mod4-grid.component.html'
})
export class Project8Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
