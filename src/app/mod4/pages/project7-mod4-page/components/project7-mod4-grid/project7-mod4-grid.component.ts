...
@Component({
  selector: 'app-mod4-project7-mod4-grid',
  templateUrl: './project7-mod4-grid.component.html'
})
export class Project7Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
