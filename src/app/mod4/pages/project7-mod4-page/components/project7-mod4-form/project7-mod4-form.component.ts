...
@Component({
  selector: 'app-mod4-project7-mod4-form',
  templateUrl: './project7-mod4-form.component.html'
})
export class Project7Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/project7-mod4']);
  }
