...
@Component({
  selector: 'app-mod4-issue10-mod4-grid',
  templateUrl: './issue10-mod4-grid.component.html'
})
export class Issue10Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
