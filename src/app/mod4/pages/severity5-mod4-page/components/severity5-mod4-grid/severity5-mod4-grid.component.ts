...
@Component({
  selector: 'app-mod4-severity5-mod4-grid',
  templateUrl: './severity5-mod4-grid.component.html'
})
export class Severity5Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
