...
@Component({
  selector: 'app-mod4-issue8-mod4-grid',
  templateUrl: './issue8-mod4-grid.component.html'
})
export class Issue8Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
