...
@Component({
  selector: 'app-mod4-issue6-mod4-grid',
  templateUrl: './issue6-mod4-grid.component.html'
})
export class Issue6Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
