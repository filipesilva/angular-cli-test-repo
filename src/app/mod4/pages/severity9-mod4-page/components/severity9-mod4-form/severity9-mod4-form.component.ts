...
@Component({
  selector: 'app-mod4-severity9-mod4-form',
  templateUrl: './severity9-mod4-form.component.html'
})
export class Severity9Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/severity9-mod4']);
  }
