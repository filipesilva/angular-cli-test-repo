...
@Component({
  selector: 'app-mod4-severity9-mod4-grid',
  templateUrl: './severity9-mod4-grid.component.html'
})
export class Severity9Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
