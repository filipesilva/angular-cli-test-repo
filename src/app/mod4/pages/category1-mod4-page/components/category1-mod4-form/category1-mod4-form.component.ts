...
@Component({
  selector: 'app-mod4-category1-mod4-form',
  templateUrl: './category1-mod4-form.component.html'
})
export class Category1Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category1-mod4']);
  }
