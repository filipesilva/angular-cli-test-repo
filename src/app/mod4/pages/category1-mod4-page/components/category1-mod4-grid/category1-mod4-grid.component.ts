...
@Component({
  selector: 'app-mod4-category1-mod4-grid',
  templateUrl: './category1-mod4-grid.component.html'
})
export class Category1Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
