...
@Component({
  selector: 'app-mod4-status10-mod4-form',
  templateUrl: './status10-mod4-form.component.html'
})
export class Status10Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/status10-mod4']);
  }
