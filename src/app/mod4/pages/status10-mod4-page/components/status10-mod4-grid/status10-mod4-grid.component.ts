...
@Component({
  selector: 'app-mod4-status10-mod4-grid',
  templateUrl: './status10-mod4-grid.component.html'
})
export class Status10Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
