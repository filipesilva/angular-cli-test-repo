...
@Component({
  selector: 'app-mod4-project2-mod4-form',
  templateUrl: './project2-mod4-form.component.html'
})
export class Project2Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/project2-mod4']);
  }
