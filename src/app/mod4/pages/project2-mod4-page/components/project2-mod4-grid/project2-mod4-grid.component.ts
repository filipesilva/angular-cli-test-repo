...
@Component({
  selector: 'app-mod4-project2-mod4-grid',
  templateUrl: './project2-mod4-grid.component.html'
})
export class Project2Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
