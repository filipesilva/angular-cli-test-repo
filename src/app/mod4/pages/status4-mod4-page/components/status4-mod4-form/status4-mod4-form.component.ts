...
@Component({
  selector: 'app-mod4-status4-mod4-form',
  templateUrl: './status4-mod4-form.component.html'
})
export class Status4Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/status4-mod4']);
  }
