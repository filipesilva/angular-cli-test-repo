...
@Component({
  selector: 'app-mod4-status4-mod4-grid',
  templateUrl: './status4-mod4-grid.component.html'
})
export class Status4Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
