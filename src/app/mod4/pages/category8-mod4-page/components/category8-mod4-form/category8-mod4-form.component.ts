...
@Component({
  selector: 'app-mod4-category8-mod4-form',
  templateUrl: './category8-mod4-form.component.html'
})
export class Category8Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category8-mod4']);
  }
