...
@Component({
  selector: 'app-mod4-category8-mod4-grid',
  templateUrl: './category8-mod4-grid.component.html'
})
export class Category8Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
