...
@Component({
  selector: 'app-mod4-category3-mod4-form',
  templateUrl: './category3-mod4-form.component.html'
})
export class Category3Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category3-mod4']);
  }
