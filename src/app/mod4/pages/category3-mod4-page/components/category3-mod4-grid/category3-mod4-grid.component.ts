...
@Component({
  selector: 'app-mod4-category3-mod4-grid',
  templateUrl: './category3-mod4-grid.component.html'
})
export class Category3Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
