...
@Component({
  selector: 'app-mod4-severity10-mod4-grid',
  templateUrl: './severity10-mod4-grid.component.html'
})
export class Severity10Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
