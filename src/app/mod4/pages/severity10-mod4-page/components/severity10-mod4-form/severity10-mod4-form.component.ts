...
@Component({
  selector: 'app-mod4-severity10-mod4-form',
  templateUrl: './severity10-mod4-form.component.html'
})
export class Severity10Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/severity10-mod4']);
  }
