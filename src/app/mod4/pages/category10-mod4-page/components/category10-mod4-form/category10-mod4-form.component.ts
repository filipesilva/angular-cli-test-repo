...
@Component({
  selector: 'app-mod4-category10-mod4-form',
  templateUrl: './category10-mod4-form.component.html'
})
export class Category10Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category10-mod4']);
  }
