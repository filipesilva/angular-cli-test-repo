...
@Component({
  selector: 'app-mod4-category10-mod4-grid',
  templateUrl: './category10-mod4-grid.component.html'
})
export class Category10Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
