...
@Component({
  selector: 'app-mod4-category5-mod4-form',
  templateUrl: './category5-mod4-form.component.html'
})
export class Category5Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/category5-mod4']);
  }
