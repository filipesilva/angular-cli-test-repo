...
@Component({
  selector: 'app-mod4-category5-mod4-grid',
  templateUrl: './category5-mod4-grid.component.html'
})
export class Category5Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
