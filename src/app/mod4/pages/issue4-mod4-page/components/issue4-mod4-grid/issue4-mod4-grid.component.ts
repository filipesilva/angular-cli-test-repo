...
@Component({
  selector: 'app-mod4-issue4-mod4-grid',
  templateUrl: './issue4-mod4-grid.component.html'
})
export class Issue4Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
