...
@Component({
  selector: 'app-mod4-issue5-mod4-grid',
  templateUrl: './issue5-mod4-grid.component.html'
})
export class Issue5Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
