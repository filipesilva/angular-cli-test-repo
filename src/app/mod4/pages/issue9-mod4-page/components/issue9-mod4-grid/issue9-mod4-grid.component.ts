...
@Component({
  selector: 'app-mod4-issue9-mod4-grid',
  templateUrl: './issue9-mod4-grid.component.html'
})
export class Issue9Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
