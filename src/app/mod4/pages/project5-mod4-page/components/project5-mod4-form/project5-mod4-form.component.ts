...
@Component({
  selector: 'app-mod4-project5-mod4-form',
  templateUrl: './project5-mod4-form.component.html'
})
export class Project5Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/project5-mod4']);
  }
