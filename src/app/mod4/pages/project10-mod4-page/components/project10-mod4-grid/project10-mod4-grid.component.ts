...
@Component({
  selector: 'app-mod4-project10-mod4-grid',
  templateUrl: './project10-mod4-grid.component.html'
})
export class Project10Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
