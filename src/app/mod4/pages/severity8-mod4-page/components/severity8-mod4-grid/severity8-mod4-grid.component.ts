...
@Component({
  selector: 'app-mod4-severity8-mod4-grid',
  templateUrl: './severity8-mod4-grid.component.html'
})
export class Severity8Mod4GridComponent extends GridComponent implements OnInit, OnDestroy {
