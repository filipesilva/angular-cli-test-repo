...
@Component({
  selector: 'app-mod4-severity8-mod4-form',
  templateUrl: './severity8-mod4-form.component.html'
})
export class Severity8Mod4FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod4/severity8-mod4']);
  }
