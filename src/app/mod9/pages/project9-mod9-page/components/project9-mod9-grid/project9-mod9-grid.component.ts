...
@Component({
  selector: 'app-mod9-project9-mod9-grid',
  templateUrl: './project9-mod9-grid.component.html'
})
export class Project9Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
