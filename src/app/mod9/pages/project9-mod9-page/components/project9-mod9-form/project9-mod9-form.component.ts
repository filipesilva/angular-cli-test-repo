...
@Component({
  selector: 'app-mod9-project9-mod9-form',
  templateUrl: './project9-mod9-form.component.html'
})
export class Project9Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/project9-mod9']);
  }
