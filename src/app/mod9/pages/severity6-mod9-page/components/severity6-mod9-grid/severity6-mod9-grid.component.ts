...
@Component({
  selector: 'app-mod9-severity6-mod9-grid',
  templateUrl: './severity6-mod9-grid.component.html'
})
export class Severity6Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
