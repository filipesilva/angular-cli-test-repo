...
@Component({
  selector: 'app-mod9-severity6-mod9-form',
  templateUrl: './severity6-mod9-form.component.html'
})
export class Severity6Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity6-mod9']);
  }
