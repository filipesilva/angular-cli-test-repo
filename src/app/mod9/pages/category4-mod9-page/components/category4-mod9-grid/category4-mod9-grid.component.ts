...
@Component({
  selector: 'app-mod9-category4-mod9-grid',
  templateUrl: './category4-mod9-grid.component.html'
})
export class Category4Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
