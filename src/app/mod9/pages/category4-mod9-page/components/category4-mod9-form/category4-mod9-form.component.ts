...
@Component({
  selector: 'app-mod9-category4-mod9-form',
  templateUrl: './category4-mod9-form.component.html'
})
export class Category4Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category4-mod9']);
  }
