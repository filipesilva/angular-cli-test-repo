...
@Component({
  selector: 'app-mod9-issue7-mod9-form',
  templateUrl: './issue7-mod9-form.component.html'
})
export class Issue7Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/issue7-mod9']);
  }
  ...
  private loadSelects(): void {
    this.project7Mod9Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsProject7Mod9 = items;
      });
    ...
    this.category7Mod9Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsCategory7Mod9 = items;
      });
    ...
    this.status7Mod9Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsStatus7Mod9 = items;
      });
    ...
    this.severity7Mod9Service
      ...
      .takeUntil(this.ngUnsubscribe)
      .subscribe(items => {
        this.selects.itemsSeverity7Mod9 = items;
      });
  }
