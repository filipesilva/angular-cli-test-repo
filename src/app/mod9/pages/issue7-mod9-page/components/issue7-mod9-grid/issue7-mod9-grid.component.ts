...
@Component({
  selector: 'app-mod9-issue7-mod9-grid',
  templateUrl: './issue7-mod9-grid.component.html'
})
export class Issue7Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
