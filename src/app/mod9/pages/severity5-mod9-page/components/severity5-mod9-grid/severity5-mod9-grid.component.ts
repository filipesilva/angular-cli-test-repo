...
@Component({
  selector: 'app-mod9-severity5-mod9-grid',
  templateUrl: './severity5-mod9-grid.component.html'
})
export class Severity5Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
