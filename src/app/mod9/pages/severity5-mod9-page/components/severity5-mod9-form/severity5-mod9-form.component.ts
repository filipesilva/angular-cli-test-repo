...
@Component({
  selector: 'app-mod9-severity5-mod9-form',
  templateUrl: './severity5-mod9-form.component.html'
})
export class Severity5Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity5-mod9']);
  }
