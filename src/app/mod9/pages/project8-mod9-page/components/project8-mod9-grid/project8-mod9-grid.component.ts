...
@Component({
  selector: 'app-mod9-project8-mod9-grid',
  templateUrl: './project8-mod9-grid.component.html'
})
export class Project8Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
