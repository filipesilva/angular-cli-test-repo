...
@Component({
  selector: 'app-mod9-category3-mod9-grid',
  templateUrl: './category3-mod9-grid.component.html'
})
export class Category3Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
