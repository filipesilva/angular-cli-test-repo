...
@Component({
  selector: 'app-mod9-issue3-mod9-grid',
  templateUrl: './issue3-mod9-grid.component.html'
})
export class Issue3Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
