...
@Component({
  selector: 'app-mod9-status4-mod9-grid',
  templateUrl: './status4-mod9-grid.component.html'
})
export class Status4Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
