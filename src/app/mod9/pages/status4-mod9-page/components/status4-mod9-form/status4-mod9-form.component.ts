...
@Component({
  selector: 'app-mod9-status4-mod9-form',
  templateUrl: './status4-mod9-form.component.html'
})
export class Status4Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status4-mod9']);
  }
