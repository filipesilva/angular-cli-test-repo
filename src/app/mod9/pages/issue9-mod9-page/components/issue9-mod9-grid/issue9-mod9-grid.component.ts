...
@Component({
  selector: 'app-mod9-issue9-mod9-grid',
  templateUrl: './issue9-mod9-grid.component.html'
})
export class Issue9Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
