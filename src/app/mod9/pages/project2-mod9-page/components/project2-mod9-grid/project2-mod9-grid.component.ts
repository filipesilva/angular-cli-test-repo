...
@Component({
  selector: 'app-mod9-project2-mod9-grid',
  templateUrl: './project2-mod9-grid.component.html'
})
export class Project2Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
