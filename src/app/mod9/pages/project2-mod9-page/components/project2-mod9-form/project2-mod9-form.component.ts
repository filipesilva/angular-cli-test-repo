...
@Component({
  selector: 'app-mod9-project2-mod9-form',
  templateUrl: './project2-mod9-form.component.html'
})
export class Project2Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/project2-mod9']);
  }
