...
@Component({
  selector: 'app-mod9-category10-mod9-grid',
  templateUrl: './category10-mod9-grid.component.html'
})
export class Category10Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
