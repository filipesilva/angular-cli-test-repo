...
@Component({
  selector: 'app-mod9-category10-mod9-form',
  templateUrl: './category10-mod9-form.component.html'
})
export class Category10Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category10-mod9']);
  }
