...
@Component({
  selector: 'app-mod9-severity3-mod9-grid',
  templateUrl: './severity3-mod9-grid.component.html'
})
export class Severity3Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
