...
@Component({
  selector: 'app-mod9-severity3-mod9-form',
  templateUrl: './severity3-mod9-form.component.html'
})
export class Severity3Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity3-mod9']);
  }
