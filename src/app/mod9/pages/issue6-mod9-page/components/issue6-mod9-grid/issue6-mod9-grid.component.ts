...
@Component({
  selector: 'app-mod9-issue6-mod9-grid',
  templateUrl: './issue6-mod9-grid.component.html'
})
export class Issue6Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
