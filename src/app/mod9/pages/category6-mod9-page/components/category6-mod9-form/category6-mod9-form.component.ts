...
@Component({
  selector: 'app-mod9-category6-mod9-form',
  templateUrl: './category6-mod9-form.component.html'
})
export class Category6Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category6-mod9']);
  }
