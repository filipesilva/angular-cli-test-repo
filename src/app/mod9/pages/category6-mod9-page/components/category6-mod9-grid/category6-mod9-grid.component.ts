...
@Component({
  selector: 'app-mod9-category6-mod9-grid',
  templateUrl: './category6-mod9-grid.component.html'
})
export class Category6Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
