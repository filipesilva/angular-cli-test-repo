...
@Component({
  selector: 'app-mod9-status6-mod9-form',
  templateUrl: './status6-mod9-form.component.html'
})
export class Status6Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status6-mod9']);
  }
