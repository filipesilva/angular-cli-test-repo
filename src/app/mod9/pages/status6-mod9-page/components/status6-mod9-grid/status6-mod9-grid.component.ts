...
@Component({
  selector: 'app-mod9-status6-mod9-grid',
  templateUrl: './status6-mod9-grid.component.html'
})
export class Status6Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
