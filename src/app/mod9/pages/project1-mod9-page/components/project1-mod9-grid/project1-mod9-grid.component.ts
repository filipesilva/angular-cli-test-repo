...
@Component({
  selector: 'app-mod9-project1-mod9-grid',
  templateUrl: './project1-mod9-grid.component.html'
})
export class Project1Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
