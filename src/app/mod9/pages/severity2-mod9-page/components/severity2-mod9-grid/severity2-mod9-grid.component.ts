...
@Component({
  selector: 'app-mod9-severity2-mod9-grid',
  templateUrl: './severity2-mod9-grid.component.html'
})
export class Severity2Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
