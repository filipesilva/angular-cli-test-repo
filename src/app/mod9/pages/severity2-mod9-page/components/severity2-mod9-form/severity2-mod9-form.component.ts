...
@Component({
  selector: 'app-mod9-severity2-mod9-form',
  templateUrl: './severity2-mod9-form.component.html'
})
export class Severity2Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity2-mod9']);
  }
