...
@Component({
  selector: 'app-mod9-category7-mod9-form',
  templateUrl: './category7-mod9-form.component.html'
})
export class Category7Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category7-mod9']);
  }
