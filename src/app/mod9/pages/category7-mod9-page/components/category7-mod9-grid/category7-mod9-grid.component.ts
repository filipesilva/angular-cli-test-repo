...
@Component({
  selector: 'app-mod9-category7-mod9-grid',
  templateUrl: './category7-mod9-grid.component.html'
})
export class Category7Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
