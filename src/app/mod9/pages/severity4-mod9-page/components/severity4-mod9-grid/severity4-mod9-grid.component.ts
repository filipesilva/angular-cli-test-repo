...
@Component({
  selector: 'app-mod9-severity4-mod9-grid',
  templateUrl: './severity4-mod9-grid.component.html'
})
export class Severity4Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
