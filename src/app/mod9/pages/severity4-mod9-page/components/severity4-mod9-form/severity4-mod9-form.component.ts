...
@Component({
  selector: 'app-mod9-severity4-mod9-form',
  templateUrl: './severity4-mod9-form.component.html'
})
export class Severity4Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity4-mod9']);
  }
