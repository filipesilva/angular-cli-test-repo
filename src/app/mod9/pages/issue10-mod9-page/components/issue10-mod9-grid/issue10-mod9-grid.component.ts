...
@Component({
  selector: 'app-mod9-issue10-mod9-grid',
  templateUrl: './issue10-mod9-grid.component.html'
})
export class Issue10Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
