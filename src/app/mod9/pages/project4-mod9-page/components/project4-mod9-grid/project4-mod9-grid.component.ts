...
@Component({
  selector: 'app-mod9-project4-mod9-grid',
  templateUrl: './project4-mod9-grid.component.html'
})
export class Project4Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
