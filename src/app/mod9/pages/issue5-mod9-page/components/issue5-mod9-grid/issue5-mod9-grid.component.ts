...
@Component({
  selector: 'app-mod9-issue5-mod9-grid',
  templateUrl: './issue5-mod9-grid.component.html'
})
export class Issue5Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
