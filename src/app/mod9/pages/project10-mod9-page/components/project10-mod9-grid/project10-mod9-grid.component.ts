...
@Component({
  selector: 'app-mod9-project10-mod9-grid',
  templateUrl: './project10-mod9-grid.component.html'
})
export class Project10Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
