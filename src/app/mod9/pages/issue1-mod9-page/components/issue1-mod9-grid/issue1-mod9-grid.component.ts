...
@Component({
  selector: 'app-mod9-issue1-mod9-grid',
  templateUrl: './issue1-mod9-grid.component.html'
})
export class Issue1Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
