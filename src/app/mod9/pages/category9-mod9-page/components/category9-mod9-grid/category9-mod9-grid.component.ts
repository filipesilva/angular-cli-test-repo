...
@Component({
  selector: 'app-mod9-category9-mod9-grid',
  templateUrl: './category9-mod9-grid.component.html'
})
export class Category9Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
