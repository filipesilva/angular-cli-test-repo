...
@Component({
  selector: 'app-mod9-category9-mod9-form',
  templateUrl: './category9-mod9-form.component.html'
})
export class Category9Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category9-mod9']);
  }
