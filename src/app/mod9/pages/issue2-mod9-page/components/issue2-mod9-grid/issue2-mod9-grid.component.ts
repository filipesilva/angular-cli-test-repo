...
@Component({
  selector: 'app-mod9-issue2-mod9-grid',
  templateUrl: './issue2-mod9-grid.component.html'
})
export class Issue2Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
