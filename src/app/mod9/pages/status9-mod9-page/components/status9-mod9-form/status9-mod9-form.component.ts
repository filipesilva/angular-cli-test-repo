...
@Component({
  selector: 'app-mod9-status9-mod9-form',
  templateUrl: './status9-mod9-form.component.html'
})
export class Status9Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status9-mod9']);
  }
