...
@Component({
  selector: 'app-mod9-status9-mod9-grid',
  templateUrl: './status9-mod9-grid.component.html'
})
export class Status9Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
