...
@Component({
  selector: 'app-mod9-category1-mod9-grid',
  templateUrl: './category1-mod9-grid.component.html'
})
export class Category1Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
