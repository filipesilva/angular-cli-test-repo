...
@Component({
  selector: 'app-mod9-category1-mod9-form',
  templateUrl: './category1-mod9-form.component.html'
})
export class Category1Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category1-mod9']);
  }
