...
@Component({
  selector: 'app-mod9-status7-mod9-grid',
  templateUrl: './status7-mod9-grid.component.html'
})
export class Status7Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
