...
@Component({
  selector: 'app-mod9-status7-mod9-form',
  templateUrl: './status7-mod9-form.component.html'
})
export class Status7Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status7-mod9']);
  }
