...
@Component({
  selector: 'app-mod9-category5-mod9-form',
  templateUrl: './category5-mod9-form.component.html'
})
export class Category5Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category5-mod9']);
  }
