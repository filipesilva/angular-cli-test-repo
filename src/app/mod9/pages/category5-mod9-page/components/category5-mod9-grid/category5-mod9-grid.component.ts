...
@Component({
  selector: 'app-mod9-category5-mod9-grid',
  templateUrl: './category5-mod9-grid.component.html'
})
export class Category5Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
