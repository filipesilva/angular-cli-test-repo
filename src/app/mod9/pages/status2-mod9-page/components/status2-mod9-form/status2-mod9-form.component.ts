...
@Component({
  selector: 'app-mod9-status2-mod9-form',
  templateUrl: './status2-mod9-form.component.html'
})
export class Status2Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status2-mod9']);
  }
