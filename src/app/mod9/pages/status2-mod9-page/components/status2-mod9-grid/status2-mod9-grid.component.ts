...
@Component({
  selector: 'app-mod9-status2-mod9-grid',
  templateUrl: './status2-mod9-grid.component.html'
})
export class Status2Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
