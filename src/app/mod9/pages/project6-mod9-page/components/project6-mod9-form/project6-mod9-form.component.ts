...
@Component({
  selector: 'app-mod9-project6-mod9-form',
  templateUrl: './project6-mod9-form.component.html'
})
export class Project6Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/project6-mod9']);
  }
