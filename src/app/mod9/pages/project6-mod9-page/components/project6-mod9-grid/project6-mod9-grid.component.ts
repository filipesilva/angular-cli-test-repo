...
@Component({
  selector: 'app-mod9-project6-mod9-grid',
  templateUrl: './project6-mod9-grid.component.html'
})
export class Project6Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
