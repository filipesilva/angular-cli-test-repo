...
@Component({
  selector: 'app-mod9-category8-mod9-form',
  templateUrl: './category8-mod9-form.component.html'
})
export class Category8Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/category8-mod9']);
  }
