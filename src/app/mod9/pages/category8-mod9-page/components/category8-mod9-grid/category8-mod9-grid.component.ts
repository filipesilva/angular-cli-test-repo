...
@Component({
  selector: 'app-mod9-category8-mod9-grid',
  templateUrl: './category8-mod9-grid.component.html'
})
export class Category8Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
