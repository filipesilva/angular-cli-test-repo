...
@Component({
  selector: 'app-mod9-issue8-mod9-grid',
  templateUrl: './issue8-mod9-grid.component.html'
})
export class Issue8Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
