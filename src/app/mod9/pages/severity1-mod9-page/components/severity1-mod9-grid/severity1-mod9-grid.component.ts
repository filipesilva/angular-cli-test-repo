...
@Component({
  selector: 'app-mod9-severity1-mod9-grid',
  templateUrl: './severity1-mod9-grid.component.html'
})
export class Severity1Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
