...
@Component({
  selector: 'app-mod9-severity1-mod9-form',
  templateUrl: './severity1-mod9-form.component.html'
})
export class Severity1Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity1-mod9']);
  }
