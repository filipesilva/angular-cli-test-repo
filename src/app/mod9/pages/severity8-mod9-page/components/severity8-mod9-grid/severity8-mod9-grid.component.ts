...
@Component({
  selector: 'app-mod9-severity8-mod9-grid',
  templateUrl: './severity8-mod9-grid.component.html'
})
export class Severity8Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
