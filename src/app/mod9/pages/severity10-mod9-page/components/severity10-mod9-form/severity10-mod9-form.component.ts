...
@Component({
  selector: 'app-mod9-severity10-mod9-form',
  templateUrl: './severity10-mod9-form.component.html'
})
export class Severity10Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity10-mod9']);
  }
