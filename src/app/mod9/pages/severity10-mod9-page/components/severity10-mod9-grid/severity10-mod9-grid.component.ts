...
@Component({
  selector: 'app-mod9-severity10-mod9-grid',
  templateUrl: './severity10-mod9-grid.component.html'
})
export class Severity10Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
