...
@Component({
  selector: 'app-mod9-category2-mod9-grid',
  templateUrl: './category2-mod9-grid.component.html'
})
export class Category2Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
