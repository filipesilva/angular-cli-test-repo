...
@Component({
  selector: 'app-mod9-status5-mod9-form',
  templateUrl: './status5-mod9-form.component.html'
})
export class Status5Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status5-mod9']);
  }
