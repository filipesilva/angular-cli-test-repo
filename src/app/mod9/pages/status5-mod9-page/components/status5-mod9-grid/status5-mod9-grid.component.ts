...
@Component({
  selector: 'app-mod9-status5-mod9-grid',
  templateUrl: './status5-mod9-grid.component.html'
})
export class Status5Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
