...
@Component({
  selector: 'app-mod9-status8-mod9-grid',
  templateUrl: './status8-mod9-grid.component.html'
})
export class Status8Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
