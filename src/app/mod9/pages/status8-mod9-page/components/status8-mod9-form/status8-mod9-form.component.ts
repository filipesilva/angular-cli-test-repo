...
@Component({
  selector: 'app-mod9-status8-mod9-form',
  templateUrl: './status8-mod9-form.component.html'
})
export class Status8Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status8-mod9']);
  }
