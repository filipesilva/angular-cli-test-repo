...
@Component({
  selector: 'app-mod9-status10-mod9-form',
  templateUrl: './status10-mod9-form.component.html'
})
export class Status10Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status10-mod9']);
  }
