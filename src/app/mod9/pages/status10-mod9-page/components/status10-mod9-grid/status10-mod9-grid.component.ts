...
@Component({
  selector: 'app-mod9-status10-mod9-grid',
  templateUrl: './status10-mod9-grid.component.html'
})
export class Status10Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
