...
@Component({
  selector: 'app-mod9-severity7-mod9-form',
  templateUrl: './severity7-mod9-form.component.html'
})
export class Severity7Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity7-mod9']);
  }
