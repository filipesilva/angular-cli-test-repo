...
@Component({
  selector: 'app-mod9-severity7-mod9-grid',
  templateUrl: './severity7-mod9-grid.component.html'
})
export class Severity7Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
