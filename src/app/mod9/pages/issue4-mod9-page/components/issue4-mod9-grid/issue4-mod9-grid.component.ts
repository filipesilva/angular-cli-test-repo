...
@Component({
  selector: 'app-mod9-issue4-mod9-grid',
  templateUrl: './issue4-mod9-grid.component.html'
})
export class Issue4Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
