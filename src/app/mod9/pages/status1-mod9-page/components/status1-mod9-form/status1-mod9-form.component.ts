...
@Component({
  selector: 'app-mod9-status1-mod9-form',
  templateUrl: './status1-mod9-form.component.html'
})
export class Status1Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status1-mod9']);
  }
