...
@Component({
  selector: 'app-mod9-status1-mod9-grid',
  templateUrl: './status1-mod9-grid.component.html'
})
export class Status1Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
