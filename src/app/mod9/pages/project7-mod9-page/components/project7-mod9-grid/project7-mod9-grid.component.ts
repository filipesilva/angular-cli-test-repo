...
@Component({
  selector: 'app-mod9-project7-mod9-grid',
  templateUrl: './project7-mod9-grid.component.html'
})
export class Project7Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
