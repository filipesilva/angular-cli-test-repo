...
@Component({
  selector: 'app-mod9-project7-mod9-form',
  templateUrl: './project7-mod9-form.component.html'
})
export class Project7Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/project7-mod9']);
  }
