...
@Component({
  selector: 'app-mod9-status3-mod9-grid',
  templateUrl: './status3-mod9-grid.component.html'
})
export class Status3Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
