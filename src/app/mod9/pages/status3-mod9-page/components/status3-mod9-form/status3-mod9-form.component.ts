...
@Component({
  selector: 'app-mod9-status3-mod9-form',
  templateUrl: './status3-mod9-form.component.html'
})
export class Status3Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/status3-mod9']);
  }
