...
@Component({
  selector: 'app-mod9-severity9-mod9-grid',
  templateUrl: './severity9-mod9-grid.component.html'
})
export class Severity9Mod9GridComponent extends GridComponent implements OnInit, OnDestroy {
