...
@Component({
  selector: 'app-mod9-severity9-mod9-form',
  templateUrl: './severity9-mod9-form.component.html'
})
export class Severity9Mod9FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod9/severity9-mod9']);
  }
