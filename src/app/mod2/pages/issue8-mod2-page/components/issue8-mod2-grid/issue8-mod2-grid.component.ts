...
@Component({
  selector: 'app-mod2-issue8-mod2-grid',
  templateUrl: './issue8-mod2-grid.component.html'
})
export class Issue8Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
