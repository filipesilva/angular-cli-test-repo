...
@Component({
  selector: 'app-mod2-category3-mod2-grid',
  templateUrl: './category3-mod2-grid.component.html'
})
export class Category3Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
