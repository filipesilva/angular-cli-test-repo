...
@Component({
  selector: 'app-mod2-severity4-mod2-grid',
  templateUrl: './severity4-mod2-grid.component.html'
})
export class Severity4Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
