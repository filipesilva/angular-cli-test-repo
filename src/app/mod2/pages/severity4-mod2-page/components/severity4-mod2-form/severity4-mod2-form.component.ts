...
@Component({
  selector: 'app-mod2-severity4-mod2-form',
  templateUrl: './severity4-mod2-form.component.html'
})
export class Severity4Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/severity4-mod2']);
  }
