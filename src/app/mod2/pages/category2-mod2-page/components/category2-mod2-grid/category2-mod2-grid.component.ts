...
@Component({
  selector: 'app-mod2-category2-mod2-grid',
  templateUrl: './category2-mod2-grid.component.html'
})
export class Category2Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
