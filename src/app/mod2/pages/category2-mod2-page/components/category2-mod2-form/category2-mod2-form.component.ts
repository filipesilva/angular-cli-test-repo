...
@Component({
  selector: 'app-mod2-category2-mod2-form',
  templateUrl: './category2-mod2-form.component.html'
})
export class Category2Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/category2-mod2']);
  }
