...
@Component({
  selector: 'app-mod2-severity1-mod2-grid',
  templateUrl: './severity1-mod2-grid.component.html'
})
export class Severity1Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
