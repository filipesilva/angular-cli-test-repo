...
@Component({
  selector: 'app-mod2-project8-mod2-form',
  templateUrl: './project8-mod2-form.component.html'
})
export class Project8Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project8-mod2']);
  }
