...
@Component({
  selector: 'app-mod2-project8-mod2-grid',
  templateUrl: './project8-mod2-grid.component.html'
})
export class Project8Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
