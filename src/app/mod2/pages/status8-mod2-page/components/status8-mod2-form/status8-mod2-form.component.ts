...
@Component({
  selector: 'app-mod2-status8-mod2-form',
  templateUrl: './status8-mod2-form.component.html'
})
export class Status8Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status8-mod2']);
  }
