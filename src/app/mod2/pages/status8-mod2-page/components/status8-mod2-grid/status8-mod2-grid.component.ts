...
@Component({
  selector: 'app-mod2-status8-mod2-grid',
  templateUrl: './status8-mod2-grid.component.html'
})
export class Status8Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
