...
@Component({
  selector: 'app-mod2-issue6-mod2-grid',
  templateUrl: './issue6-mod2-grid.component.html'
})
export class Issue6Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
