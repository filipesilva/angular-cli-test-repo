...
@Component({
  selector: 'app-mod2-project4-mod2-form',
  templateUrl: './project4-mod2-form.component.html'
})
export class Project4Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project4-mod2']);
  }
