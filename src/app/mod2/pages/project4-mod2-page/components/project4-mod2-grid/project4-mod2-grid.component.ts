...
@Component({
  selector: 'app-mod2-project4-mod2-grid',
  templateUrl: './project4-mod2-grid.component.html'
})
export class Project4Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
