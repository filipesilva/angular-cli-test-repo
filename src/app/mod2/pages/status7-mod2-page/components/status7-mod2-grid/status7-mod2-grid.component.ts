...
@Component({
  selector: 'app-mod2-status7-mod2-grid',
  templateUrl: './status7-mod2-grid.component.html'
})
export class Status7Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
