...
@Component({
  selector: 'app-mod2-status7-mod2-form',
  templateUrl: './status7-mod2-form.component.html'
})
export class Status7Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status7-mod2']);
  }
