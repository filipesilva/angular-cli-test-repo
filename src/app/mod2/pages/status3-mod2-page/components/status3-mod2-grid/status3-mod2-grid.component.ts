...
@Component({
  selector: 'app-mod2-status3-mod2-grid',
  templateUrl: './status3-mod2-grid.component.html'
})
export class Status3Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
