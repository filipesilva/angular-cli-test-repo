...
@Component({
  selector: 'app-mod2-status3-mod2-form',
  templateUrl: './status3-mod2-form.component.html'
})
export class Status3Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status3-mod2']);
  }
