...
@Component({
  selector: 'app-mod2-project7-mod2-grid',
  templateUrl: './project7-mod2-grid.component.html'
})
export class Project7Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
