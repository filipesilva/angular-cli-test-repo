...
@Component({
  selector: 'app-mod2-project7-mod2-form',
  templateUrl: './project7-mod2-form.component.html'
})
export class Project7Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project7-mod2']);
  }
