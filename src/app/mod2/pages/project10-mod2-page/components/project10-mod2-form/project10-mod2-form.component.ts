...
@Component({
  selector: 'app-mod2-project10-mod2-form',
  templateUrl: './project10-mod2-form.component.html'
})
export class Project10Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project10-mod2']);
  }
