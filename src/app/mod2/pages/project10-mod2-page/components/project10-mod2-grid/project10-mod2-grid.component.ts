...
@Component({
  selector: 'app-mod2-project10-mod2-grid',
  templateUrl: './project10-mod2-grid.component.html'
})
export class Project10Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
