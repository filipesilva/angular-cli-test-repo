...
@Component({
  selector: 'app-mod2-project3-mod2-form',
  templateUrl: './project3-mod2-form.component.html'
})
export class Project3Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project3-mod2']);
  }
