...
@Component({
  selector: 'app-mod2-project3-mod2-grid',
  templateUrl: './project3-mod2-grid.component.html'
})
export class Project3Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
