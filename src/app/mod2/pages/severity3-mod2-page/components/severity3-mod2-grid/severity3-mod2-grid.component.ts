...
@Component({
  selector: 'app-mod2-severity3-mod2-grid',
  templateUrl: './severity3-mod2-grid.component.html'
})
export class Severity3Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
