...
@Component({
  selector: 'app-mod2-status6-mod2-grid',
  templateUrl: './status6-mod2-grid.component.html'
})
export class Status6Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
