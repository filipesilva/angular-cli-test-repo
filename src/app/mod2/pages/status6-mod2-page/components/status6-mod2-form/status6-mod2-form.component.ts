...
@Component({
  selector: 'app-mod2-status6-mod2-form',
  templateUrl: './status6-mod2-form.component.html'
})
export class Status6Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status6-mod2']);
  }
