...
@Component({
  selector: 'app-mod2-issue7-mod2-grid',
  templateUrl: './issue7-mod2-grid.component.html'
})
export class Issue7Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
