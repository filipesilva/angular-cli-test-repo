...
@Component({
  selector: 'app-mod2-project6-mod2-grid',
  templateUrl: './project6-mod2-grid.component.html'
})
export class Project6Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
