...
@Component({
  selector: 'app-mod2-severity8-mod2-form',
  templateUrl: './severity8-mod2-form.component.html'
})
export class Severity8Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/severity8-mod2']);
  }
