...
@Component({
  selector: 'app-mod2-severity8-mod2-grid',
  templateUrl: './severity8-mod2-grid.component.html'
})
export class Severity8Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
