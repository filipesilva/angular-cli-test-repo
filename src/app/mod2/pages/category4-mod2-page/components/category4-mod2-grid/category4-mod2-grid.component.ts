...
@Component({
  selector: 'app-mod2-category4-mod2-grid',
  templateUrl: './category4-mod2-grid.component.html'
})
export class Category4Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
