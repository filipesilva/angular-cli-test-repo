...
@Component({
  selector: 'app-mod2-category4-mod2-form',
  templateUrl: './category4-mod2-form.component.html'
})
export class Category4Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/category4-mod2']);
  }
