...
@Component({
  selector: 'app-mod2-severity7-mod2-grid',
  templateUrl: './severity7-mod2-grid.component.html'
})
export class Severity7Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
