...
@Component({
  selector: 'app-mod2-severity7-mod2-form',
  templateUrl: './severity7-mod2-form.component.html'
})
export class Severity7Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/severity7-mod2']);
  }
