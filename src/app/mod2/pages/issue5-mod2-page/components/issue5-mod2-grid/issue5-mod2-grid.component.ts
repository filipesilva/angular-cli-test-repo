...
@Component({
  selector: 'app-mod2-issue5-mod2-grid',
  templateUrl: './issue5-mod2-grid.component.html'
})
export class Issue5Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
