...
@Component({
  selector: 'app-mod2-issue9-mod2-grid',
  templateUrl: './issue9-mod2-grid.component.html'
})
export class Issue9Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
