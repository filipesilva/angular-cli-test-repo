...
@Component({
  selector: 'app-mod2-status9-mod2-grid',
  templateUrl: './status9-mod2-grid.component.html'
})
export class Status9Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
