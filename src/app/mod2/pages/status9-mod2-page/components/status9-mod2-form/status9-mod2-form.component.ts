...
@Component({
  selector: 'app-mod2-status9-mod2-form',
  templateUrl: './status9-mod2-form.component.html'
})
export class Status9Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status9-mod2']);
  }
