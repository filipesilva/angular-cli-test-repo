...
@Component({
  selector: 'app-mod2-project1-mod2-grid',
  templateUrl: './project1-mod2-grid.component.html'
})
export class Project1Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
