...
@Component({
  selector: 'app-mod2-project1-mod2-form',
  templateUrl: './project1-mod2-form.component.html'
})
export class Project1Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project1-mod2']);
  }
