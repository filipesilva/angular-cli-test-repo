...
@Component({
  selector: 'app-mod2-category7-mod2-form',
  templateUrl: './category7-mod2-form.component.html'
})
export class Category7Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/category7-mod2']);
  }
