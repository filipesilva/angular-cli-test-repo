...
@Component({
  selector: 'app-mod2-category7-mod2-grid',
  templateUrl: './category7-mod2-grid.component.html'
})
export class Category7Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
