...
@Component({
  selector: 'app-mod2-project2-mod2-grid',
  templateUrl: './project2-mod2-grid.component.html'
})
export class Project2Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
