...
@Component({
  selector: 'app-mod2-project2-mod2-form',
  templateUrl: './project2-mod2-form.component.html'
})
export class Project2Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project2-mod2']);
  }
