...
@Component({
  selector: 'app-mod2-category10-mod2-grid',
  templateUrl: './category10-mod2-grid.component.html'
})
export class Category10Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
