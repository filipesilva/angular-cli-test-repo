...
@Component({
  selector: 'app-mod2-issue10-mod2-grid',
  templateUrl: './issue10-mod2-grid.component.html'
})
export class Issue10Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
