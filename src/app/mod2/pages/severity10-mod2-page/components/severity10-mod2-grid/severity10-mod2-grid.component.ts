...
@Component({
  selector: 'app-mod2-severity10-mod2-grid',
  templateUrl: './severity10-mod2-grid.component.html'
})
export class Severity10Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
