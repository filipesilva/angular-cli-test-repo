...
@Component({
  selector: 'app-mod2-issue2-mod2-grid',
  templateUrl: './issue2-mod2-grid.component.html'
})
export class Issue2Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
