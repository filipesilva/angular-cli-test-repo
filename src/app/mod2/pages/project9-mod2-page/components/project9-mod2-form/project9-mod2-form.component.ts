...
@Component({
  selector: 'app-mod2-project9-mod2-form',
  templateUrl: './project9-mod2-form.component.html'
})
export class Project9Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project9-mod2']);
  }
