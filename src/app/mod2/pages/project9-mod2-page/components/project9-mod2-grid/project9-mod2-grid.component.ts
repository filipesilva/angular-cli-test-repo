...
@Component({
  selector: 'app-mod2-project9-mod2-grid',
  templateUrl: './project9-mod2-grid.component.html'
})
export class Project9Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
