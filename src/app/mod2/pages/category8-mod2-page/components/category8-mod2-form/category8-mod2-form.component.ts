...
@Component({
  selector: 'app-mod2-category8-mod2-form',
  templateUrl: './category8-mod2-form.component.html'
})
export class Category8Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/category8-mod2']);
  }
