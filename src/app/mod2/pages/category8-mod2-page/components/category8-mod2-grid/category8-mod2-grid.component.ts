...
@Component({
  selector: 'app-mod2-category8-mod2-grid',
  templateUrl: './category8-mod2-grid.component.html'
})
export class Category8Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
