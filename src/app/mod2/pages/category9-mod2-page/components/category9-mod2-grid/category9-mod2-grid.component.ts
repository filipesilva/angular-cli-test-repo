...
@Component({
  selector: 'app-mod2-category9-mod2-grid',
  templateUrl: './category9-mod2-grid.component.html'
})
export class Category9Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
