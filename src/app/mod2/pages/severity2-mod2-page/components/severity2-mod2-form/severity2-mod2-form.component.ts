...
@Component({
  selector: 'app-mod2-severity2-mod2-form',
  templateUrl: './severity2-mod2-form.component.html'
})
export class Severity2Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/severity2-mod2']);
  }
