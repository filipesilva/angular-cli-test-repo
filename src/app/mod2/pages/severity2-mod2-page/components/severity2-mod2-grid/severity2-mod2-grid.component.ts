...
@Component({
  selector: 'app-mod2-severity2-mod2-grid',
  templateUrl: './severity2-mod2-grid.component.html'
})
export class Severity2Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
