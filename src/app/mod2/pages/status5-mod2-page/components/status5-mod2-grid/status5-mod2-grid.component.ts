...
@Component({
  selector: 'app-mod2-status5-mod2-grid',
  templateUrl: './status5-mod2-grid.component.html'
})
export class Status5Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
