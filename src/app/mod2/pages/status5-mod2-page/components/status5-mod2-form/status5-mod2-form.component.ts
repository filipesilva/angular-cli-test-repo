...
@Component({
  selector: 'app-mod2-status5-mod2-form',
  templateUrl: './status5-mod2-form.component.html'
})
export class Status5Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status5-mod2']);
  }
