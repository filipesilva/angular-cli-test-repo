...
@Component({
  selector: 'app-mod2-issue4-mod2-grid',
  templateUrl: './issue4-mod2-grid.component.html'
})
export class Issue4Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
