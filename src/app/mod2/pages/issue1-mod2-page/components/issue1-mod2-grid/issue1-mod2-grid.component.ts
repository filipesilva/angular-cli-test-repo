...
@Component({
  selector: 'app-mod2-issue1-mod2-grid',
  templateUrl: './issue1-mod2-grid.component.html'
})
export class Issue1Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
