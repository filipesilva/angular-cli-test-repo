...
@Component({
  selector: 'app-mod2-status4-mod2-grid',
  templateUrl: './status4-mod2-grid.component.html'
})
export class Status4Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
