...
@Component({
  selector: 'app-mod2-status4-mod2-form',
  templateUrl: './status4-mod2-form.component.html'
})
export class Status4Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status4-mod2']);
  }
