...
@Component({
  selector: 'app-mod2-category1-mod2-grid',
  templateUrl: './category1-mod2-grid.component.html'
})
export class Category1Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
