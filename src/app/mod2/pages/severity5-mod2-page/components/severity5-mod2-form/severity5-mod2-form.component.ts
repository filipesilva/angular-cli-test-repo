...
@Component({
  selector: 'app-mod2-severity5-mod2-form',
  templateUrl: './severity5-mod2-form.component.html'
})
export class Severity5Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/severity5-mod2']);
  }
