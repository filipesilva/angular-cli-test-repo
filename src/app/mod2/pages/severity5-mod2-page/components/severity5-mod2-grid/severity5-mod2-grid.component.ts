...
@Component({
  selector: 'app-mod2-severity5-mod2-grid',
  templateUrl: './severity5-mod2-grid.component.html'
})
export class Severity5Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
