...
@Component({
  selector: 'app-mod2-status1-mod2-grid',
  templateUrl: './status1-mod2-grid.component.html'
})
export class Status1Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
