...
@Component({
  selector: 'app-mod2-status1-mod2-form',
  templateUrl: './status1-mod2-form.component.html'
})
export class Status1Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status1-mod2']);
  }
