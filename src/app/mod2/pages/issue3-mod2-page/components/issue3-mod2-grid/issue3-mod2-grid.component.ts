...
@Component({
  selector: 'app-mod2-issue3-mod2-grid',
  templateUrl: './issue3-mod2-grid.component.html'
})
export class Issue3Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
