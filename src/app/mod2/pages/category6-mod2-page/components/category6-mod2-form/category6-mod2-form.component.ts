...
@Component({
  selector: 'app-mod2-category6-mod2-form',
  templateUrl: './category6-mod2-form.component.html'
})
export class Category6Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/category6-mod2']);
  }
