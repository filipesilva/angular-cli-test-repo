...
@Component({
  selector: 'app-mod2-category6-mod2-grid',
  templateUrl: './category6-mod2-grid.component.html'
})
export class Category6Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
