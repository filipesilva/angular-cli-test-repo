...
@Component({
  selector: 'app-mod2-severity6-mod2-grid',
  templateUrl: './severity6-mod2-grid.component.html'
})
export class Severity6Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
