...
@Component({
  selector: 'app-mod2-status10-mod2-form',
  templateUrl: './status10-mod2-form.component.html'
})
export class Status10Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status10-mod2']);
  }
