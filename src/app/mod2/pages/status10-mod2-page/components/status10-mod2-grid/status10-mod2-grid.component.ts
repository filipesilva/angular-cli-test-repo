...
@Component({
  selector: 'app-mod2-status10-mod2-grid',
  templateUrl: './status10-mod2-grid.component.html'
})
export class Status10Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
