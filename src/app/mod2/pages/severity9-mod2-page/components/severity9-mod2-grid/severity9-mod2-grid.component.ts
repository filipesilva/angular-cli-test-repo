...
@Component({
  selector: 'app-mod2-severity9-mod2-grid',
  templateUrl: './severity9-mod2-grid.component.html'
})
export class Severity9Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
