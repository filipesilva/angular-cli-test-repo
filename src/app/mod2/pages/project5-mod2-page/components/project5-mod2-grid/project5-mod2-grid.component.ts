...
@Component({
  selector: 'app-mod2-project5-mod2-grid',
  templateUrl: './project5-mod2-grid.component.html'
})
export class Project5Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
