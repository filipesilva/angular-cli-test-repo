...
@Component({
  selector: 'app-mod2-project5-mod2-form',
  templateUrl: './project5-mod2-form.component.html'
})
export class Project5Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/project5-mod2']);
  }
