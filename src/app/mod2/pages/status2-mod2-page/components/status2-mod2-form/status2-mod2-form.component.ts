...
@Component({
  selector: 'app-mod2-status2-mod2-form',
  templateUrl: './status2-mod2-form.component.html'
})
export class Status2Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/status2-mod2']);
  }
