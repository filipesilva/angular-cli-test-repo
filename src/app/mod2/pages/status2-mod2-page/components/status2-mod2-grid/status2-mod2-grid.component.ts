...
@Component({
  selector: 'app-mod2-status2-mod2-grid',
  templateUrl: './status2-mod2-grid.component.html'
})
export class Status2Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
