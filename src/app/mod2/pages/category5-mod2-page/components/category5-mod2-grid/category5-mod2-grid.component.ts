...
@Component({
  selector: 'app-mod2-category5-mod2-grid',
  templateUrl: './category5-mod2-grid.component.html'
})
export class Category5Mod2GridComponent extends GridComponent implements OnInit, OnDestroy {
