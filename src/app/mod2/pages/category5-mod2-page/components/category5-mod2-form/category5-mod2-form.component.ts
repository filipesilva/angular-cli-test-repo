...
@Component({
  selector: 'app-mod2-category5-mod2-form',
  templateUrl: './category5-mod2-form.component.html'
})
export class Category5Mod2FormComponent extends FormComponent implements OnInit, OnDestroy {
  ...
  public back(): void {
    this.router.navigate(['/mod2/category5-mod2']);
  }
